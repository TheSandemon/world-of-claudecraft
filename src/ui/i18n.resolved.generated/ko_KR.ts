...
export const ko_KR: EnTranslations = {
  ...
  "cards": {
    "docTitle": "카드 듀얼 플레이테스트 - World of ClaudeCraft",
    "appTitle": "카드 듀얼 플레이테스트",
    "intro": "게임 세계 없이 실제 규칙 엔진을 그대로 구동하는 카드 듀얼 테이블입니다. 시드를 지정하면 똑같은 셔플을 재현할 수 있습니다.",
    "basicName": "평범한 {value}",
    "noRulesText": "효과 없음.",
    "seat": {
      "a": "Seat A",
    ...
    "controls": {
      "label": "테이블 조작",
      "seed": "Seed",
      "seedHint": "같은 시드는 매번 같은 대전을 만듭니다.",
      "newMatch": "새 대전",
      "runToEnd": "Run to end",
      "runToEndHint": "두 자리 모두 컴퓨터 상대여야 합니다.",
      "opponentA": "A 자리 조작",
      "opponentB": "B 자리 조작",
      "human": "플레이어",
      "novice": "초보",
    ...
    "round": {
      "heading": "라운드 {round}",
      "outcomeWin": "A 자리가 {a} 대 {b}로 이번 라운드를 이겼습니다.",
      "outcomeLose": "B 자리가 {b} 대 {a}로 이번 라운드를 이겼습니다.",
      "outcomePush": "이번 라운드는 {a}로 무승부입니다.",
    ...
    "result": {
      ...
      "winB": "B 자리가 대전에서 승리했습니다.",
      "live": "대전 진행 중입니다."
    },
    "name": {
      "mudfin_scout": "머드핀 정찰병",
      "ratling_thief": "랫링 도둑",
      "grave_rat": "무덤 쥐",
      "grave_candle": "무덤 촛불",
      "web_spinner": "거미줄 방적공",
      "mire_toad": "수렁 두꺼비",
      "forest_wolf": "숲 늑대",
      "bramble_sprite": "가시덤불 정령",
      "bone_picker": "뼈 줍는 자",
      "sableweb_hexer": "흑망 저주술사",
      "nullstone": "무효석",
      "stablemaster": "마구간지기",
      "doppelganger": "도플갱어",
      "necromancer": "강령술사",
      ...
      "pack_alpha": "무리의 우두머리",
      "tunnel_guard": "터널 수호병",
      "ember_drake": "잉걸불 드레이크",
      "ironclad": "철갑",
      "mirefen_ambusher": "미어펜 매복자",
      "grave_warden": "무덤 감시자",
      "old_greyjaw": "늙은 회색턱",
      "sable_matriarch": "흑거미 여왕",
      "hollow_knight": "공허의 기사",
      "stormcaller": "폭풍 소환자",
      "vale_warden": "계곡 수호자",
      "ashen_wyrm": "잿빛 웜",
      "grix_tunnelking": "터널왕 그릭스",
      "nythraxis_broodling": "니스락시스 새끼",
      "vale_champion": "계곡의 용사"
    },
    "text": {
      "mudfin_scout": "이 카드가 패배하면 상대 손패에서 무작위로 {count}장을 공개합니다.",
      "ratling_thief": "이 카드가 승리하면 상대는 무작위로 카드 한 장을 버립니다.",
      "grave_rat": "이번 라운드에 상대 카드가 -{amount}를 받습니다.",
      "grave_candle": "이 카드가 패배하면 다음에 내는 언데드가 +{amount}를 받습니다.",
      "web_spinner": "공개될 때 거미줄 {amount}개를 얻습니다.",
      "mire_toad": "상대 카드가 {threshold} 이상이면 +{amount}를 받습니다.",
      "forest_wolf": "이전에 낸 카드가 야수였다면 +{amount}를 받습니다.",
      "bramble_sprite": "이번 라운드에 이 카드는 야수로 취급되며 +{amount}를 받습니다.",
      "bone_picker": "이번 대전에서 낸 언데드 한 장마다 +1을 받습니다.",
      "sableweb_hexer": "상대 카드가 인간이면 -{amount}를 받습니다.",
      "nullstone": "이번 라운드에 상대 카드는 효과를 발휘하지 못합니다.",
      "stablemaster": "다음에 내는 야수가 +{amount}를 받습니다.",
      "doppelganger": "이 카드의 값이 상대 카드의 기본값이 됩니다.",
      "necromancer": "다음에 내는 언데드가 +{amount}를 받습니다.",
      "torchbearer": "라운드 점수에서 뒤지고 있는 동안 +{amount}를 받습니다.",
      "pack_alpha": "이번 대전에서 낸 야수 두 장마다 +1을 받습니다.",
      "tunnel_guard": "이 카드의 값은 {amount} 아래로 내려가지 않습니다.",
      "ember_drake": "상대의 공포 하나마다 +1을 받습니다.",
      "ironclad": "이번 라운드에 상대 카드의 값은 {amount}를 넘지 못합니다.",
      "mirefen_ambusher": "상대 카드가 인간이면 +{amount}를 받습니다.",
      "grave_warden": "이 카드가 승리하면 버린 카드 더미에서 값 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.",
      "old_greyjaw": "라운드 점수에서 뒤지고 있는 동안 +{amount}를 받습니다.",
      "sable_matriarch": "보유한 거미줄 하나마다 +1을 받습니다.",
      "hollow_knight": "무승부 라운드에서 이 카드가 승리합니다.",
      "stormcaller": "상대 카드가 {threshold} 이상이면 -{amount}를 받습니다.",
      "vale_warden": "이 카드가 승리하면 카드 {amount}장을 뽑습니다.",
      "ashen_wyrm": "공개될 때 상대에게 공포 {amount}개를 부여합니다.",
      "grix_tunnelking": "이 카드가 승리하면 다음에 내는 카드가 -{amount}를 받습니다.",
