...
export const zh_CN: EnTranslations = {
  ...
  "cards": {
    "docTitle": "卡牌对决试玩 - World of ClaudeCraft",
    "appTitle": "卡牌对决试玩",
    "intro": "一张不依赖游戏世界的卡牌对决桌，运行的是正式版规则引擎。设置随机种子即可复现完全相同的洗牌。",
    "basicName": "普通 {value}",
    "noRulesText": "无效果。",
    "seat": {
      "a": "Seat A",
    ...
    "controls": {
      "label": "牌桌控制",
      "seed": "Seed",
      "seedHint": "相同的种子每次都会发出相同的对局。",
      "newMatch": "新对局",
      "runToEnd": "Run to end",
      "runToEndHint": "两个座位都必须由电脑对手操作。",
      "opponentA": "A 座位由",
      "opponentB": "B 座位由",
      "human": "玩家",
      "novice": "新手",
    ...
    "round": {
      "heading": "第 {round} 回合",
      "outcomeWin": "A 座位以 {a} 比 {b} 赢下本回合。",
      "outcomeLose": "B 座位以 {b} 比 {a} 赢下本回合。",
      "outcomePush": "本回合以 {a} 打平。",
    ...
    "name": {
      ...
      "ember_drake": "余烬幼龙",
      "ironclad": "铁甲卫",
      "mirefen_ambusher": "泥沼伏击者",
      "grave_warden": "墓地守望者",
      "old_greyjaw": "老灰颚",
      "sable_matriarch": "黑蛛女王",
      "hollow_knight": "空洞骑士",
      "stormcaller": "唤风者",
      "vale_warden": "山谷守卫",
      "ashen_wyrm": "灰烬巨蛇",
      "grix_tunnelking": "隧道之王格里克斯",
      "nythraxis_broodling": "奈斯拉克斯幼裔",
      "vale_champion": "山谷勇士"
    },
    "text": {
      "mudfin_scout": "若此牌落败，随机展示对手手牌中的 {count} 张牌。",
      "ratling_thief": "若此牌获胜，对手随机弃掉一张手牌。",
      "grave_rat": "本回合对手的牌获得 -{amount}。",
      "grave_candle": "若此牌落败，你的下一张亡灵牌获得 +{amount}。",
      "web_spinner": "展示时，获得 {amount} 层蛛网。",
      "mire_toad": "若对手的牌为 {threshold} 或更高，此牌获得 +{amount}。",
      "forest_wolf": "若你上一张牌是野兽牌，此牌获得 +{amount}。",
      "bramble_sprite": "本回合此牌视为野兽，并获得 +{amount}。",
      "bone_picker": "本局中你每打出一张亡灵牌，此牌便获得 +1。",
      "sableweb_hexer": "若对手的牌是人类，则其获得 -{amount}。",
      "nullstone": "本回合对手的牌不产生任何效果。",
      "stablemaster": "你的下一张野兽牌获得 +{amount}。",
      "doppelganger": "此牌的数值变为对手牌的基础数值。",
      "necromancer": "你的下一张亡灵牌获得 +{amount}。",
      "torchbearer": "当你在回合数上落后时，此牌获得 +{amount}。",
      "pack_alpha": "本局中你每打出两张野兽牌，此牌便获得 +1。",
      "tunnel_guard": "此牌的数值不会被降至 {amount} 以下。",
      "ember_drake": "对手每有 1 层恐惧，此牌便获得 +1。",
      "ironclad": "本回合对手的牌数值不会超过 {amount}。",
      "mirefen_ambusher": "若对手的牌是人类，此牌获得 +{amount}。",
      "grave_warden": "若此牌获胜，将你弃牌堆中数值 {threshold} 或更低的最高亡灵牌收回手牌。",
      "old_greyjaw": "当你在回合数上落后时，此牌获得 +{amount}。",
      "sable_matriarch": "你每有 1 层蛛网，此牌便获得 +1。",
      "hollow_knight": "此牌在平局回合中获胜。",
      "stormcaller": "若对手的牌为 {threshold} 或更高，则其获得 -{amount}。",
      "vale_warden": "若此牌获胜，抽 {amount} 张牌。",
      "ashen_wyrm": "展示时，使对手获得 {amount} 层恐惧。",
      "grix_tunnelking": "若此牌获胜，你的下一张牌获得 -{amount}。",
