...
export const ja_JP: EnTranslations = {
  ...
  "cards": {
    "docTitle": "カードデュエル試遊 - World of ClaudeCraft",
    "appTitle": "カードデュエル試遊",
    "intro": "ゲーム世界を必要としないカードデュエル卓で、製品版のルールエンジンをそのまま動かします。シード値を設定すると同じシャッフルを再現できます。",
    "basicName": "ただの{value}",
    "noRulesText": "効果なし。",
    "seat": {
      "a": "Seat A",
    ...
    "controls": {
      "label": "卓の操作",
      "seed": "Seed",
      "seedHint": "同じシード値なら毎回同じ対戦が配られます。",
      "newMatch": "新しい対戦",
      "runToEnd": "Run to end",
      "runToEndHint": "両方の席がコンピューター対戦相手である必要があります。",
      "opponentA": "A席の操作",
      "opponentB": "B席の操作",
      "human": "プレイヤー",
      "novice": "初心者",
    ...
    "round": {
      "heading": "ラウンド{round}",
      "outcomeWin": "A席が{a}対{b}でこのラウンドに勝ちました。",
      "outcomeLose": "B席が{b}対{a}でこのラウンドに勝ちました。",
      "outcomePush": "このラウンドは{a}で引き分けです。",
    ...
    "name": {
      "mudfin_scout": "マッドフィンの斥候",
      "ratling_thief": "ラットリングの盗人",
      "grave_rat": "墓場のネズミ",
      "grave_candle": "墓前の蝋燭",
      "web_spinner": "巣を紡ぐ者",
      "mire_toad": "泥沼のヒキガエル",
      ...
      "pack_alpha": "群れの長",
      "tunnel_guard": "坑道の衛兵",
      "ember_drake": "残り火のドレイク",
      "ironclad": "鉄装甲",
      "mirefen_ambusher": "マイアフェンの伏兵",
      "grave_warden": "墓守",
      "old_greyjaw": "老いたグレイジョー",
      "sable_matriarch": "漆黒の母蜘蛛",
      "hollow_knight": "虚ろの騎士",
      "stormcaller": "嵐呼び",
      "vale_warden": "谷の守人",
      "ashen_wyrm": "灰のワーム",
      "grix_tunnelking": "坑道王グリックス",
      "nythraxis_broodling": "ニスラクシスの仔",
      "vale_champion": "谷の勇者"
    },
    "text": {
      "mudfin_scout": "このカードが負けた場合、相手の手札からランダムに{count}枚を公開する。",
      "ratling_thief": "このカードが勝った場合、相手は手札からランダムに1枚を捨てる。",
      "grave_rat": "このラウンド、相手のカードは-{amount}される。",
      "grave_candle": "このカードが負けた場合、次に出すアンデッドは+{amount}される。",
      "web_spinner": "公開時、蜘蛛の巣を{amount}得る。",
      "mire_toad": "相手のカードが{threshold}以上なら、+{amount}される。",
      "forest_wolf": "直前に出したカードが野獣なら、+{amount}される。",
      "bramble_sprite": "このラウンド、このカードは野獣として扱われ、+{amount}される。",
      "bone_picker": "この試合であなたが出したアンデッド1体につき+1される。",
      "sableweb_hexer": "相手のカードが人間なら、-{amount}される。",
      "nullstone": "このラウンド、相手のカードの効果は発動しない。",
      "stablemaster": "次に出す野獣は+{amount}される。",
      "doppelganger": "このカードの値は相手のカードの基本値になる。",
      "necromancer": "次に出すアンデッドは+{amount}される。",
      "torchbearer": "ラウンド数で負けている間、+{amount}される。",
      "pack_alpha": "この試合であなたが出した野獣2体につき+1される。",
      "tunnel_guard": "このカードの値は{amount}未満にはならない。",
      "ember_drake": "相手の恐怖1つにつき+1される。",
      "ironclad": "このラウンド、相手のカードの値は{amount}を超えない。",
      "mirefen_ambusher": "相手のカードが人間なら、+{amount}される。",
      "grave_warden": "このカードが勝った場合、捨て札から値{threshold}以下で最も高いアンデッドを手札に戻す。",
      "old_greyjaw": "ラウンド数で負けている間、+{amount}される。",
      "sable_matriarch": "あなたの蜘蛛の巣1つにつき+1される。",
      "hollow_knight": "引き分けのラウンドはこのカードの勝ちとなる。",
      "stormcaller": "相手のカードが{threshold}以上なら、-{amount}される。",
      "vale_warden": "このカードが勝った場合、カードを{amount}枚引く。",
      "ashen_wyrm": "公開時、相手に恐怖を{amount}与える。",
      "grix_tunnelking": "このカードが勝った場合、次に出すカードは-{amount}される。",
