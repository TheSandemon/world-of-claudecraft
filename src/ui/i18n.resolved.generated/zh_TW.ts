...
export const zh_TW: EnTranslations = {
  ...
  "cards": {
    "docTitle": "卡牌對決試玩 - World of ClaudeCraft",
    "appTitle": "卡牌對決試玩",
    "intro": "一張不依賴遊戲世界的卡牌對決桌，運行的是正式版規則引擎。設定隨機種子即可重現完全相同的洗牌。",
    "basicName": "普通 {value}",
    "noRulesText": "無效果。",
    "seat": {
      "a": "Seat A",
      ...
      "discardCount": "棄牌堆：{count}",
      "score": "已勝回合：{count}"
    },
    "controls": {
      "label": "牌桌控制",
      "seed": "Seed",
      "seedHint": "相同的種子每次都會發出相同的對局。",
      "newMatch": "新對局",
      "runToEnd": "Run to end",
      "runToEndHint": "兩個座位都必須由電腦對手操作。",
      "opponentA": "A 座位由",
      "opponentB": "B 座位由",
      "human": "玩家",
      "novice": "新手",
    ...
    "round": {
      "heading": "第 {round} 回合",
      "outcomeWin": "A 座位以 {a} 比 {b} 贏下本回合。",
      "outcomeLose": "B 座位以 {b} 比 {a} 贏下本回合。",
      "outcomePush": "本回合以 {a} 打平。",
      "reshuffled": "一方的棄牌堆已重新洗回牌庫。",
      "steps": "已結算 {count} 個效果。",
      "overflow": "結算達到步數上限，本回合按當前數值判定。",
      "empty": "尚未進行任何回合。",
      "verdictA": "A 席贏得本輪",
      "verdictB": "B 席贏得本輪",
      "verdictPush": "本輪平手"
    ...
    "text": {
      "mudfin_scout": "若此牌落敗，隨機展示對手手牌中的 {count} 張牌。",
      "ratling_thief": "若此牌獲勝，對手隨機棄掉一張手牌。",
      "grave_rat": "本回合對手的牌獲得 -{amount}。",
      "grave_candle": "若此牌落敗，你的下一張亡靈牌獲得 +{amount}。",
      "web_spinner": "展示時，獲得 {amount} 層蛛網。",
      "mire_toad": "若對手的牌為 {threshold} 或更高，此牌獲得 +{amount}。",
      "forest_wolf": "若你上一張牌是野獸牌，此牌獲得 +{amount}。",
      "bramble_sprite": "本回合此牌視為野獸，並獲得 +{amount}。",
      "bone_picker": "本局中你每打出一張亡靈牌，此牌便獲得 +1。",
      "sableweb_hexer": "若對手的牌是人類，則其獲得 -{amount}。",
      "nullstone": "本回合對手的牌不產生任何效果。",
      "stablemaster": "你的下一張野獸牌獲得 +{amount}。",
      "doppelganger": "此牌的數值變為對手牌的基礎數值。",
      "necromancer": "你的下一張亡靈牌獲得 +{amount}。",
      "torchbearer": "當你在回合數上落後時，此牌獲得 +{amount}。",
      "pack_alpha": "本局中你每打出兩張野獸牌，此牌便獲得 +1。",
      "tunnel_guard": "此牌的數值不會被降至 {amount} 以下。",
      "ember_drake": "對手每有 1 層恐懼，此牌便獲得 +1。",
      "ironclad": "本回合對手的牌數值不會超過 {amount}。",
      "mirefen_ambusher": "若對手的牌是人類，此牌獲得 +{amount}。",
      "grave_warden": "若此牌獲勝，將你棄牌堆中數值 {threshold} 或更低的最高亡靈牌收回手牌。",
      "old_greyjaw": "當你在回合數上落後時，此牌獲得 +{amount}。",
      "sable_matriarch": "你每有 1 層蛛網，此牌便獲得 +1。",
      "hollow_knight": "此牌在平局回合中獲勝。",
      "stormcaller": "若對手的牌為 {threshold} 或更高，則其獲得 -{amount}。",
      "vale_warden": "若此牌獲勝，抽 {amount} 張牌。",
      "ashen_wyrm": "展示時，使對手獲得 {amount} 層恐懼。",
      "grix_tunnelking": "若此牌獲勝，你的下一張牌獲得 -{amount}。",
      "nythraxis_broodling": "展示時，使對手獲得 {amount} 層恐懼。",
      "vale_champion": "若此牌落敗，抽 {amount} 張牌。"
    },
    "opponent": {
      "dockhand_pell": {
        "name": "佩爾",
