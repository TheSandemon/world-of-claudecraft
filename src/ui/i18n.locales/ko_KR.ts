...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.controls.human': '플레이어',
  'cards.controls.label': '테이블 조작',
  'cards.controls.master': '달인',
  'cards.controls.newMatch': '새 대전',
  'cards.controls.novice': '초보',
  'cards.controls.opponentA': 'A 자리 조작',
  'cards.controls.opponentB': 'B 자리 조작',
  'cards.controls.runToEndHint': '두 자리 모두 컴퓨터 상대여야 합니다.',
  'cards.controls.seedHint': '같은 시드는 매번 같은 대전을 만듭니다.',
  'cards.controls.sharp': '예리',
  'cards.controls.steady': '안정',
  'cards.docTitle': '카드 듀얼 플레이테스트 - World of ClaudeCraft',
  'cards.intro': '게임 세계 없이 실제 규칙 엔진을 그대로 구동하는 카드 듀얼 테이블입니다. 시드를 지정하면 똑같은 셔플을 재현할 수 있습니다.',
  'cards.name.ashen_wyrm': '잿빛 웜',
  'cards.name.bone_picker': '뼈 줍는 자',
  'cards.name.bramble_sprite': '가시덤불 정령',
  'cards.name.doppelganger': '도플갱어',
  'cards.name.ember_drake': '잉걸불 드레이크',
  'cards.name.forest_wolf': '숲 늑대',
  'cards.name.grave_candle': '무덤 촛불',
  'cards.name.grave_rat': '무덤 쥐',
  'cards.name.grave_warden': '무덤 감시자',
  'cards.name.grix_tunnelking': '터널왕 그릭스',
  'cards.name.hollow_knight': '공허의 기사',
  'cards.name.ironclad': '철갑',
  'cards.name.mire_toad': '수렁 두꺼비',
  'cards.name.mirefen_ambusher': '미어펜 매복자',
  'cards.name.mudfin_scout': '머드핀 정찰병',
  'cards.name.necromancer': '강령술사',
  'cards.name.nullstone': '무효석',
  'cards.name.nythraxis_broodling': '니스락시스 새끼',
  'cards.name.old_greyjaw': '늙은 회색턱',
  'cards.name.pack_alpha': '무리의 우두머리',
  'cards.name.ratling_thief': '랫링 도둑',
  'cards.name.sable_matriarch': '흑거미 여왕',
  'cards.name.sableweb_hexer': '흑망 저주술사',
  'cards.name.stablemaster': '마구간지기',
  'cards.name.stormcaller': '폭풍 소환자',
  'cards.name.torchbearer': '횃불잡이',
  'cards.name.tunnel_guard': '터널 수호병',
  'cards.name.vale_champion': '계곡의 용사',
  'cards.name.vale_warden': '계곡 수호자',
  'cards.name.web_spinner': '거미줄 방적공',
  'cards.noRulesText': '효과 없음.',
  'cards.result.live': '대전 진행 중입니다.',
  'cards.result.winA': 'A 자리가 대전에서 승리했습니다.',
  'cards.result.winB': 'B 자리가 대전에서 승리했습니다.',
  'cards.round.empty': '아직 진행된 라운드가 없습니다.',
  'cards.round.heading': '라운드 {round}',
  'cards.round.outcomeLose': 'B 자리가 {b} 대 {a}로 이번 라운드를 이겼습니다.',
  'cards.round.outcomePush': '이번 라운드는 {a}로 무승부입니다.',
  'cards.round.outcomeWin': 'A 자리가 {a} 대 {b}로 이번 라운드를 이겼습니다.',
  'cards.round.overflow': '처리 단계 상한에 도달하여 이번 라운드는 현재 값으로 판정되었습니다.',
  'cards.round.reshuffled': '버린 카드 더미가 덱으로 다시 섞여 들어갔습니다.',
  'cards.round.steps': '효과 {count}개가 처리되었습니다.',
  'cards.seat.committed': '카드 확정',
  'cards.seat.discardCount': '버린 카드: {count}',
  'cards.seat.score': '승리 라운드: {count}',
  'cards.seat.waiting': '선택 중...',
  'cards.seat.you': '내 자리',
  'cards.text.ashen_wyrm': '공개될 때 상대에게 공포 {amount}개를 부여합니다.',
  'cards.text.bone_picker': '이번 대전에서 낸 언데드 한 장마다 +1을 받습니다.',
  'cards.text.bramble_sprite': '이번 라운드에 이 카드는 야수로 취급되며 +{amount}를 받습니다.',
  'cards.text.doppelganger': '이 카드의 값이 상대 카드의 기본값이 됩니다.',
  'cards.text.ember_drake': '상대의 공포 하나마다 +1을 받습니다.',
  'cards.text.forest_wolf': '이전에 낸 카드가 야수였다면 +{amount}를 받습니다.',
  'cards.text.grave_candle': '이 카드가 패배하면 다음에 내는 언데드가 +{amount}를 받습니다.',
  'cards.text.grave_rat': '이번 라운드에 상대 카드가 -{amount}를 받습니다.',
  'cards.text.grave_warden': '이 카드가 승리하면 버린 카드 더미에서 값 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.grix_tunnelking': '이 카드가 승리하면 다음에 내는 카드가 -{amount}를 받습니다.',
  'cards.text.hollow_knight': '무승부 라운드에서 이 카드가 승리합니다.',
  'cards.text.ironclad': '이번 라운드에 상대 카드의 값은 {amount}를 넘지 못합니다.',
  'cards.text.mire_toad': '상대 카드가 {threshold} 이상이면 +{amount}를 받습니다.',
  'cards.text.mirefen_ambusher': '상대 카드가 인간이면 +{amount}를 받습니다.',
  'cards.text.mudfin_scout': '이 카드가 패배하면 상대 손패에서 무작위로 {count}장을 공개합니다.',
  'cards.text.necromancer': '다음에 내는 언데드가 +{amount}를 받습니다.',
  'cards.text.nullstone': '이번 라운드에 상대 카드는 효과를 발휘하지 못합니다.',
  'cards.text.nythraxis_broodling': '공개될 때 상대에게 공포 {amount}개를 부여합니다.',
  'cards.text.old_greyjaw': '라운드 점수에서 뒤지고 있는 동안 +{amount}를 받습니다.',
  'cards.text.pack_alpha': '이번 대전에서 낸 야수 두 장마다 +1을 받습니다.',
  'cards.text.ratling_thief': '이 카드가 승리하면 상대는 무작위로 카드 한 장을 버립니다.',
  'cards.text.sable_matriarch': '보유한 거미줄 하나마다 +1을 받습니다.',
  'cards.text.sableweb_hexer': '상대 카드가 인간이면 -{amount}를 받습니다.',
  'cards.text.stablemaster': '다음에 내는 야수가 +{amount}를 받습니다.',
  'cards.text.stormcaller': '상대 카드가 {threshold} 이상이면 -{amount}를 받습니다.',
  'cards.text.torchbearer': '라운드 점수에서 뒤지고 있는 동안 +{amount}를 받습니다.',
  'cards.text.tunnel_guard': '이 카드의 값은 {amount} 아래로 내려가지 않습니다.',
  'cards.text.vale_champion': '이 카드가 패배하면 카드 {amount}장을 뽑습니다.',
  'cards.text.vale_warden': '이 카드가 승리하면 카드 {amount}장을 뽑습니다.',
  'cards.text.web_spinner': '공개될 때 거미줄 {amount}개를 얻습니다.',
  ...
  'cards.round.verdictA': 'A 자리가 이번 라운드 승리',
  'cards.round.verdictB': 'B 자리가 이번 라운드 승리',
  'cards.round.verdictPush': '이번 라운드 무승부',
  ...
  'cardDuel.pipsAria': '{name}: {total}라운드 중 {won}승',
  'cardDuel.revealedHeading': '확인된 상대 손패',
