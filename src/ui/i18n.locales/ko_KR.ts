...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.card_master.greeting':
    'ClaudeStone 한 판 어떻소? 삼판양승, 승자에게는 자랑거리가 생기지.',
  'cardDuel.title': 'ClaudeStone',
  'cardDuel.close': '닫기',
  'cardDuel.join': '대기열 참가',
  'cardDuel.joinAria': 'ClaudeStone 대기열에 참가',
  'cardDuel.leave': '대기열 나가기',
  'cardDuel.leaveAria': 'ClaudeStone 대기열에서 나가기',
  'cardDuel.queued': '상대를 기다리는 중...',
  'cardDuel.vsOpponent': '{name}와(과) 대결',
  'cardDuel.round': '라운드 점수: {mine} - {theirs}',
  'cardDuel.forfeit': '기권',
  'cardDuel.forfeitAria': 'ClaudeStone 기권하기',
  'cardDuel.unavailable': 'ClaudeStone을 하려면 다른 플레이어가 온라인 상태여야 합니다.',
  ...
  'cards.card.playDetail': '{name} 내기, 값 {value}. {rules}',
  'cards.noRulesText': '효과 없음.',
  'cards.tribe.Bandit': '도적',
  'cards.tribe.Beast': '야수',
  'cards.tribe.Burrower': '굴착자',
  'cards.tribe.Construct': '구조물',
  'cards.tribe.Demon': '악마',
  'cards.tribe.Dragon': '용',
  'cards.tribe.Elemental': '정령',
  'cards.tribe.Human': '인간',
  'cards.tribe.Mudfin': '머드핀',
  ...
  'cardDuel.clockHeld': '라운드 정산 중',
  'cardDuel.summary.win': '당신의 승리',
  'cardDuel.summary.loss': '당신의 패배',
  'cardDuel.summary.draw': '무승부',
  'cardDuel.summary.against': '상대: {name}',
  'cardDuel.summary.health': '남은 체력',
  'cardDuel.summary.rounds': '진행한 라운드',
  'cardDuel.summary.dealt': '가한 피해',
  'cardDuel.summary.taken': '받은 피해',
  'cardDuel.summary.bestHit': '최대 타격',
  'cardDuel.summary.bestHitValue': '{round}라운드, {card}로 {amount}',
  'cardDuel.summary.rematch': '다시 하기',
  'cardDuel.summary.done': '자리 떠나기',
  ...
  'cardDeck.close': '닫기',
  'cardDeck.defaultName': '새 덱',
  'cardDeck.delete': '덱 삭제',
  'cardDeck.emptySlot': '값 {value} 빈 칸',
  'cardDeck.nameLabel': '덱 이름',
  'cardDeck.open': '덱',
  'cardDeck.openAria': '덱 빌더 열기',
  'cardDeck.progress': '{required}칸 중 {filled}칸 채움',
  'cardDeck.rowTitle': '값 {value}',
  'cardDeck.rule': '덱은 스무 장입니다. 1부터 10까지 값마다 두 장씩이며, 같은 카드는 넣을 수 없습니다.',
  'cardDeck.save': '덱 저장',
  'cardDeck.title': '덱 빌더',
  'cardOpponents.heading': '단골과 대결',
  'cardOpponents.sitDown': '{name}와 대결하기',
  'cardOpponents.tier.master': '달인',
  'cardOpponents.tier.novice': '초보',
  'cardOpponents.tier.sharp': '예리',
  'cardOpponents.tier.steady': '안정',
  'cards.opponent.dockhand_pell.greeting': '진흙을 조심하시오. 우리 쪽 진흙은 물어뜯거든.',
  'cards.opponent.dockhand_pell.name': '펠',
  'cards.opponent.dockhand_pell.title': '부두 인부',
  'cards.opponent.gravedigger_ossa.greeting': '내가 묻은 것은 오래 누워 있지 않아.',
  'cards.opponent.gravedigger_ossa.name': '오사',
  'cards.opponent.gravedigger_ossa.title': '무덤 파는 사람',
  'cards.opponent.huntsman_bregg.greeting': '늑대 한 마리는 골칫거리지. 여섯이면 사냥이고.',
  'cards.opponent.huntsman_bregg.name': '브레그',
  'cards.opponent.huntsman_bregg.title': '사냥꾼',
  'cards.opponent.the_card_master.greeting': '앉으시오. 누구나 같은 스무 장을 받소. 그대가 고른 카드를 보여 주시오.',
  'cards.opponent.the_card_master.name': '카드 마스터',
  'cards.opponent.the_card_master.title': '테이블의 관리인',
  'cards.counter.Pack': '무리',
  'cards.counter.Dread': '공포',
  'cardDuel.commitLocked': '카드 확정',
  'cardDuel.commitChoosing': '선택 중',
  'cardDuel.waitingBoth': '양쪽 모두 카드를 고르는 중',
  'cardDuel.waitingThem': '상대의 카드를 기다리는 중',
  'cardDuel.waitingMe': '상대가 준비되었습니다',
  ...
  'cardDuel.beat.reveal': '카드 공개',
  'cardDuel.beat.effectValue': '{card}: {target}에 {amount}',
  'cardDuel.beat.effectSilence': '{card}이(가) 상대 카드를 침묵시킴',
  'cardDuel.beat.effectReveal': '{card}이(가) 카드를 공개',
  'cardDuel.beat.effectDraw': '{card}이(가) 카드를 뽑음',
  'cardDuel.beat.effectSwap': '{card}이(가) 두 값을 맞바꿈',
  'cardDuel.beat.effectOther': '{card} 발동',
  'cardDuel.beat.yourCard': '당신의 카드',
  'cardDuel.beat.theirCard': '상대의 카드',
  'cardDuel.damageMine': '당신이 {amount} 피해를 입음',
  'cardDuel.damageTheirs': '상대가 {amount} 피해를 입음',
  'cardDuel.beat.clash': '카드 격돌',
  'cardDuel.beat.finish': '마지막 일격이 꽂혔다',
  'cardDuel.beat.gloryWin': '이 대결은 당신의 것이다',
  'cardDuel.beat.gloryLose': '이 대결은 패배로 끝났다',
  'cardDuel.beat.gloryDraw': '이 대결은 무승부로 끝났다',
  'cardDuel.announce': '나는 {mine}, 상대는 {theirs}을(를) 냈습니다. {outcome}',
  'cardDuel.oppoHandHidden': '상대 손패: {count}',
  'cardDuel.oppoHandSeen': '상대 손패: {count}, {seen}장 확인됨',
  'cardDuel.effectsHeading': '진행 중인 효과',
  'cardDuel.durationNextRound': '다음 라운드',
  'cardDuel.durationUntilTriggered': '발동할 때까지',
  'cardDuel.durationMatchEnd': '이번 대전 내내',
  'cards.name.briarpack_wolfs_nap': '1 늑대의 낮잠',
  'cards.name.briarpack_wolves_hunt': '2 늑대의 사냥',
  'cards.name.briarpack_wolves_howl': '3 늑대의 울부짖음',
  'cards.name.briarpack_wolves_ambush': '4 늑대의 매복',
  'cards.name.briarpack_wolves_trail': '5 늑대의 자취',
  'cards.name.briarpack_wolves_moonrun': '6 늑대의 달밤 질주',
  'cards.name.briarpack_wolves_feast': '7 늑대의 연회',
  'cards.name.briarpack_wolves_siege': '8 늑대의 포위',
  'cards.name.briarpack_wolves_overlook': '9 늑대의 전망대',
  'cards.name.briarpack_wolves_wild_night': '10 늑대의 거친 밤',
  'cards.name.gravebound_court_ghosts_wake': '1 유령의 초혼',
  'cards.name.gravebound_court_ghosts_vigil': '2 유령의 불침번',
  'cards.name.gravebound_court_ghosts_supper': '3 유령의 만찬',
  'cards.name.gravebound_court_ghosts_grave_shift': '4 유령의 무덤 교대',
  'cards.name.gravebound_court_ghosts_bell_toll': '5 유령의 조종',
  'cards.name.gravebound_court_ghosts_procession': '6 유령의 행렬',
  'cards.name.gravebound_court_ghosts_crypt_ball': '7 유령의 납골당 무도회',
  'cards.name.gravebound_court_ghosts_court': '8 유령의 궁정',
  'cards.name.gravebound_court_ghosts_coronation': '9 유령의 대관식',
  'cards.name.gravebound_court_ghosts_reunion': '10 유령의 재회',
  'cards.name.sableweb_brood_spiders_web': '1 거미의 거미줄',
  'cards.name.sableweb_brood_spiders_wait': '2 거미의 기다림',
  'cards.name.sableweb_brood_spiders_snack': '3 거미의 간식',
  'cards.name.sableweb_brood_spiders_silk_trap': '4 거미의 실 덫',
  'cards.name.sableweb_brood_spiders_shed': '5 거미의 탈피',
  'cards.name.sableweb_brood_spiders_egg_hunt': '6 거미의 알 찾기',
  'cards.name.sableweb_brood_spiders_tea_party': '7 거미의 다과회',
  'cards.name.sableweb_brood_spiders_night_watch': '8 거미의 야간 경계',
  'cards.name.sableweb_brood_spiders_feast': '9 거미의 연회',
  'cards.name.sableweb_brood_spiders_brood_rite': '10 거미의 부화 의식',
  'cards.name.ashen_flight_dragons_spark': '1 용의 불티',
  'cards.name.ashen_flight_dragons_smoke_break': '2 용의 연기 쉼',
  'cards.name.ashen_flight_dragons_roost': '3 용의 둥지',
  'cards.name.ashen_flight_dragons_first_raid': '4 용의 첫 습격',
  'cards.name.ashen_flight_dragons_ashfall': '5 용의 잿비',
  'cards.name.ashen_flight_dragons_fire_drill': '6 용의 화재 훈련',
  'cards.name.ashen_flight_dragons_sky_hunt': '7 용의 하늘 사냥',
  'cards.name.ashen_flight_dragons_bridge_roast': '8 용의 다리 화형',
  'cards.name.ashen_flight_dragons_sun_feast': '9 용의 태양 연회',
  'cards.name.ashen_flight_dragons_long_nap': '10 용의 긴 낮잠',
  'cards.name.eastbrook_company_rangers_patrol': '1 레인저의 순찰',
  'cards.name.eastbrook_company_rangers_lost_map': '2 레인저의 잃어버린 지도',
  'cards.name.eastbrook_company_rangers_dog_walk': '3 레인저의 개 산책',
  'cards.name.eastbrook_company_rangers_campfire': '4 레인저의 모닥불',
  'cards.name.eastbrook_company_rangers_beast_hunt': '5 레인저의 야수 사냥',
  'cards.name.eastbrook_company_rangers_stable_shift': '6 레인저의 마구간 교대',
  'cards.name.eastbrook_company_rangers_roll_call': '7 레인저의 점호',
  'cards.name.eastbrook_company_rangers_rescue': '8 레인저의 구조',
  'cards.name.eastbrook_company_rangers_last_watch': '9 레인저의 마지막 경계',
  'cards.name.eastbrook_company_rangers_victory_march': '10 레인저의 승전 행진',
  'cards.name.ironward_assembly_golems_boot': '1 골렘의 기동',
  'cards.name.ironward_assembly_golems_test_run': '2 골렘의 시운전',
  'cards.name.ironward_assembly_golems_watch': '3 골렘의 경계',
  'cards.name.ironward_assembly_golems_tune_up': '4 골렘의 정비',
  'cards.name.ironward_assembly_golems_forge_day': '5 골렘의 단조의 날',
  'cards.name.ironward_assembly_golems_shield_wall': '6 골렘의 방패벽',
  'cards.name.ironward_assembly_golems_march': '7 골렘의 행군',
  'cards.name.ironward_assembly_golems_lockdown': '8 골렘의 봉쇄',
  'cards.name.ironward_assembly_golems_last_stand': '9 골렘의 최후의 항전',
  'cards.name.ironward_assembly_golems_awakening': '10 골렘의 각성',
  'cards.name.mirefen_tide_mudfins_puddle': '1 머드핀의 웅덩이',
  'cards.name.mirefen_tide_mudfins_fish_fry': '2 머드핀의 생선 튀김',
  'cards.name.mirefen_tide_mudfins_net_cast': '3 머드핀의 그물 던지기',
  'cards.name.mirefen_tide_mudfins_bog_race': '4 머드핀의 늪 경주',
  'cards.name.mirefen_tide_mudfins_reed_raid': '5 머드핀의 갈대 습격',
  'cards.name.mirefen_tide_mudfins_tide_call': '6 머드핀의 조수 부름',
  'cards.name.mirefen_tide_mudfins_grub_feast': '7 머드핀의 애벌레 연회',
  'cards.name.mirefen_tide_mudfins_mud_ball': '8 머드핀의 진흙 공',
  'cards.name.mirefen_tide_mudfins_moon_croak': '9 머드핀의 달빛 울음',
  'cards.name.mirefen_tide_mudfins_flood': '10 머드핀의 홍수',
  'cards.name.tunnel_crown_burrowers_dig': '1 굴착자의 굴착',
  'cards.name.tunnel_crown_burrowers_shift': '2 굴착자의 교대',
  'cards.name.tunnel_crown_burrowers_cave_in': '3 굴착자의 붕락',
  'cards.name.tunnel_crown_burrowers_gem_rush': '4 굴착자의 보석 열풍',
  'cards.name.tunnel_crown_burrowers_lunch_break': '5 굴착자의 점심 휴식',
  'cards.name.tunnel_crown_burrowers_deep_march': '6 굴착자의 심층 행군',
  'cards.name.tunnel_crown_burrowers_rockfall': '7 굴착자의 낙석',
  'cards.name.tunnel_crown_burrowers_throne_run': '8 굴착자의 왕좌 질주',
  'cards.name.tunnel_crown_burrowers_last_tunnel': '9 굴착자의 마지막 굴',
  'cards.name.tunnel_crown_burrowers_uprising': '10 굴착자의 봉기',
  'cards.name.stormheart_conclave_stormlings_static': '1 폭풍아의 정전기',
  'cards.name.stormheart_conclave_stormlings_rain_dance': '2 폭풍아의 기우제 춤',
  'cards.name.stormheart_conclave_stormlings_wind_race': '3 폭풍아의 바람 경주',
  'cards.name.stormheart_conclave_stormlings_storm_call': '4 폭풍아의 폭풍 부름',
  'cards.name.stormheart_conclave_stormlings_cloudbreak': '5 폭풍아의 구름 가르기',
  'cards.name.stormheart_conclave_stormlings_thunder_roll': '6 폭풍아의 천둥소리',
  'cards.name.stormheart_conclave_stormlings_sky_brawl': '7 폭풍아의 하늘 난투',
  'cards.name.stormheart_conclave_stormlings_blackout': '8 폭풍아의 암전',
  'cards.name.stormheart_conclave_stormlings_tempest': '9 폭풍아의 대폭풍',
  'cards.name.stormheart_conclave_stormlings_big_bang': '10 폭풍아의 대폭발',
  'cards.name.roadknife_guild_bandits_heist': '1 산적의 강탈',
  'cards.name.roadknife_guild_bandits_lookout': '2 산적의 망보기',
  'cards.name.roadknife_guild_bandits_road_toll': '3 산적의 통행세',
  'cards.name.roadknife_guild_bandits_knife_game': '4 산적의 칼 놀이',
  'cards.name.roadknife_guild_bandits_bridge_job': '5 산적의 다리 작전',
  'cards.name.roadknife_guild_bandits_powder_plot': '6 산적의 화약 음모',
  'cards.name.roadknife_guild_bandits_night_raid': '7 산적의 야습',
  'cards.name.roadknife_guild_bandits_coach_job': '8 산적의 마차 습격',
  'cards.name.roadknife_guild_bandits_guild_vote': '9 산적의 길드 투표',
  'cards.name.roadknife_guild_bandits_last_score': '10 산적의 마지막 한탕',
  'cards.name.mirrorveil_chorus_spirits_glance': '1 정령의 눈길',
  'cards.name.mirrorveil_chorus_spirits_echo': '2 정령의 메아리',
  'cards.name.mirrorveil_chorus_spirits_double_take': '3 정령의 두 번 보기',
  'cards.name.mirrorveil_chorus_spirits_mirror_game': '4 정령의 거울 놀이',
  'cards.name.mirrorveil_chorus_spirits_glass_dance': '5 정령의 유리 춤',
  'cards.name.mirrorveil_chorus_spirits_name_swap': '6 정령의 이름 바꾸기',
  'cards.name.mirrorveil_chorus_spirits_lost_face': '7 정령의 잃은 얼굴',
  'cards.name.mirrorveil_chorus_spirits_hall_walk': '8 정령의 회랑 산책',
  'cards.name.mirrorveil_chorus_spirits_shattering': '9 정령의 산산조각',
  'cards.name.mirrorveil_chorus_spirits_encore': '10 정령의 앙코르',
  'cards.name.emberwatch_compact_wardens_watch': '1 수호자의 경계',
  'cards.name.emberwatch_compact_wardens_lantern_run': '2 수호자의 등불 순행',
  'cards.name.emberwatch_compact_wardens_fire_drill': '3 수호자의 화재 훈련',
  'cards.name.emberwatch_compact_wardens_night_shift': '4 수호자의 야간 근무',
  'cards.name.emberwatch_compact_wardens_beacon': '5 수호자의 봉화',
  'cards.name.emberwatch_compact_wardens_muster': '6 수호자의 소집',
  'cards.name.emberwatch_compact_wardens_rescue': '7 수호자의 구조',
  'cards.name.emberwatch_compact_wardens_last_watch': '8 수호자의 마지막 경계',
  'cards.name.emberwatch_compact_wardens_alarm': '9 수호자의 경보',
  'cards.name.emberwatch_compact_wardens_final_stand': '10 수호자의 최후 방어',
  'cards.name.cryptfire_covenant_fiends_spark': '1 악귀의 불티',
  'cards.name.cryptfire_covenant_fiends_grave_raid': '2 악귀의 도굴',
  'cards.name.cryptfire_covenant_fiends_bone_fire': '3 악귀의 뼈 화톳불',
  'cards.name.cryptfire_covenant_fiends_soul_hunt': '4 악귀의 영혼 사냥',
  'cards.name.cryptfire_covenant_fiends_crypt_feast': '5 악귀의 납골당 연회',
  'cards.name.cryptfire_covenant_fiends_ash_rite': '6 악귀의 재의 의식',
  'cards.name.cryptfire_covenant_fiends_hellgate': '7 악귀의 지옥문',
  'cards.name.cryptfire_covenant_fiends_doom_march': '8 악귀의 파멸의 행군',
  'cards.name.cryptfire_covenant_fiends_graveburn': '9 악귀의 무덤 화형',
  'cards.name.cryptfire_covenant_fiends_endtime': '10 악귀의 종말',
  'cards.name.tableborn_circle_gamblers_deal': '1 노름꾼의 패 돌리기',
  'cards.name.tableborn_circle_gamblers_small_bet': '2 노름꾼의 작은 판돈',
  'cards.name.tableborn_circle_gamblers_card_trick': '3 노름꾼의 카드 속임수',
  'cards.name.tableborn_circle_gamblers_poker_night': '4 노름꾼의 포커의 밤',
  'cards.name.tableborn_circle_gamblers_bad_hand': '5 노름꾼의 나쁜 패',
  'cards.name.tableborn_circle_gamblers_bluff': '6 노름꾼의 허세',
  'cards.name.tableborn_circle_gamblers_lucky_draw': '7 노름꾼의 행운의 뽑기',
  'cards.name.tableborn_circle_gamblers_table_flip': '8 노름꾼의 판 뒤집기',
  'cards.name.tableborn_circle_gamblers_final_bet': '9 노름꾼의 마지막 베팅',
  'cards.name.tableborn_circle_gamblers_grand_game': '10 노름꾼의 큰 판',
  'cards.name.greenwake_circle_treants_sprout': '1 나무정령의 새싹',
  'cards.name.greenwake_circle_treants_rain_song': '2 나무정령의 빗노래',
  'cards.name.greenwake_circle_treants_root_race': '3 나무정령의 뿌리 경주',
  'cards.name.greenwake_circle_treants_orchard_walk': '4 나무정령의 과수원 산책',
  'cards.name.greenwake_circle_treants_stag_hunt': '5 나무정령의 사슴 사냥',
  'cards.name.greenwake_circle_treants_bloom': '6 나무정령의 개화',
  'cards.name.greenwake_circle_treants_grove_dance': '7 나무정령의 숲속 춤',
  'cards.name.greenwake_circle_treants_wild_hunt': '8 나무정령의 광란의 사냥',
  'cards.name.greenwake_circle_treants_long_sleep': '9 나무정령의 긴 잠',
  'cards.name.greenwake_circle_treants_awakening': '10 나무정령의 각성',
  'cards.name.boneflame_host_skeletons_spark': '1 해골의 불티',
  'cards.name.boneflame_host_skeletons_bone_toss': '2 해골의 뼈 던지기',
  'cards.name.boneflame_host_skeletons_ash_dance': '3 해골의 재의 춤',
  'cards.name.boneflame_host_skeletons_grave_run': '4 해골의 무덤 질주',
  'cards.name.boneflame_host_skeletons_fire_walk': '5 해골의 불 밟기',
  'cards.name.boneflame_host_skeletons_pyre': '6 해골의 장작더미',
  'cards.name.boneflame_host_skeletons_crypt_roast': '7 해골의 납골당 화덕',
  'cards.name.boneflame_host_skeletons_last_march': '8 해골의 마지막 행군',
  'cards.name.boneflame_host_skeletons_bone_feast': '9 해골의 뼈 연회',
  'cards.name.boneflame_host_skeletons_inferno': '10 해골의 화염지옥',
  'cards.name.fenward_hunters_scout': '1 사냥꾼의 정찰',
  'cards.name.fenward_hunters_net_cast': '2 사냥꾼의 그물 던지기',
  'cards.name.fenward_hunters_bog_hunt': '3 사냥꾼의 늪 사냥',
  'cards.name.fenward_hunters_spider_trap': '4 사냥꾼의 거미 덫',
  'cards.name.fenward_hunters_trail': '5 사냥꾼의 자취',
  'cards.name.fenward_hunters_night_hunt': '6 사냥꾼의 밤 사냥',
  'cards.name.fenward_hunters_web_raid': '7 사냥꾼의 거미줄 습격',
  'cards.name.fenward_hunters_mire_watch': '8 사냥꾼의 수렁 경계',
  'cards.name.fenward_hunters_queen_hunt': '9 사냥꾼의 여왕 사냥',
  'cards.name.fenward_hunters_homecoming': '10 사냥꾼의 귀향',
  'cards.name.relicguard_order_sentinels_vigil': '1 파수병의 불침번',
  'cards.name.relicguard_order_sentinels_key_turn': '2 파수병의 열쇠 돌리기',
  'cards.name.relicguard_order_sentinels_vault_watch': '3 파수병의 금고 경계',
  'cards.name.relicguard_order_sentinels_seal': '4 파수병의 봉인',
  'cards.name.relicguard_order_sentinels_relic_hunt': '5 파수병의 유물 추적',
  'cards.name.relicguard_order_sentinels_oath': '6 파수병의 맹세',
  'cards.name.relicguard_order_sentinels_crypt_guard': '7 파수병의 납골당 경비',
  'cards.name.relicguard_order_sentinels_gate_lock': '8 파수병의 문 잠금',
  'cards.name.relicguard_order_sentinels_last_watch': '9 파수병의 마지막 경계',
  'cards.name.relicguard_order_sentinels_final_oath': '10 파수병의 마지막 맹세',
  'cards.name.questbound_caravan_travelers_errand': '1 나그네의 심부름',
  'cards.name.questbound_caravan_travelers_wrong_turn': '2 나그네의 잘못된 길',
  'cards.name.questbound_caravan_travelers_bridge_stop': '3 나그네의 다리 쉼터',
  'cards.name.questbound_caravan_travelers_camp': '4 나그네의 야영',
  'cards.name.questbound_caravan_travelers_side_quest': '5 나그네의 부차 임무',
  'cards.name.questbound_caravan_travelers_cart_fix': '6 나그네의 수레 수리',
  'cards.name.questbound_caravan_travelers_road_meal': '7 나그네의 길 위의 식사',
  'cards.name.questbound_caravan_travelers_lost_map': '8 나그네의 잃어버린 지도',
  'cards.name.questbound_caravan_travelers_boss_fight': '9 나그네의 보스전',
  'cards.name.questbound_caravan_travelers_homecoming': '10 나그네의 귀향',
  'cards.name.crownless_legends_whisper': '1 전설의 속삭임',
  'cards.name.crownless_legends_exile': '2 전설의 유배',
  'cards.name.crownless_legends_broken_oath': '3 전설의 깨진 맹세',
  'cards.name.crownless_legends_empty_hall': '4 전설의 텅 빈 전당',
  'cards.name.crownless_legends_last_song': '5 전설의 마지막 노래',
  'cards.name.crownless_legends_ghost_court': '6 전설의 유령 궁정',
  'cards.name.crownless_legends_lost_crown': '7 전설의 잃어버린 왕관',
  'cards.name.crownless_legends_kingless_feast': '8 전설의 왕 없는 연회',
  'cards.name.crownless_legends_final_war': '9 전설의 최후의 전쟁',
  'cards.name.crownless_legends_return': '10 전설의 귀환',
  'cards.text.briarpack_wolfs_nap': '공개될 때 무리를 {amount} 얻습니다. 이번 비교에서는 낮은 수치가 승리합니다.',
  'cards.text.briarpack_wolves_hunt': '무리가 {threshold} 이상이면 +{amount}.',
  'cards.text.briarpack_wolves_howl': '무리 1당 +{rate}, 현재 +{amount}.',
  'cards.text.briarpack_wolves_ambush': '공개될 때 무리를 {amount} 얻습니다. 무리가 {threshold} 이상이면 이번 라운드에는 영혼으로도 취급합니다.',
  'cards.text.briarpack_wolves_trail': '무리가 {threshold} 이상이면 +{amount}.',
  'cards.text.briarpack_wolves_moonrun': '무리 1당 +{rate}, 현재 +{amount}.',
  'cards.text.briarpack_wolves_feast': '공개될 때 무리를 {amount} 얻습니다.',
  'cards.text.briarpack_wolves_siege': '무리가 {threshold} 이상이면 +{amount}.',
  'cards.text.briarpack_wolves_overlook': '무리 1당 +{rate}, 현재 +{amount}.',
  'cards.text.briarpack_wolves_wild_night': '공개될 때 무리를 {amount} 얻습니다.',
  'cards.text.gravebound_court_ghosts_wake': '이 카드가 패배하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌리고 카드를 {drawCount}장 뽑습니다.',
  'cards.text.gravebound_court_ghosts_vigil': '이 카드가 패배하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.gravebound_court_ghosts_supper': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.gravebound_court_ghosts_grave_shift': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.gravebound_court_ghosts_bell_toll': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.gravebound_court_ghosts_procession': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.gravebound_court_ghosts_crypt_ball': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.gravebound_court_ghosts_court': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.gravebound_court_ghosts_coronation': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.gravebound_court_ghosts_reunion': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.sableweb_brood_spiders_web': '공개될 때 거미줄을 {amount} 얻고, 이번 라운드 상대 카드를 침묵시킵니다.',
  'cards.text.sableweb_brood_spiders_wait': '거미줄이 {threshold} 이상이면 +{amount}.',
  'cards.text.sableweb_brood_spiders_snack': '거미줄 1당 +{rate}, 현재 +{amount}.',
  'cards.text.sableweb_brood_spiders_silk_trap': '공개될 때 거미줄을 {amount} 얻습니다. 거미줄이 {threshold} 이상이면 이번 라운드에는 영혼으로도 취급합니다.',
  'cards.text.sableweb_brood_spiders_shed': '거미줄이 {threshold} 이상이면 +{amount}.',
  'cards.text.sableweb_brood_spiders_egg_hunt': '거미줄 1당 +{rate}, 현재 +{amount}.',
  'cards.text.sableweb_brood_spiders_tea_party': '공개될 때 거미줄을 {amount} 얻습니다.',
  'cards.text.sableweb_brood_spiders_night_watch': '거미줄이 {threshold} 이상이면 +{amount}.',
  'cards.text.sableweb_brood_spiders_feast': '거미줄 1당 +{rate}, 현재 +{amount}.',
  'cards.text.sableweb_brood_spiders_brood_rite': '공개될 때 거미줄을 {amount} 얻습니다.',
  'cards.text.ashen_flight_dragons_spark': '공개될 때 상대에게 공포를 {amount} 줍니다. 이번 비교에서 상대 카드는 {cap}를 넘을 수 없습니다.',
  'cards.text.ashen_flight_dragons_smoke_break': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.ashen_flight_dragons_roost': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.ashen_flight_dragons_first_raid': '공개될 때 상대에게 공포를 {amount} 줍니다.',
  'cards.text.ashen_flight_dragons_ashfall': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.ashen_flight_dragons_fire_drill': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.ashen_flight_dragons_sky_hunt': '공개될 때 상대에게 공포를 {amount} 줍니다. 이 카드가 승리하면 공포를 {bonus} 더 줍니다.',
  'cards.text.ashen_flight_dragons_bridge_roast': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.ashen_flight_dragons_sun_feast': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.ashen_flight_dragons_long_nap': '공개될 때 상대에게 공포를 {amount} 줍니다.',
  'cards.text.eastbrook_company_rangers_patrol': '이 카드가 패배하면 다음에 낼 야수가 +{amount}를 얻고, 버린 더미에서 가장 높은 야수가 손으로 돌아옵니다.',
  'cards.text.eastbrook_company_rangers_lost_map': '이 카드가 패배하면 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_dog_walk': '이 카드가 패배하면 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_campfire': '공개될 때 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_beast_hunt': '공개될 때 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_stable_shift': '공개될 때 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_roll_call': '이 카드가 승리하면 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_rescue': '이 카드가 승리하면 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_last_watch': '이 카드가 승리하면 다음에 낼 야수가 +{amount}를 얻습니다.',
  'cards.text.eastbrook_company_rangers_victory_march': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.ironward_assembly_golems_boot': '공개될 때 이번 비교에서는 낮은 수치가 승리하며, 이번 라운드 상대 카드를 침묵시킵니다.',
  'cards.text.ironward_assembly_golems_test_run': '이 카드는 무승부 라운드에서 승리합니다.',
  'cards.text.ironward_assembly_golems_watch': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.ironward_assembly_golems_tune_up': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.ironward_assembly_golems_forge_day': '이 카드는 상대 카드의 기본 수치가 됩니다.',
  'cards.text.ironward_assembly_golems_shield_wall': '이 카드가 처음 공개될 때 상대 카드는 이번 라운드 효과를 잃습니다.',
  'cards.text.ironward_assembly_golems_march': '이 카드를 처음 낼 때 양쪽의 실효 수치를 맞바꿉니다.',
  'cards.text.ironward_assembly_golems_lockdown': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.ironward_assembly_golems_last_stand': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.ironward_assembly_golems_awakening': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.mirefen_tide_mudfins_puddle': '이 카드가 패배하면 상대 손에서 무작위 {count}장을 공개하고, 상대는 무작위로 {discardCount}장을 버립니다.',
  'cards.text.mirefen_tide_mudfins_fish_fry': '이 카드가 패배하면 상대 손에서 무작위 {count}장을 공개합니다.',
  'cards.text.mirefen_tide_mudfins_net_cast': '이 카드가 승리하면 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.mirefen_tide_mudfins_bog_race': '이 카드가 승리하면 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.mirefen_tide_mudfins_reed_raid': '이 카드가 처음 공개될 때 상대의 손을 공개합니다.',
  'cards.text.mirefen_tide_mudfins_tide_call': '이 카드가 처음 공개될 때 상대의 손을 공개합니다.',
  'cards.text.mirefen_tide_mudfins_grub_feast': '상대 카드가 인간이면 +{amount}.',
  'cards.text.mirefen_tide_mudfins_mud_ball': '상대 카드가 인간이면 +{amount}.',
  'cards.text.mirefen_tide_mudfins_moon_croak': '이 카드가 승리할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.mirefen_tide_mudfins_flood': '공개될 때 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.tunnel_crown_burrowers_dig': '직전 카드가 굴착자였다면 +{amount}. 이 카드는 무승부에서 승리합니다.',
  'cards.text.tunnel_crown_burrowers_shift': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_cave_in': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_gem_rush': '이번 라운드에는 굴착자로 취급합니다. 직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_lunch_break': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_deep_march': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_rockfall': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_throne_run': '이번 라운드에는 굴착자로 취급합니다. 직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_last_tunnel': '직전 카드가 굴착자였다면 +{amount}.',
  'cards.text.tunnel_crown_burrowers_uprising': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.stormheart_conclave_stormlings_static': '상대 카드가 {threshold} 이상이면 -{amount}, 이번 비교에서 {cap}를 넘을 수 없습니다.',
  'cards.text.stormheart_conclave_stormlings_rain_dance': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.stormheart_conclave_stormlings_wind_race': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.stormheart_conclave_stormlings_storm_call': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.stormheart_conclave_stormlings_cloudbreak': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.stormheart_conclave_stormlings_thunder_roll': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.stormheart_conclave_stormlings_sky_brawl': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.stormheart_conclave_stormlings_blackout': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.stormheart_conclave_stormlings_tempest': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.stormheart_conclave_stormlings_big_bang': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.roadknife_guild_bandits_heist': '이 카드가 패배하면 상대 손에서 무작위 {count}장을 공개하고, 상대는 무작위로 {discardCount}장을 버립니다.',
  'cards.text.roadknife_guild_bandits_lookout': '이 카드가 패배하면 상대 손에서 무작위 {count}장을 공개합니다.',
  'cards.text.roadknife_guild_bandits_road_toll': '이 카드가 승리하면 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.roadknife_guild_bandits_knife_game': '이 카드가 승리하면 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.roadknife_guild_bandits_bridge_job': '이 카드가 처음 공개될 때 상대의 손을 공개합니다.',
  'cards.text.roadknife_guild_bandits_powder_plot': '이 카드가 처음 공개될 때 상대의 손을 공개합니다.',
  'cards.text.roadknife_guild_bandits_night_raid': '상대 카드가 인간이면 +{amount}.',
  'cards.text.roadknife_guild_bandits_coach_job': '상대 카드가 인간이면 +{amount}.',
  'cards.text.roadknife_guild_bandits_guild_vote': '이 카드가 승리할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.roadknife_guild_bandits_last_score': '공개될 때 상대는 무작위로 {count}장을 버립니다.',
  'cards.text.mirrorveil_chorus_spirits_glance': '공개될 때 이번 비교에서는 낮은 수치가 승리하며, 이번 라운드 상대 카드를 침묵시킵니다.',
  'cards.text.mirrorveil_chorus_spirits_echo': '이 카드는 무승부 라운드에서 승리합니다.',
  'cards.text.mirrorveil_chorus_spirits_double_take': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.mirrorveil_chorus_spirits_mirror_game': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.mirrorveil_chorus_spirits_glass_dance': '이 카드는 상대 카드의 기본 수치가 됩니다.',
  'cards.text.mirrorveil_chorus_spirits_name_swap': '이 카드가 처음 공개될 때 상대 카드는 이번 라운드 효과를 잃습니다.',
  'cards.text.mirrorveil_chorus_spirits_lost_face': '이 카드를 처음 낼 때 양쪽의 실효 수치를 맞바꿉니다.',
  'cards.text.mirrorveil_chorus_spirits_hall_walk': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.mirrorveil_chorus_spirits_shattering': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.mirrorveil_chorus_spirits_encore': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.emberwatch_compact_wardens_watch': '이 카드가 패배할 때마다 카드를 {amount}장 뽑고, 버린 더미에서 수치 {threshold} 이하의 가장 높은 인간을 손으로 되돌립니다.',
  'cards.text.emberwatch_compact_wardens_lantern_run': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.emberwatch_compact_wardens_fire_drill': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.emberwatch_compact_wardens_night_shift': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.emberwatch_compact_wardens_beacon': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.emberwatch_compact_wardens_muster': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.emberwatch_compact_wardens_rescue': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.emberwatch_compact_wardens_last_watch': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.emberwatch_compact_wardens_alarm': '이 카드가 승리할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.emberwatch_compact_wardens_final_stand': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.cryptfire_covenant_fiends_spark': '공개될 때 상대에게 공포를 {amount} 줍니다. 이번 비교에서 상대 카드는 {cap}를 넘을 수 없습니다.',
  'cards.text.cryptfire_covenant_fiends_grave_raid': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.cryptfire_covenant_fiends_bone_fire': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.cryptfire_covenant_fiends_soul_hunt': '공개될 때 상대에게 공포를 {amount} 줍니다.',
  'cards.text.cryptfire_covenant_fiends_crypt_feast': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.cryptfire_covenant_fiends_ash_rite': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.cryptfire_covenant_fiends_hellgate': '공개될 때 상대에게 공포를 {amount} 줍니다. 이 카드가 승리하면 공포를 {bonus} 더 줍니다.',
  'cards.text.cryptfire_covenant_fiends_doom_march': '상대의 공포 1당 +{rate}, 현재 +{amount}.',
  'cards.text.cryptfire_covenant_fiends_graveburn': '상대의 공포가 {threshold} 이상이면 상대 카드는 -{amount}.',
  'cards.text.cryptfire_covenant_fiends_endtime': '공개될 때 상대에게 공포를 {amount} 줍니다.',
  'cards.text.tableborn_circle_gamblers_deal': '이번 대전에서 낸 인간 카드 1장당 +{rate}, 현재 +{amount}. 이번 비교에서는 낮은 수치가 승리합니다.',
  'cards.text.tableborn_circle_gamblers_small_bet': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.tableborn_circle_gamblers_card_trick': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.tableborn_circle_gamblers_poker_night': '{round} 라운드부터 +{amount}.',
  'cards.text.tableborn_circle_gamblers_bad_hand': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cards.text.tableborn_circle_gamblers_bluff': '이번 대전에서 낸 인간 카드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.tableborn_circle_gamblers_lucky_draw': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.tableborn_circle_gamblers_table_flip': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.tableborn_circle_gamblers_final_bet': '{round} 라운드부터 +{amount}.',
  'cards.text.tableborn_circle_gamblers_grand_game': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cards.text.greenwake_circle_treants_sprout': '이번 대전에서 낸 정령 카드 1장당 +{rate}, 현재 +{amount}. 이번 라운드에는 영혼으로도 취급합니다.',
  'cards.text.greenwake_circle_treants_rain_song': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.greenwake_circle_treants_root_race': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.greenwake_circle_treants_orchard_walk': '{round} 라운드부터 +{amount}.',
  'cards.text.greenwake_circle_treants_stag_hunt': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cards.text.greenwake_circle_treants_bloom': '이번 대전에서 낸 정령 카드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.greenwake_circle_treants_grove_dance': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.greenwake_circle_treants_wild_hunt': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.greenwake_circle_treants_long_sleep': '{round} 라운드부터 +{amount}.',
  'cards.text.greenwake_circle_treants_awakening': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cards.text.boneflame_host_skeletons_spark': '이 카드가 패배하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌리고 카드를 {drawCount}장 뽑습니다.',
  'cards.text.boneflame_host_skeletons_bone_toss': '이 카드가 패배하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.boneflame_host_skeletons_ash_dance': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.boneflame_host_skeletons_grave_run': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.boneflame_host_skeletons_fire_walk': '이번 대전에서 잃은 언데드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.boneflame_host_skeletons_pyre': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.boneflame_host_skeletons_crypt_roast': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.boneflame_host_skeletons_last_march': '이 카드가 승리하면 버린 더미에서 수치 {threshold} 이하의 가장 높은 언데드를 손으로 되돌립니다.',
  'cards.text.boneflame_host_skeletons_bone_feast': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.boneflame_host_skeletons_inferno': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.fenward_hunters_scout': '상대 카드가 {threshold} 이상이면 -{amount}. 공개될 때 이번 라운드 상대 카드를 침묵시킵니다.',
  'cards.text.fenward_hunters_net_cast': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.fenward_hunters_bog_hunt': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.fenward_hunters_spider_trap': '상대 카드가 거미면 +{amount}.',
  'cards.text.fenward_hunters_trail': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.fenward_hunters_night_hunt': '상대 카드가 {threshold} 이상이면 +{amount}.',
  'cards.text.fenward_hunters_web_raid': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.fenward_hunters_mire_watch': '상대 카드가 거미면 +{amount}.',
  'cards.text.fenward_hunters_queen_hunt': '상대 카드가 {threshold} 이상이면 -{amount}.',
  'cards.text.fenward_hunters_homecoming': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.relicguard_order_sentinels_vigil': '공개될 때 이번 비교에서는 낮은 수치가 승리하며, 이번 라운드 상대 카드를 침묵시킵니다.',
  'cards.text.relicguard_order_sentinels_key_turn': '이 카드는 무승부 라운드에서 승리합니다.',
  'cards.text.relicguard_order_sentinels_vault_watch': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.relicguard_order_sentinels_seal': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.relicguard_order_sentinels_relic_hunt': '이 카드는 상대 카드의 기본 수치가 됩니다.',
  'cards.text.relicguard_order_sentinels_oath': '이 카드가 처음 공개될 때 상대 카드는 이번 라운드 효과를 잃습니다.',
  'cards.text.relicguard_order_sentinels_crypt_guard': '이 카드를 처음 낼 때 양쪽의 실효 수치를 맞바꿉니다.',
  'cards.text.relicguard_order_sentinels_gate_lock': '이 카드는 {amount} 아래로 내려가지 않습니다.',
  'cards.text.relicguard_order_sentinels_last_watch': '이번 라운드에 상대 카드는 {amount}를 넘을 수 없습니다.',
  'cards.text.relicguard_order_sentinels_final_oath': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.questbound_caravan_travelers_errand': '이 카드가 패배할 때마다 카드를 {amount}장 뽑고, 버린 더미에서 수치 {threshold} 이하의 가장 높은 카드를 손으로 되돌립니다.',
  'cards.text.questbound_caravan_travelers_wrong_turn': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.questbound_caravan_travelers_bridge_stop': '이 카드가 패배할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.questbound_caravan_travelers_camp': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.questbound_caravan_travelers_side_quest': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.questbound_caravan_travelers_cart_fix': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.questbound_caravan_travelers_road_meal': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.questbound_caravan_travelers_lost_map': '라운드 수에서 뒤지고 있는 동안 +{amount}.',
  'cards.text.questbound_caravan_travelers_boss_fight': '이 카드가 승리할 때마다 카드를 {amount}장 뽑습니다.',
  'cards.text.questbound_caravan_travelers_homecoming': '이 카드가 승리하면 다음에 낼 카드가 +{amount}를 얻습니다.',
  'cards.text.crownless_legends_whisper': '이번 대전에서 낸 영혼 카드 1장당 +{rate}, 현재 +{amount}. 이번 비교에서는 낮은 수치가 승리합니다.',
  'cards.text.crownless_legends_exile': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.crownless_legends_broken_oath': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.crownless_legends_empty_hall': '{round} 라운드부터 +{amount}.',
  'cards.text.crownless_legends_last_song': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cards.text.crownless_legends_ghost_court': '이번 대전에서 낸 영혼 카드 1장당 +{rate}, 현재 +{amount}.',
  'cards.text.crownless_legends_lost_crown': '이번 대전에서 서로 다른 종족을 {threshold} 종류 이상 냈다면 +{amount}.',
  'cards.text.crownless_legends_kingless_feast': '직전 카드가 패배했다면 +{amount}.',
  'cards.text.crownless_legends_final_war': '{round} 라운드부터 +{amount}.',
  'cards.text.crownless_legends_return': '{threshold} 라운드 연속으로 패배한 뒤 +{amount}.',
  'cardDeck.setFilterLabel': '세트로 거르기',
  'cardDeck.allSets': '모든 세트',
  'cardDeck.set.ashen_flight': '잿빛 비행',
  'cardDeck.set.boneflame_host': '뼈불꽃 군단',
  'cardDeck.set.briarpack': '가시덤불 무리',
  'cardDeck.set.crownless_legends': '왕관 없는 전설',
  'cardDeck.set.cryptfire_covenant': '묘화 서약',
  'cardDeck.set.eastbrook_company': '이스트브룩 상단',
  'cardDeck.set.emberwatch_compact': '잔불 감시단',
  'cardDeck.set.fenward_hunters': '늪지기 사냥꾼',
  'cardDeck.set.gravebound_court': '무덤에 묶인 궁정',
  'cardDeck.set.greenwake_circle': '푸른 각성의 원',
  'cardDeck.set.ironward_assembly': '강철 수호 의회',
  'cardDeck.set.mirefen_tide': '수렁의 조수',
  'cardDeck.set.mirrorveil_chorus': '거울 장막 합창',
  'cardDeck.set.questbound_caravan': '여정의 대상',
  'cardDeck.set.relicguard_order': '유물 수호 기사단',
  'cardDeck.set.roadknife_guild': '노상강도 길드',
  'cardDeck.set.sableweb_brood': '검은 실 무리',
  'cardDeck.set.stormheart_conclave': '폭풍심장 회합',
  'cardDeck.set.tableborn_circle': '도박판의 자식들',
  'cardDeck.set.tunnel_crown': '굴의 왕관',
  'cardDeck.set.basics': '기본 카드',
