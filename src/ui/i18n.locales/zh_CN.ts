...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.controls.human': '玩家',
  'cards.controls.label': '牌桌控制',
  'cards.controls.master': '大师',
  'cards.controls.newMatch': '新对局',
  'cards.controls.novice': '新手',
  'cards.controls.opponentA': 'A 座位由',
  'cards.controls.opponentB': 'B 座位由',
  'cards.controls.runToEndHint': '两个座位都必须由电脑对手操作。',
  'cards.controls.seedHint': '相同的种子每次都会发出相同的对局。',
  'cards.controls.sharp': '敏锐',
  'cards.controls.steady': '稳健',
  'cards.docTitle': '卡牌对决试玩 - World of ClaudeCraft',
  'cards.intro': '一张不依赖游戏世界的卡牌对决桌，运行的是正式版规则引擎。设置随机种子即可复现完全相同的洗牌。',
  ...
  'cards.result.live': '对局进行中。',
  'cards.result.winA': 'A 座位赢得本局。',
  'cards.result.winB': 'B 座位赢得本局。',
  'cards.round.empty': '尚未进行任何回合。',
  'cards.round.heading': '第 {round} 回合',
  'cards.round.outcomeLose': 'B 座位以 {b} 比 {a} 赢下本回合。',
  'cards.round.outcomePush': '本回合以 {a} 打平。',
  'cards.round.outcomeWin': 'A 座位以 {a} 比 {b} 赢下本回合。',
  'cards.round.overflow': '结算达到步数上限，本回合按当前数值判定。',
  'cards.round.reshuffled': '一方的弃牌堆已重新洗回牌库。',
  'cards.round.steps': '已结算 {count} 个效果。',
  'cards.seat.committed': '已锁定出牌',
  'cards.seat.discardCount': '弃牌堆：{count}',
  'cards.seat.score': '已胜回合：{count}',
  'cards.seat.waiting': '选牌中...',
  'cards.seat.you': '你的座位',
  ...
  'cards.round.verdictA': 'A 席赢得本轮',
  'cards.round.verdictB': 'B 席赢得本轮',
  'cards.round.verdictPush': '本轮打平',
  ...
  'cardDuel.pipsAria': '{name}：已赢 {won}/{total} 轮',
  'cardDuel.revealedHeading': '已看到的对手手牌',
