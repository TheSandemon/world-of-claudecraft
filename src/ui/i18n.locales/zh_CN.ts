...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.name.ashen_wyrm': '灰烬巨蛇',
  'cards.name.bone_picker': '拾骨者',
  'cards.name.bramble_sprite': '荆棘精灵',
  'cards.name.doppelganger': '拟形者',
  'cards.name.ember_drake': '余烬幼龙',
  'cards.name.forest_wolf': '森林狼',
  'cards.name.grave_candle': '墓地烛火',
  'cards.name.grave_rat': '墓地老鼠',
  'cards.name.grave_warden': '墓地守望者',
  'cards.name.grix_tunnelking': '隧道之王格里克斯',
  'cards.name.hollow_knight': '空洞骑士',
  'cards.name.ironclad': '铁甲卫',
  'cards.name.mire_toad': '泥沼蟾蜍',
  'cards.name.mirefen_ambusher': '泥沼伏击者',
  'cards.name.mudfin_scout': '泥鳍斥候',
  'cards.name.necromancer': '亡灵法师',
  'cards.name.nullstone': '虚无石',
  'cards.name.nythraxis_broodling': '奈斯拉克斯幼裔',
  'cards.name.old_greyjaw': '老灰颚',
  'cards.name.pack_alpha': '兽群首领',
  'cards.name.ratling_thief': '鼠人窃贼',
  'cards.name.sable_matriarch': '黑蛛女王',
  'cards.name.sableweb_hexer': '黑网巫师',
  'cards.name.stablemaster': '马厩总管',
  'cards.name.stormcaller': '唤风者',
  'cards.name.torchbearer': '执炬者',
  'cards.name.tunnel_guard': '隧道守卫',
  'cards.name.vale_champion': '山谷勇士',
  'cards.name.vale_warden': '山谷守卫',
  'cards.name.web_spinner': '织网蛛',
  'cards.noRulesText': '无效果。',
  'cards.text.ashen_wyrm': '展示时，使对手获得 {amount} 层恐惧。',
  'cards.text.bone_picker': '本局中你每打出一张亡灵牌，此牌便获得 +1。',
  'cards.text.bramble_sprite': '本回合此牌视为野兽，并获得 +{amount}。',
  'cards.text.doppelganger': '此牌的数值变为对手牌的基础数值。',
  'cards.text.ember_drake': '对手每有 1 层恐惧，此牌便获得 +1。',
  'cards.text.forest_wolf': '若你上一张牌是野兽牌，此牌获得 +{amount}。',
  'cards.text.grave_candle': '若此牌落败，你的下一张亡灵牌获得 +{amount}。',
  'cards.text.grave_rat': '本回合对手的牌获得 -{amount}。',
  'cards.text.grave_warden': '若此牌获胜，将你弃牌堆中数值 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.grix_tunnelking': '若此牌获胜，你的下一张牌获得 -{amount}。',
  'cards.text.hollow_knight': '此牌在平局回合中获胜。',
  'cards.text.ironclad': '本回合对手的牌数值不会超过 {amount}。',
  'cards.text.mire_toad': '若对手的牌为 {threshold} 或更高，此牌获得 +{amount}。',
  'cards.text.mirefen_ambusher': '若对手的牌是人类，此牌获得 +{amount}。',
  'cards.text.mudfin_scout': '若此牌落败，随机展示对手手牌中的 {count} 张牌。',
  'cards.text.necromancer': '你的下一张亡灵牌获得 +{amount}。',
  'cards.text.nullstone': '本回合对手的牌不产生任何效果。',
  'cards.text.nythraxis_broodling': '展示时，使对手获得 {amount} 层恐惧。',
  'cards.text.old_greyjaw': '当你在回合数上落后时，此牌获得 +{amount}。',
  'cards.text.pack_alpha': '本局中你每打出两张野兽牌，此牌便获得 +1。',
  'cards.text.ratling_thief': '若此牌获胜，对手随机弃掉一张手牌。',
  'cards.text.sable_matriarch': '你每有 1 层蛛网，此牌便获得 +1。',
  'cards.text.sableweb_hexer': '若对手的牌是人类，则其获得 -{amount}。',
  'cards.text.stablemaster': '你的下一张野兽牌获得 +{amount}。',
  'cards.text.stormcaller': '若对手的牌为 {threshold} 或更高，则其获得 -{amount}。',
  'cards.text.torchbearer': '当你在回合数上落后时，此牌获得 +{amount}。',
  'cards.text.tunnel_guard': '此牌的数值不会被降至 {amount} 以下。',
  'cards.text.vale_champion': '若此牌落败，抽 {amount} 张牌。',
  'cards.text.vale_warden': '若此牌获胜，抽 {amount} 张牌。',
  'cards.text.web_spinner': '展示时，获得 {amount} 层蛛网。',
