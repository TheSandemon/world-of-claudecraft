...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.card_master.greeting': '来一局ClaudeStone？三局两胜，赢家赢得吹嘘的资本。',
  'cardDuel.title': 'ClaudeStone',
  'cardDuel.close': '关闭',
  'cardDuel.join': '加入队列',
  'cardDuel.joinAria': '加入ClaudeStone队列',
  'cardDuel.leave': '离开队列',
  'cardDuel.leaveAria': '离开ClaudeStone队列',
  'cardDuel.queued': '正在等待对手……',
  'cardDuel.vsOpponent': '对战 {name}',
  'cardDuel.round': '局分：{mine} - {theirs}',
  'cardDuel.forfeit': '认输',
  'cardDuel.forfeitAria': '认输退出ClaudeStone',
  'cardDuel.unavailable': 'ClaudeStone需要另一名玩家在线。',
  ...
  'guide.questsPage.cardMasterBody': '东溪镇有一位 NPC 发的不是差事，而是纸牌。找到纸牌大师，从他的菜单里选择ClaudeStone，你就会进入队列，与下一位等待的玩家配对。任何职业都能坐下来玩，等级和装备都不作数。双方各用自己的二十张牌组：一到十每个数值各两张，且没有重复的牌，因此每副牌组的原始强度都相同，差别只在于你选了哪些牌。你手上始终有四张，每回合结束后补满到四张。牌的作用不止于数字：狼会随着身后的兽群变强，石头能让对手这一回合失去效果，烛火会为你下一张亡灵牌赐福。结算完这一切后数值更高的一方赢下该回合，两张数值相同则为平局，双方都不计分。先赢两回合者拿下整局，因此一场对决是三局两胜。回合有计时：四十五秒内不出牌，整局便判给对方，除非尚未分出任何回合，那样就直接作废、没有胜者。如果双方在已经出过牌之后都让计时耗尽，这场对决会记为平局。你自己中途离开也适用同样的规则。加入队列必须站在纸牌大师身旁，但一旦配对成功，牌桌会自行打开，你在任何地方都能出牌。这需要两个人，所以离线世界永远不会提供它。',
  ...
  'cards.card.effectiveLabel': '实际数值 {value}',
  'cards.card.valueLabel': '数值 {value}',
  'cards.card.playDetail': '打出{name}，数值{value}。{rules}',
  'cards.noRulesText': '无效果。',
  'cards.tribe.Bandit': '强盗',
  'cards.tribe.Beast': '野兽',
  'cards.tribe.Burrower': '掘地者',
  'cards.tribe.Construct': '构造体',
  'cards.tribe.Demon': '恶魔',
  'cards.tribe.Dragon': '巨龙',
  'cards.tribe.Elemental': '元素',
  'cards.tribe.Human': '人类',
  'cards.tribe.Mudfin': '泥鳍',
  'cards.tribe.Spider': '蜘蛛',
  'cards.tribe.Spirit': '幽魂',
  'cards.tribe.Undead': '亡灵',
  'cardDuel.clock': '剩余 {seconds} 秒',
  'cardDuel.clockAria': '本回合剩余秒数：{seconds}',
  'cardDuel.clockOut': '时间到',
  'cardDuel.clockHeld': '正在结算本回合',
  'cardDuel.summary.win': '你赢下这场对决',
  'cardDuel.summary.loss': '你输掉这场对决',
  'cardDuel.summary.draw': '这场对决打平',
  'cardDuel.summary.against': '对手：{name}',
  'cardDuel.summary.health': '剩余生命',
  'cardDuel.summary.rounds': '回合数',
  'cardDuel.summary.dealt': '造成伤害',
  'cardDuel.summary.taken': '承受伤害',
  'cardDuel.summary.bestHit': '最大一击',
  'cardDuel.summary.bestHitValue': '第 {round} 回合用{card}打出 {amount}',
  'cardDuel.summary.rematch': '再来一局',
  'cardDuel.summary.done': '离开牌桌',
  'cardDuel.revealLose': '你输掉本回合',
  'cardDuel.revealMine': '你出的牌',
  'cardDuel.revealPush': '本回合打平',
  'cardDuel.revealReshuffled': '你的弃牌堆已重新洗回牌库。',
  'cardDuel.revealTheirs': '对手出的牌',
  'cardDuel.revealWin': '你赢下本回合',
  'cardDeck.close': '关闭',
  'cardDeck.defaultName': '新牌组',
  'cardDeck.delete': '删除牌组',
  'cardDeck.emptySlot': '数值 {value} 的空槽位',
  'cardDeck.nameLabel': '牌组名称',
  'cardDeck.open': '牌组',
  'cardDeck.openAria': '打开牌组编辑器',
  'cardDeck.progress': '已填 {filled} / {required} 个槽位',
  'cardDeck.rowTitle': '数值 {value}',
  'cardDeck.rule': '一副牌组是二十张：一到十每个数值各两张，且没有重复的牌。',
  'cardDeck.save': '保存牌组',
  'cardDeck.title': '牌组编辑器',
  'cardOpponents.heading': '与常客对局',
  'cardOpponents.sitDown': '与 {name} 对局',
  'cardOpponents.tier.master': '大师',
  'cardOpponents.tier.novice': '新手',
  'cardOpponents.tier.sharp': '敏锐',
  'cardOpponents.tier.steady': '稳健',
  'cards.opponent.dockhand_pell.greeting': '小心泥地。在我那一带，泥是会咬人的。',
  'cards.opponent.dockhand_pell.name': '佩尔',
  'cards.opponent.dockhand_pell.title': '码头工',
  'cards.opponent.gravedigger_ossa.greeting': '我埋下的东西，没有一样能安分躺着。',
  'cards.opponent.gravedigger_ossa.name': '奥萨',
  'cards.opponent.gravedigger_ossa.title': '掘墓人',
  'cards.opponent.huntsman_bregg.greeting': '一头狼只是麻烦。六头狼就是一场狩猎。',
  'cards.opponent.huntsman_bregg.name': '布雷格',
  'cards.opponent.huntsman_bregg.title': '猎手',
  'cards.opponent.the_card_master.greeting': '坐吧。每个人拿到的都是同样的二十张牌。让我看看你选了哪些。',
  'cards.opponent.the_card_master.name': '纸牌大师',
  'cards.opponent.the_card_master.title': '牌桌的守护者',
  'cards.counter.Pack': '狼群',
  'cards.counter.Dread': '恐惧',
  'cardDuel.commitLocked': '已出牌',
  'cardDuel.commitChoosing': '选择中',
  'cardDuel.waitingBoth': '双方都在选牌',
  'cardDuel.waitingThem': '等待对手出牌',
  'cardDuel.waitingMe': '对手已就绪',
  'cardDuel.waitingReveal': '正在揭示本轮',
  'cardDuel.healthAria': '{name}：生命 {hp}/{max}',
  'cardDuel.roundsWon': '已胜回合：{count}',
  'cardDuel.pileDiscardTheirs': '对手的弃牌堆',
  'cardDuel.pileDiscard': '弃牌堆：{count}',
  'cardDuel.stageIdle': '牌桌上还没有牌',
  'cardDuel.beat.deal': '牌已扣下',
  'cardDuel.beat.reveal': '翻开牌面',
  'cardDuel.beat.effectValue': '{card}：{target} {amount}',
  'cardDuel.beat.effectSilence': '{card}沉默了对方的牌',
  'cardDuel.beat.effectReveal': '{card}揭示一张牌',
  'cardDuel.beat.effectDraw': '{card}抽了一张牌',
  'cardDuel.beat.effectSwap': '{card}交换了双方数值',
  'cardDuel.beat.effectOther': '{card}生效',
  'cardDuel.beat.yourCard': '你的牌',
  'cardDuel.beat.theirCard': '对方的牌',
  'cardDuel.damageMine': '你受到 {amount} 点伤害',
  'cardDuel.damageTheirs': '对手受到 {amount} 点伤害',
  'cardDuel.beat.clash': '两牌交锋',
  'cardDuel.beat.finish': '最后一击落下',
  'cardDuel.beat.gloryWin': '这场对决属于你',
  'cardDuel.beat.gloryLose': '这场对决输了',
  'cardDuel.beat.gloryDraw': '这场对决打成平手',
  'cardDuel.announce': '你打出 {mine}，对手打出 {theirs}。{outcome}',
  'cardDuel.oppoHandHidden': '对手手牌：{count}',
  'cardDuel.oppoHandSeen': '对手手牌：{count}，已看到 {seen}',
  'cardDuel.effectsHeading': '仍在生效',
  'cardDuel.durationNextRound': '下一轮',
  'cardDuel.durationUntilTriggered': '直到触发',
  'cardDuel.durationMatchEnd': '本局剩余时间',
  'cards.name.briarpack_wolfs_nap': '1 狼之小憩',
  'cards.name.briarpack_wolves_hunt': '2 狼之狩猎',
  'cards.name.briarpack_wolves_howl': '3 狼之嚎叫',
  'cards.name.briarpack_wolves_ambush': '4 狼之伏击',
  'cards.name.briarpack_wolves_trail': '5 狼之足迹',
  'cards.name.briarpack_wolves_moonrun': '6 狼之月夜疾行',
  'cards.name.briarpack_wolves_feast': '7 狼之盛宴',
  'cards.name.briarpack_wolves_siege': '8 狼之围攻',
  'cards.name.briarpack_wolves_overlook': '9 狼之瞭望',
  'cards.name.briarpack_wolves_wild_night': '10 狼之狂野之夜',
  'cards.name.gravebound_court_ghosts_wake': '1 幽魂之守灵',
  'cards.name.gravebound_court_ghosts_vigil': '2 幽魂之守夜',
  'cards.name.gravebound_court_ghosts_supper': '3 幽魂之晚膳',
  'cards.name.gravebound_court_ghosts_grave_shift': '4 幽魂之守墓班',
  'cards.name.gravebound_court_ghosts_bell_toll': '5 幽魂之丧钟',
  'cards.name.gravebound_court_ghosts_procession': '6 幽魂之行列',
  'cards.name.gravebound_court_ghosts_crypt_ball': '7 幽魂之墓窖舞会',
  'cards.name.gravebound_court_ghosts_court': '8 幽魂之宫廷',
  'cards.name.gravebound_court_ghosts_coronation': '9 幽魂之加冕',
  'cards.name.gravebound_court_ghosts_reunion': '10 幽魂之重聚',
  'cards.name.sableweb_brood_spiders_web': '1 蜘蛛之蛛网',
  'cards.name.sableweb_brood_spiders_wait': '2 蜘蛛之守候',
  'cards.name.sableweb_brood_spiders_snack': '3 蜘蛛之小食',
  'cards.name.sableweb_brood_spiders_silk_trap': '4 蜘蛛之丝网陷阱',
  'cards.name.sableweb_brood_spiders_shed': '5 蜘蛛之蜕壳',
  'cards.name.sableweb_brood_spiders_egg_hunt': '6 蜘蛛之寻卵',
  'cards.name.sableweb_brood_spiders_tea_party': '7 蜘蛛之茶会',
  'cards.name.sableweb_brood_spiders_night_watch': '8 蜘蛛之夜巡',
  'cards.name.sableweb_brood_spiders_feast': '9 蜘蛛之盛宴',
  'cards.name.sableweb_brood_spiders_brood_rite': '10 蜘蛛之孵育仪式',
  'cards.name.ashen_flight_dragons_spark': '1 巨龙之火星',
  'cards.name.ashen_flight_dragons_smoke_break': '2 巨龙之吐息小憩',
  'cards.name.ashen_flight_dragons_roost': '3 巨龙之栖巢',
  'cards.name.ashen_flight_dragons_first_raid': '4 巨龙之初袭',
  'cards.name.ashen_flight_dragons_ashfall': '5 巨龙之落灰',
  'cards.name.ashen_flight_dragons_fire_drill': '6 巨龙之火演',
  'cards.name.ashen_flight_dragons_sky_hunt': '7 巨龙之天空狩猎',
  'cards.name.ashen_flight_dragons_bridge_roast': '8 巨龙之焚桥',
  'cards.name.ashen_flight_dragons_sun_feast': '9 巨龙之日宴',
  'cards.name.ashen_flight_dragons_long_nap': '10 巨龙之长眠',
  'cards.name.eastbrook_company_rangers_patrol': '1 游侠之巡逻',
  'cards.name.eastbrook_company_rangers_lost_map': '2 游侠之遗失地图',
  'cards.name.eastbrook_company_rangers_dog_walk': '3 游侠之遛犬',
  'cards.name.eastbrook_company_rangers_campfire': '4 游侠之营火',
  'cards.name.eastbrook_company_rangers_beast_hunt': '5 游侠之猎兽',
  'cards.name.eastbrook_company_rangers_stable_shift': '6 游侠之马厩轮值',
  'cards.name.eastbrook_company_rangers_roll_call': '7 游侠之点名',
  'cards.name.eastbrook_company_rangers_rescue': '8 游侠之救援',
  'cards.name.eastbrook_company_rangers_last_watch': '9 游侠之最后守望',
  'cards.name.eastbrook_company_rangers_victory_march': '10 游侠之凯旋行军',
  'cards.name.ironward_assembly_golems_boot': '1 石魔之启动',
  'cards.name.ironward_assembly_golems_test_run': '2 石魔之试运行',
  'cards.name.ironward_assembly_golems_watch': '3 石魔之守望',
  'cards.name.ironward_assembly_golems_tune_up': '4 石魔之调校',
  'cards.name.ironward_assembly_golems_forge_day': '5 石魔之锻造日',
  'cards.name.ironward_assembly_golems_shield_wall': '6 石魔之盾墙',
  'cards.name.ironward_assembly_golems_march': '7 石魔之行军',
  'cards.name.ironward_assembly_golems_lockdown': '8 石魔之封锁',
  'cards.name.ironward_assembly_golems_last_stand': '9 石魔之背水一战',
  'cards.name.ironward_assembly_golems_awakening': '10 石魔之觉醒',
  'cards.name.mirefen_tide_mudfins_puddle': '1 泥鳍之水洼',
  'cards.name.mirefen_tide_mudfins_fish_fry': '2 泥鳍之煎鱼',
  'cards.name.mirefen_tide_mudfins_net_cast': '3 泥鳍之撒网',
  'cards.name.mirefen_tide_mudfins_bog_race': '4 泥鳍之沼泽竞逐',
  'cards.name.mirefen_tide_mudfins_reed_raid': '5 泥鳍之芦苇突袭',
  'cards.name.mirefen_tide_mudfins_tide_call': '6 泥鳍之潮汐召唤',
  'cards.name.mirefen_tide_mudfins_grub_feast': '7 泥鳍之幼虫盛宴',
  'cards.name.mirefen_tide_mudfins_mud_ball': '8 泥鳍之泥球',
  'cards.name.mirefen_tide_mudfins_moon_croak': '9 泥鳍之月下蛙鸣',
  'cards.name.mirefen_tide_mudfins_flood': '10 泥鳍之洪流',
  'cards.name.tunnel_crown_burrowers_dig': '1 掘穴者之挖掘',
  'cards.name.tunnel_crown_burrowers_shift': '2 掘穴者之轮值',
  'cards.name.tunnel_crown_burrowers_cave_in': '3 掘穴者之塌方',
  'cards.name.tunnel_crown_burrowers_gem_rush': '4 掘穴者之宝石热潮',
  'cards.name.tunnel_crown_burrowers_lunch_break': '5 掘穴者之午休',
  'cards.name.tunnel_crown_burrowers_deep_march': '6 掘穴者之深处行军',
  'cards.name.tunnel_crown_burrowers_rockfall': '7 掘穴者之落石',
  'cards.name.tunnel_crown_burrowers_throne_run': '8 掘穴者之夺位疾行',
  'cards.name.tunnel_crown_burrowers_last_tunnel': '9 掘穴者之最后隧道',
  'cards.name.tunnel_crown_burrowers_uprising': '10 掘穴者之起义',
  'cards.name.stormheart_conclave_stormlings_static': '1 风暴之子之静电',
  'cards.name.stormheart_conclave_stormlings_rain_dance': '2 风暴之子之祈雨舞',
  'cards.name.stormheart_conclave_stormlings_wind_race': '3 风暴之子之御风竞速',
  'cards.name.stormheart_conclave_stormlings_storm_call': '4 风暴之子之风暴召唤',
  'cards.name.stormheart_conclave_stormlings_cloudbreak': '5 风暴之子之破云',
  'cards.name.stormheart_conclave_stormlings_thunder_roll': '6 风暴之子之雷鸣滚滚',
  'cards.name.stormheart_conclave_stormlings_sky_brawl': '7 风暴之子之天空混战',
  'cards.name.stormheart_conclave_stormlings_blackout': '8 风暴之子之黑幕',
  'cards.name.stormheart_conclave_stormlings_tempest': '9 风暴之子之狂澜',
  'cards.name.stormheart_conclave_stormlings_big_bang': '10 风暴之子之惊天一击',
  'cards.name.roadknife_guild_bandits_heist': '1 强盗之劫案',
  'cards.name.roadknife_guild_bandits_lookout': '2 强盗之望风',
  'cards.name.roadknife_guild_bandits_road_toll': '3 强盗之过路费',
  'cards.name.roadknife_guild_bandits_knife_game': '4 强盗之飞刀赌局',
  'cards.name.roadknife_guild_bandits_bridge_job': '5 强盗之桥头买卖',
  'cards.name.roadknife_guild_bandits_powder_plot': '6 强盗之火药阴谋',
  'cards.name.roadknife_guild_bandits_night_raid': '7 强盗之夜袭',
  'cards.name.roadknife_guild_bandits_coach_job': '8 强盗之劫车',
  'cards.name.roadknife_guild_bandits_guild_vote': '9 强盗之行会表决',
  'cards.name.roadknife_guild_bandits_last_score': '10 强盗之最后一票',
  'cards.name.mirrorveil_chorus_spirits_glance': '1 灵魂之一瞥',
  'cards.name.mirrorveil_chorus_spirits_echo': '2 灵魂之回响',
  'cards.name.mirrorveil_chorus_spirits_double_take': '3 灵魂之二度回望',
  'cards.name.mirrorveil_chorus_spirits_mirror_game': '4 灵魂之镜中游戏',
  'cards.name.mirrorveil_chorus_spirits_glass_dance': '5 灵魂之琉璃之舞',
  'cards.name.mirrorveil_chorus_spirits_name_swap': '6 灵魂之易名',
  'cards.name.mirrorveil_chorus_spirits_lost_face': '7 灵魂之失容',
  'cards.name.mirrorveil_chorus_spirits_hall_walk': '8 灵魂之厅堂漫步',
  'cards.name.mirrorveil_chorus_spirits_shattering': '9 灵魂之碎裂',
  'cards.name.mirrorveil_chorus_spirits_encore': '10 灵魂之安可',
  'cards.name.emberwatch_compact_wardens_watch': '1 守望者之守望',
  'cards.name.emberwatch_compact_wardens_lantern_run': '2 守望者之提灯巡行',
  'cards.name.emberwatch_compact_wardens_fire_drill': '3 守望者之火演',
  'cards.name.emberwatch_compact_wardens_night_shift': '4 守望者之夜班',
  'cards.name.emberwatch_compact_wardens_beacon': '5 守望者之烽火',
  'cards.name.emberwatch_compact_wardens_muster': '6 守望者之集结',
  'cards.name.emberwatch_compact_wardens_rescue': '7 守望者之救援',
  'cards.name.emberwatch_compact_wardens_last_watch': '8 守望者之最后守望',
  'cards.name.emberwatch_compact_wardens_alarm': '9 守望者之警号',
  'cards.name.emberwatch_compact_wardens_final_stand': '10 守望者之终局死守',
  'cards.name.cryptfire_covenant_fiends_spark': '1 邪魔之火星',
  'cards.name.cryptfire_covenant_fiends_grave_raid': '2 邪魔之盗墓',
  'cards.name.cryptfire_covenant_fiends_bone_fire': '3 邪魔之骨火',
  'cards.name.cryptfire_covenant_fiends_soul_hunt': '4 邪魔之猎魂',
  'cards.name.cryptfire_covenant_fiends_crypt_feast': '5 邪魔之墓窖盛宴',
  'cards.name.cryptfire_covenant_fiends_ash_rite': '6 邪魔之灰烬仪式',
  'cards.name.cryptfire_covenant_fiends_hellgate': '7 邪魔之地狱之门',
  'cards.name.cryptfire_covenant_fiends_doom_march': '8 邪魔之末日行军',
  'cards.name.cryptfire_covenant_fiends_graveburn': '9 邪魔之焚墓',
  'cards.name.cryptfire_covenant_fiends_endtime': '10 邪魔之终末',
  'cards.name.tableborn_circle_gamblers_deal': '1 赌徒之发牌',
  'cards.name.tableborn_circle_gamblers_small_bet': '2 赌徒之小注',
  'cards.name.tableborn_circle_gamblers_card_trick': '3 赌徒之纸牌戏法',
  'cards.name.tableborn_circle_gamblers_poker_night': '4 赌徒之牌局之夜',
  'cards.name.tableborn_circle_gamblers_bad_hand': '5 赌徒之烂牌',
  'cards.name.tableborn_circle_gamblers_bluff': '6 赌徒之诈唬',
  'cards.name.tableborn_circle_gamblers_lucky_draw': '7 赌徒之幸运抽牌',
  'cards.name.tableborn_circle_gamblers_table_flip': '8 赌徒之掀桌',
  'cards.name.tableborn_circle_gamblers_final_bet': '9 赌徒之最终一注',
  'cards.name.tableborn_circle_gamblers_grand_game': '10 赌徒之大局',
  'cards.name.greenwake_circle_treants_sprout': '1 树人之新芽',
  'cards.name.greenwake_circle_treants_rain_song': '2 树人之雨歌',
  'cards.name.greenwake_circle_treants_root_race': '3 树人之根须竞逐',
  'cards.name.greenwake_circle_treants_orchard_walk': '4 树人之果园漫步',
  'cards.name.greenwake_circle_treants_stag_hunt': '5 树人之猎鹿',
  'cards.name.greenwake_circle_treants_bloom': '6 树人之绽放',
  'cards.name.greenwake_circle_treants_grove_dance': '7 树人之林间之舞',
  'cards.name.greenwake_circle_treants_wild_hunt': '8 树人之狂野狩猎',
  'cards.name.greenwake_circle_treants_long_sleep': '9 树人之长眠',
  'cards.name.greenwake_circle_treants_awakening': '10 树人之觉醒',
  'cards.name.boneflame_host_skeletons_spark': '1 骷髅之火星',
  'cards.name.boneflame_host_skeletons_bone_toss': '2 骷髅之掷骨',
  'cards.name.boneflame_host_skeletons_ash_dance': '3 骷髅之灰舞',
  'cards.name.boneflame_host_skeletons_grave_run': '4 骷髅之墓间疾行',
  'cards.name.boneflame_host_skeletons_fire_walk': '5 骷髅之踏火',
  'cards.name.boneflame_host_skeletons_pyre': '6 骷髅之柴堆',
  'cards.name.boneflame_host_skeletons_crypt_roast': '7 骷髅之墓窖炙宴',
  'cards.name.boneflame_host_skeletons_last_march': '8 骷髅之最后行军',
  'cards.name.boneflame_host_skeletons_bone_feast': '9 骷髅之骨宴',
  'cards.name.boneflame_host_skeletons_inferno': '10 骷髅之炼狱',
  'cards.name.fenward_hunters_scout': '1 猎人之侦察',
  'cards.name.fenward_hunters_net_cast': '2 猎人之撒网',
  'cards.name.fenward_hunters_bog_hunt': '3 猎人之沼泽狩猎',
  'cards.name.fenward_hunters_spider_trap': '4 猎人之捕蛛陷阱',
  'cards.name.fenward_hunters_trail': '5 猎人之足迹',
  'cards.name.fenward_hunters_night_hunt': '6 猎人之夜猎',
  'cards.name.fenward_hunters_web_raid': '7 猎人之蛛网突袭',
  'cards.name.fenward_hunters_mire_watch': '8 猎人之泥沼守望',
  'cards.name.fenward_hunters_queen_hunt': '9 猎人之猎后',
  'cards.name.fenward_hunters_homecoming': '10 猎人之归乡',
  'cards.name.relicguard_order_sentinels_vigil': '1 哨卫之守夜',
  'cards.name.relicguard_order_sentinels_key_turn': '2 哨卫之转钥',
  'cards.name.relicguard_order_sentinels_vault_watch': '3 哨卫之宝库守望',
  'cards.name.relicguard_order_sentinels_seal': '4 哨卫之封印',
  'cards.name.relicguard_order_sentinels_relic_hunt': '5 哨卫之圣物追寻',
  'cards.name.relicguard_order_sentinels_oath': '6 哨卫之誓约',
  'cards.name.relicguard_order_sentinels_crypt_guard': '7 哨卫之墓窖守卫',
  'cards.name.relicguard_order_sentinels_gate_lock': '8 哨卫之锁门',
  'cards.name.relicguard_order_sentinels_last_watch': '9 哨卫之最后守望',
  'cards.name.relicguard_order_sentinels_final_oath': '10 哨卫之终誓',
  'cards.name.questbound_caravan_travelers_errand': '1 旅人之差事',
  'cards.name.questbound_caravan_travelers_wrong_turn': '2 旅人之歧路',
  'cards.name.questbound_caravan_travelers_bridge_stop': '3 旅人之桥头歇脚',
  'cards.name.questbound_caravan_travelers_camp': '4 旅人之宿营',
  'cards.name.questbound_caravan_travelers_side_quest': '5 旅人之支线任务',
  'cards.name.questbound_caravan_travelers_cart_fix': '6 旅人之修车',
  'cards.name.questbound_caravan_travelers_road_meal': '7 旅人之路餐',
  'cards.name.questbound_caravan_travelers_lost_map': '8 旅人之遗失地图',
  'cards.name.questbound_caravan_travelers_boss_fight': '9 旅人之首领之战',
  'cards.name.questbound_caravan_travelers_homecoming': '10 旅人之归乡',
  'cards.name.crownless_legends_whisper': '1 传奇之低语',
  'cards.name.crownless_legends_exile': '2 传奇之流放',
  'cards.name.crownless_legends_broken_oath': '3 传奇之背誓',
  'cards.name.crownless_legends_empty_hall': '4 传奇之空厅',
  'cards.name.crownless_legends_last_song': '5 传奇之终曲',
  'cards.name.crownless_legends_ghost_court': '6 传奇之幽魂宫廷',
  'cards.name.crownless_legends_lost_crown': '7 传奇之失落王冠',
  'cards.name.crownless_legends_kingless_feast': '8 传奇之无王之宴',
  'cards.name.crownless_legends_final_war': '9 传奇之终战',
  'cards.name.crownless_legends_return': '10 传奇之归来',
  'cards.text.briarpack_wolfs_nap': '揭示时，获得 {amount} 点狼群。本次比较由较低点数获胜。',
  'cards.text.briarpack_wolves_hunt': '若你拥有至少 {threshold} 点狼群，则获得 +{amount}。',
  'cards.text.briarpack_wolves_howl': '你每有 1 点狼群便获得 +{rate}，当前为 +{amount}。',
  'cards.text.briarpack_wolves_ambush': '揭示时，获得 {amount} 点狼群。若拥有至少 {threshold} 点狼群，本回合它同时视为灵魂。',
  'cards.text.briarpack_wolves_trail': '若你拥有至少 {threshold} 点狼群，则获得 +{amount}。',
  'cards.text.briarpack_wolves_moonrun': '你每有 1 点狼群便获得 +{rate}，当前为 +{amount}。',
  'cards.text.briarpack_wolves_feast': '揭示时，获得 {amount} 点狼群。',
  'cards.text.briarpack_wolves_siege': '若你拥有至少 {threshold} 点狼群，则获得 +{amount}。',
  'cards.text.briarpack_wolves_overlook': '你每有 1 点狼群便获得 +{rate}，当前为 +{amount}。',
  'cards.text.briarpack_wolves_wild_night': '揭示时，获得 {amount} 点狼群。',
  'cards.text.gravebound_court_ghosts_wake': '若此牌落败，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌，并抽 {drawCount} 张牌。',
  'cards.text.gravebound_court_ghosts_vigil': '若此牌落败，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.gravebound_court_ghosts_supper': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.gravebound_court_ghosts_grave_shift': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.gravebound_court_ghosts_bell_toll': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.gravebound_court_ghosts_procession': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.gravebound_court_ghosts_crypt_ball': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.gravebound_court_ghosts_court': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.gravebound_court_ghosts_coronation': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.gravebound_court_ghosts_reunion': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.sableweb_brood_spiders_web': '揭示时，获得 {amount} 点蛛网，并在本回合沉默对方的牌。',
  'cards.text.sableweb_brood_spiders_wait': '若你拥有至少 {threshold} 点蛛网，则获得 +{amount}。',
  'cards.text.sableweb_brood_spiders_snack': '你每有 1 点蛛网便获得 +{rate}，当前为 +{amount}。',
  'cards.text.sableweb_brood_spiders_silk_trap': '揭示时，获得 {amount} 点蛛网。若拥有至少 {threshold} 点蛛网，本回合它同时视为灵魂。',
  'cards.text.sableweb_brood_spiders_shed': '若你拥有至少 {threshold} 点蛛网，则获得 +{amount}。',
  'cards.text.sableweb_brood_spiders_egg_hunt': '你每有 1 点蛛网便获得 +{rate}，当前为 +{amount}。',
  'cards.text.sableweb_brood_spiders_tea_party': '揭示时，获得 {amount} 点蛛网。',
  'cards.text.sableweb_brood_spiders_night_watch': '若你拥有至少 {threshold} 点蛛网，则获得 +{amount}。',
  'cards.text.sableweb_brood_spiders_feast': '你每有 1 点蛛网便获得 +{rate}，当前为 +{amount}。',
  'cards.text.sableweb_brood_spiders_brood_rite': '揭示时，获得 {amount} 点蛛网。',
  'cards.text.ashen_flight_dragons_spark': '揭示时，给予对手 {amount} 点恐惧。本次比较中对方的牌不能超过 {cap}。',
  'cards.text.ashen_flight_dragons_smoke_break': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.ashen_flight_dragons_roost': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.ashen_flight_dragons_first_raid': '揭示时，给予对手 {amount} 点恐惧。',
  'cards.text.ashen_flight_dragons_ashfall': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.ashen_flight_dragons_fire_drill': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.ashen_flight_dragons_sky_hunt': '揭示时，给予对手 {amount} 点恐惧。若此牌获胜，再给予 {bonus} 点恐惧。',
  'cards.text.ashen_flight_dragons_bridge_roast': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.ashen_flight_dragons_sun_feast': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.ashen_flight_dragons_long_nap': '揭示时，给予对手 {amount} 点恐惧。',
  'cards.text.eastbrook_company_rangers_patrol': '若此牌落败，你的下一张野兽牌获得 +{amount}，并将弃牌堆中最高的野兽牌收回手牌。',
  'cards.text.eastbrook_company_rangers_lost_map': '若此牌落败，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_dog_walk': '若此牌落败，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_campfire': '揭示时，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_beast_hunt': '揭示时，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_stable_shift': '揭示时，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_roll_call': '若此牌获胜，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_rescue': '若此牌获胜，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_last_watch': '若此牌获胜，你的下一张野兽牌获得 +{amount}。',
  'cards.text.eastbrook_company_rangers_victory_march': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.ironward_assembly_golems_boot': '揭示时，本次比较由较低点数获胜，并在本回合沉默对方的牌。',
  'cards.text.ironward_assembly_golems_test_run': '此牌在平局回合中获胜。',
  'cards.text.ironward_assembly_golems_watch': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.ironward_assembly_golems_tune_up': '本回合对手的牌不能超过 {amount}。',
  'cards.text.ironward_assembly_golems_forge_day': '此牌的点数变为对手牌的基础点数。',
  'cards.text.ironward_assembly_golems_shield_wall': '此牌首次揭示时，对手的牌在本回合失去效果。',
  'cards.text.ironward_assembly_golems_march': '此牌首次打出时，交换双方的实际点数。',
  'cards.text.ironward_assembly_golems_lockdown': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.ironward_assembly_golems_last_stand': '本回合对手的牌不能超过 {amount}。',
  'cards.text.ironward_assembly_golems_awakening': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_puddle': '若此牌落败，随机展示对手手牌中的 {count} 张牌，并令对手随机弃掉 {discardCount} 张牌。',
  'cards.text.mirefen_tide_mudfins_fish_fry': '若此牌落败，随机展示对手手牌中的 {count} 张牌。',
  'cards.text.mirefen_tide_mudfins_net_cast': '若此牌获胜，对手随机弃掉 {count} 张牌。',
  'cards.text.mirefen_tide_mudfins_bog_race': '若此牌获胜，对手随机弃掉 {count} 张牌。',
  'cards.text.mirefen_tide_mudfins_reed_raid': '此牌首次揭示时，展示对手的手牌。',
  'cards.text.mirefen_tide_mudfins_tide_call': '此牌首次揭示时，展示对手的手牌。',
  'cards.text.mirefen_tide_mudfins_grub_feast': '若对手的牌是人类，则获得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_mud_ball': '若对手的牌是人类，则获得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_moon_croak': '每当此牌获胜时，抽 {amount} 张牌。',
  'cards.text.mirefen_tide_mudfins_flood': '揭示时，对手随机弃掉 {count} 张牌。',
  'cards.text.tunnel_crown_burrowers_dig': '若你的上一张牌是掘穴者，则获得 +{amount}。此牌在平局时获胜。',
  'cards.text.tunnel_crown_burrowers_shift': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_cave_in': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_gem_rush': '本回合视为掘穴者；若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_lunch_break': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_deep_march': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_rockfall': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_throne_run': '本回合视为掘穴者；若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_last_tunnel': '若你的上一张牌是掘穴者，则获得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_uprising': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_static': '若对手的牌为 {threshold} 或更高，则获得 -{amount}，且本次比较中不能超过 {cap}。',
  'cards.text.stormheart_conclave_stormlings_rain_dance': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_wind_race': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_storm_call': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_cloudbreak': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_thunder_roll': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_sky_brawl': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_blackout': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_tempest': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_big_bang': '本回合对手的牌不能超过 {amount}。',
  'cards.text.roadknife_guild_bandits_heist': '若此牌落败，随机展示对手手牌中的 {count} 张牌，并令对手随机弃掉 {discardCount} 张牌。',
  'cards.text.roadknife_guild_bandits_lookout': '若此牌落败，随机展示对手手牌中的 {count} 张牌。',
  'cards.text.roadknife_guild_bandits_road_toll': '若此牌获胜，对手随机弃掉 {count} 张牌。',
  'cards.text.roadknife_guild_bandits_knife_game': '若此牌获胜，对手随机弃掉 {count} 张牌。',
  'cards.text.roadknife_guild_bandits_bridge_job': '此牌首次揭示时，展示对手的手牌。',
  'cards.text.roadknife_guild_bandits_powder_plot': '此牌首次揭示时，展示对手的手牌。',
  'cards.text.roadknife_guild_bandits_night_raid': '若对手的牌是人类，则获得 +{amount}。',
  'cards.text.roadknife_guild_bandits_coach_job': '若对手的牌是人类，则获得 +{amount}。',
  'cards.text.roadknife_guild_bandits_guild_vote': '每当此牌获胜时，抽 {amount} 张牌。',
  'cards.text.roadknife_guild_bandits_last_score': '揭示时，对手随机弃掉 {count} 张牌。',
  'cards.text.mirrorveil_chorus_spirits_glance': '揭示时，本次比较由较低点数获胜，并在本回合沉默对方的牌。',
  'cards.text.mirrorveil_chorus_spirits_echo': '此牌在平局回合中获胜。',
  'cards.text.mirrorveil_chorus_spirits_double_take': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.mirrorveil_chorus_spirits_mirror_game': '本回合对手的牌不能超过 {amount}。',
  'cards.text.mirrorveil_chorus_spirits_glass_dance': '此牌的点数变为对手牌的基础点数。',
  'cards.text.mirrorveil_chorus_spirits_name_swap': '此牌首次揭示时，对手的牌在本回合失去效果。',
  'cards.text.mirrorveil_chorus_spirits_lost_face': '此牌首次打出时，交换双方的实际点数。',
  'cards.text.mirrorveil_chorus_spirits_hall_walk': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.mirrorveil_chorus_spirits_shattering': '本回合对手的牌不能超过 {amount}。',
  'cards.text.mirrorveil_chorus_spirits_encore': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_watch': '每当此牌落败时，抽 {amount} 张牌，并将弃牌堆中点数 {threshold} 或更低的最高人类牌收回手牌。',
  'cards.text.emberwatch_compact_wardens_lantern_run': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.emberwatch_compact_wardens_fire_drill': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.emberwatch_compact_wardens_night_shift': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_beacon': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_muster': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_rescue': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_last_watch': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_alarm': '每当此牌获胜时，抽 {amount} 张牌。',
  'cards.text.emberwatch_compact_wardens_final_stand': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_spark': '揭示时，给予对手 {amount} 点恐惧。本次比较中对方的牌不能超过 {cap}。',
  'cards.text.cryptfire_covenant_fiends_grave_raid': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_bone_fire': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_soul_hunt': '揭示时，给予对手 {amount} 点恐惧。',
  'cards.text.cryptfire_covenant_fiends_crypt_feast': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_ash_rite': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_hellgate': '揭示时，给予对手 {amount} 点恐惧。若此牌获胜，再给予 {bonus} 点恐惧。',
  'cards.text.cryptfire_covenant_fiends_doom_march': '对手每有 1 点恐惧便获得 +{rate}，当前为 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_graveburn': '若对手拥有至少 {threshold} 点恐惧，其牌获得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_endtime': '揭示时，给予对手 {amount} 点恐惧。',
  'cards.text.tableborn_circle_gamblers_deal': '你本局每打出一张人类牌便获得 +{rate}，当前为 +{amount}。本次比较由较低点数获胜。',
  'cards.text.tableborn_circle_gamblers_small_bet': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_card_trick': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_poker_night': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_bad_hand': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_bluff': '你本局每打出一张人类牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.tableborn_circle_gamblers_lucky_draw': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_table_flip': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_final_bet': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_grand_game': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cards.text.greenwake_circle_treants_sprout': '你本局每打出一张元素牌便获得 +{rate}，当前为 +{amount}。本回合它同时视为灵魂。',
  'cards.text.greenwake_circle_treants_rain_song': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.greenwake_circle_treants_root_race': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.greenwake_circle_treants_orchard_walk': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.greenwake_circle_treants_stag_hunt': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cards.text.greenwake_circle_treants_bloom': '你本局每打出一张元素牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.greenwake_circle_treants_grove_dance': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.greenwake_circle_treants_wild_hunt': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.greenwake_circle_treants_long_sleep': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.greenwake_circle_treants_awakening': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cards.text.boneflame_host_skeletons_spark': '若此牌落败，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌，并抽 {drawCount} 张牌。',
  'cards.text.boneflame_host_skeletons_bone_toss': '若此牌落败，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.boneflame_host_skeletons_ash_dance': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.boneflame_host_skeletons_grave_run': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.boneflame_host_skeletons_fire_walk': '你本局每输掉一张亡灵牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.boneflame_host_skeletons_pyre': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.boneflame_host_skeletons_crypt_roast': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.boneflame_host_skeletons_last_march': '若此牌获胜，将你弃牌堆中点数 {threshold} 或更低的最高亡灵牌收回手牌。',
  'cards.text.boneflame_host_skeletons_bone_feast': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.boneflame_host_skeletons_inferno': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.fenward_hunters_scout': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。揭示时，本回合沉默对方的牌。',
  'cards.text.fenward_hunters_net_cast': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.fenward_hunters_bog_hunt': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.fenward_hunters_spider_trap': '若对手的牌是蜘蛛，则获得 +{amount}。',
  'cards.text.fenward_hunters_trail': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.fenward_hunters_night_hunt': '若对手的牌为 {threshold} 或更高，则获得 +{amount}。',
  'cards.text.fenward_hunters_web_raid': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.fenward_hunters_mire_watch': '若对手的牌是蜘蛛，则获得 +{amount}。',
  'cards.text.fenward_hunters_queen_hunt': '若对手的牌为 {threshold} 或更高，则获得 -{amount}。',
  'cards.text.fenward_hunters_homecoming': '本回合对手的牌不能超过 {amount}。',
  'cards.text.relicguard_order_sentinels_vigil': '揭示时，本次比较由较低点数获胜，并在本回合沉默对方的牌。',
  'cards.text.relicguard_order_sentinels_key_turn': '此牌在平局回合中获胜。',
  'cards.text.relicguard_order_sentinels_vault_watch': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.relicguard_order_sentinels_seal': '本回合对手的牌不能超过 {amount}。',
  'cards.text.relicguard_order_sentinels_relic_hunt': '此牌的点数变为对手牌的基础点数。',
  'cards.text.relicguard_order_sentinels_oath': '此牌首次揭示时，对手的牌在本回合失去效果。',
  'cards.text.relicguard_order_sentinels_crypt_guard': '此牌首次打出时，交换双方的实际点数。',
  'cards.text.relicguard_order_sentinels_gate_lock': '此牌的点数不能被降至 {amount} 以下。',
  'cards.text.relicguard_order_sentinels_last_watch': '本回合对手的牌不能超过 {amount}。',
  'cards.text.relicguard_order_sentinels_final_oath': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_errand': '每当此牌落败时，抽 {amount} 张牌，并将弃牌堆中点数 {threshold} 或更低的最高牌收回手牌。',
  'cards.text.questbound_caravan_travelers_wrong_turn': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.questbound_caravan_travelers_bridge_stop': '每当此牌落败时，抽 {amount} 张牌。',
  'cards.text.questbound_caravan_travelers_camp': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_side_quest': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_cart_fix': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_road_meal': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_lost_map': '当你的回合数落后时，获得 +{amount}。',
  'cards.text.questbound_caravan_travelers_boss_fight': '每当此牌获胜时，抽 {amount} 张牌。',
  'cards.text.questbound_caravan_travelers_homecoming': '若此牌获胜，你的下一张牌获得 +{amount}。',
  'cards.text.crownless_legends_whisper': '你本局每打出一张灵魂牌便获得 +{rate}，当前为 +{amount}。本次比较由较低点数获胜。',
  'cards.text.crownless_legends_exile': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.crownless_legends_broken_oath': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.crownless_legends_empty_hall': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.crownless_legends_last_song': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cards.text.crownless_legends_ghost_court': '你本局每打出一张灵魂牌便获得 +{rate}，当前为 +{amount}。',
  'cards.text.crownless_legends_lost_crown': '若你本局已打出至少 {threshold} 个不同种族，则获得 +{amount}。',
  'cards.text.crownless_legends_kingless_feast': '若你的上一张牌落败，则获得 +{amount}。',
  'cards.text.crownless_legends_final_war': '在第 {round} 回合及之后获得 +{amount}。',
  'cards.text.crownless_legends_return': '当你连续输掉 {threshold} 个回合后，获得 +{amount}。',
  'cardDeck.setFilterLabel': '按套牌筛选',
  'cardDeck.allSets': '全部套牌',
  'cardDeck.set.ashen_flight': '灰烬之翼',
  'cardDeck.set.boneflame_host': '骨焰之军',
  'cardDeck.set.briarpack': '荆棘狼群',
  'cardDeck.set.crownless_legends': '无冕传奇',
  'cardDeck.set.cryptfire_covenant': '墓火盟约',
  'cardDeck.set.eastbrook_company': '东溪商队',
  'cardDeck.set.emberwatch_compact': '余烬守望盟',
  'cardDeck.set.fenward_hunters': '沼守猎队',
  'cardDeck.set.gravebound_court': '墓缚宫廷',
  'cardDeck.set.greenwake_circle': '翠醒之环',
  'cardDeck.set.ironward_assembly': '铁卫议会',
  'cardDeck.set.mirefen_tide': '泥沼之潮',
  'cardDeck.set.mirrorveil_chorus': '镜纱合唱团',
  'cardDeck.set.questbound_caravan': '寻途商旅',
  'cardDeck.set.relicguard_order': '圣物守卫团',
  'cardDeck.set.roadknife_guild': '路刃行会',
  'cardDeck.set.sableweb_brood': '黑丝蛛群',
  'cardDeck.set.stormheart_conclave': '风暴之心议会',
  'cardDeck.set.tableborn_circle': '牌桌之子',
  'cardDeck.set.tunnel_crown': '地道王冠',
  'cardDeck.set.basics': '基础牌',
