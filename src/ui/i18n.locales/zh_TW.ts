...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.name.ashen_wyrm': '灰燼巨蛇',
  'cards.name.bone_picker': '拾骨者',
  'cards.name.bramble_sprite': '荊棘精靈',
  'cards.name.doppelganger': '擬形者',
  'cards.name.ember_drake': '餘燼幼龍',
  'cards.name.forest_wolf': '森林狼',
  'cards.name.grave_candle': '墓地燭火',
  'cards.name.grave_rat': '墓地老鼠',
  'cards.name.grave_warden': '墓地守望者',
  'cards.name.grix_tunnelking': '隧道之王格里克斯',
  'cards.name.hollow_knight': '空洞騎士',
  'cards.name.ironclad': '鐵甲衛',
  'cards.name.mire_toad': '泥沼蟾蜍',
  'cards.name.mirefen_ambusher': '泥沼伏擊者',
  'cards.name.mudfin_scout': '泥鰭斥候',
  'cards.name.necromancer': '亡靈法師',
  'cards.name.nullstone': '虛無石',
  'cards.name.nythraxis_broodling': '奈斯拉克斯幼裔',
  'cards.name.old_greyjaw': '老灰顎',
  'cards.name.pack_alpha': '獸群首領',
  'cards.name.ratling_thief': '鼠人竊賊',
  'cards.name.sable_matriarch': '黑蛛女王',
  'cards.name.sableweb_hexer': '黑網巫師',
  'cards.name.stablemaster': '馬廄總管',
  'cards.name.stormcaller': '喚風者',
  'cards.name.torchbearer': '執炬者',
  'cards.name.tunnel_guard': '隧道守衛',
  'cards.name.vale_champion': '山谷勇士',
  'cards.name.vale_warden': '山谷守衛',
  'cards.name.web_spinner': '織網蛛',
  'cards.noRulesText': '無效果。',
  'cards.text.ashen_wyrm': '展示時，使對手獲得 {amount} 層恐懼。',
  'cards.text.bone_picker': '本局中你每打出一張亡靈牌，此牌便獲得 +1。',
  'cards.text.bramble_sprite': '本回合此牌視為野獸，並獲得 +{amount}。',
  'cards.text.doppelganger': '此牌的數值變為對手牌的基礎數值。',
  'cards.text.ember_drake': '對手每有 1 層恐懼，此牌便獲得 +1。',
  'cards.text.forest_wolf': '若你上一張牌是野獸牌，此牌獲得 +{amount}。',
  'cards.text.grave_candle': '若此牌落敗，你的下一張亡靈牌獲得 +{amount}。',
  'cards.text.grave_rat': '本回合對手的牌獲得 -{amount}。',
  'cards.text.grave_warden': '若此牌獲勝，將你棄牌堆中數值 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.grix_tunnelking': '若此牌獲勝，你的下一張牌獲得 -{amount}。',
  'cards.text.hollow_knight': '此牌在平局回合中獲勝。',
  'cards.text.ironclad': '本回合對手的牌數值不會超過 {amount}。',
  'cards.text.mire_toad': '若對手的牌為 {threshold} 或更高，此牌獲得 +{amount}。',
  'cards.text.mirefen_ambusher': '若對手的牌是人類，此牌獲得 +{amount}。',
  'cards.text.mudfin_scout': '若此牌落敗，隨機展示對手手牌中的 {count} 張牌。',
  'cards.text.necromancer': '你的下一張亡靈牌獲得 +{amount}。',
  'cards.text.nullstone': '本回合對手的牌不產生任何效果。',
  'cards.text.nythraxis_broodling': '展示時，使對手獲得 {amount} 層恐懼。',
  'cards.text.old_greyjaw': '當你在回合數上落後時，此牌獲得 +{amount}。',
  'cards.text.pack_alpha': '本局中你每打出兩張野獸牌，此牌便獲得 +1。',
  'cards.text.ratling_thief': '若此牌獲勝，對手隨機棄掉一張手牌。',
  'cards.text.sable_matriarch': '你每有 1 層蛛網，此牌便獲得 +1。',
  'cards.text.sableweb_hexer': '若對手的牌是人類，則其獲得 -{amount}。',
  'cards.text.stablemaster': '你的下一張野獸牌獲得 +{amount}。',
  'cards.text.stormcaller': '若對手的牌為 {threshold} 或更高，則其獲得 -{amount}。',
  'cards.text.torchbearer': '當你在回合數上落後時，此牌獲得 +{amount}。',
  'cards.text.tunnel_guard': '此牌的數值不會被降至 {amount} 以下。',
  'cards.text.vale_champion': '若此牌落敗，抽 {amount} 張牌。',
  'cards.text.vale_warden': '若此牌獲勝，抽 {amount} 張牌。',
  'cards.text.web_spinner': '展示時，獲得 {amount} 層蛛網。',
