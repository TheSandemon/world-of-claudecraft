...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.card_master.greeting': '來一局ClaudeStone？三局兩勝，贏家贏得吹噓的資本。',
  'cardDuel.title': 'ClaudeStone',
  'cardDuel.close': '關閉',
  'cardDuel.join': '加入隊列',
  'cardDuel.joinAria': '加入ClaudeStone隊列',
  'cardDuel.leave': '離開隊列',
  'cardDuel.leaveAria': '離開ClaudeStone隊列',
  'cardDuel.queued': '正在等待對手……',
  'cardDuel.vsOpponent': '對戰 {name}',
  'cardDuel.round': '局分：{mine} - {theirs}',
  'cardDuel.forfeit': '認輸',
  'cardDuel.forfeitAria': '認輸退出ClaudeStone',
  'cardDuel.unavailable': 'ClaudeStone需要另一名玩家在線。',
  ...
  'cards.card.playDetail': '打出{name}，數值{value}。{rules}',
  'cards.noRulesText': '無效果。',
  'cards.tribe.Bandit': '強盜',
  'cards.tribe.Beast': '野獸',
  'cards.tribe.Burrower': '掘地者',
  'cards.tribe.Construct': '構裝體',
  'cards.tribe.Demon': '惡魔',
  'cards.tribe.Dragon': '巨龍',
  'cards.tribe.Elemental': '元素',
  'cards.tribe.Human': '人類',
  'cards.tribe.Mudfin': '泥鰭',
  ...
  'cardDuel.clockHeld': '正在結算本回合',
  'cardDuel.summary.win': '你贏下這場對決',
  'cardDuel.summary.loss': '你輸掉這場對決',
  'cardDuel.summary.draw': '這場對決打平',
  'cardDuel.summary.against': '對手：{name}',
  'cardDuel.summary.health': '剩餘生命',
  'cardDuel.summary.rounds': '回合數',
  'cardDuel.summary.dealt': '造成傷害',
  'cardDuel.summary.taken': '承受傷害',
  'cardDuel.summary.bestHit': '最大一擊',
  'cardDuel.summary.bestHitValue': '第 {round} 回合用{card}打出 {amount}',
  'cardDuel.summary.rematch': '再來一局',
  'cardDuel.summary.done': '離開牌桌',
  ...
  'cardDeck.close': '關閉',
  'cardDeck.defaultName': '新牌組',
  'cardDeck.delete': '刪除牌組',
  'cardDeck.emptySlot': '數值 {value} 的空槽位',
  'cardDeck.nameLabel': '牌組名稱',
  'cardDeck.open': '牌組',
  'cardDeck.openAria': '開啟牌組編輯器',
  'cardDeck.progress': '已填 {filled} / {required} 個槽位',
  'cardDeck.rowTitle': '數值 {value}',
  'cardDeck.rule': '一副牌組是二十張：一到十每個數值各兩張，且沒有重複的牌。',
  'cardDeck.save': '儲存牌組',
  'cardDeck.title': '牌組編輯器',
  'cardOpponents.heading': '與常客對局',
  'cardOpponents.sitDown': '與 {name} 對局',
  'cardOpponents.tier.master': '大師',
  'cardOpponents.tier.novice': '新手',
  'cardOpponents.tier.sharp': '敏銳',
  'cardOpponents.tier.steady': '穩健',
  'cards.opponent.dockhand_pell.greeting': '小心泥地。在我那一帶，泥是會咬人的。',
  'cards.opponent.dockhand_pell.name': '佩爾',
  'cards.opponent.dockhand_pell.title': '碼頭工',
  'cards.opponent.gravedigger_ossa.greeting': '我埋下的東西，沒有一樣能安分躺著。',
  'cards.opponent.gravedigger_ossa.name': '奧薩',
  'cards.opponent.gravedigger_ossa.title': '掘墓人',
  'cards.opponent.huntsman_bregg.greeting': '一頭狼只是麻煩。六頭狼就是一場狩獵。',
  'cards.opponent.huntsman_bregg.name': '布雷格',
  'cards.opponent.huntsman_bregg.title': '獵手',
  'cards.opponent.the_card_master.greeting': '坐吧。每個人拿到的都是同樣的二十張牌。讓我看看你選了哪些。',
  'cards.opponent.the_card_master.name': '紙牌大師',
  'cards.opponent.the_card_master.title': '牌桌的守護者',
  'cards.counter.Pack': '狼群',
  'cards.counter.Dread': '恐懼',
  'cardDuel.commitLocked': '已出牌',
  'cardDuel.commitChoosing': '選擇中',
  'cardDuel.waitingBoth': '雙方都在選牌',
  'cardDuel.waitingThem': '等待對手出牌',
  'cardDuel.waitingMe': '對手已就緒',
  ...
  'cardDuel.beat.reveal': '翻開牌面',
  'cardDuel.beat.effectValue': '{card}：{target} {amount}',
  'cardDuel.beat.effectSilence': '{card}沉默了對方的牌',
  'cardDuel.beat.effectReveal': '{card}揭示一張牌',
  'cardDuel.beat.effectDraw': '{card}抽了一張牌',
  'cardDuel.beat.effectSwap': '{card}交換了雙方數值',
  'cardDuel.beat.effectOther': '{card}生效',
  'cardDuel.beat.yourCard': '你的牌',
  'cardDuel.beat.theirCard': '對方的牌',
  'cardDuel.damageMine': '你受到 {amount} 點傷害',
  'cardDuel.damageTheirs': '對手受到 {amount} 點傷害',
  'cardDuel.beat.clash': '兩牌交鋒',
  'cardDuel.beat.finish': '最後一擊落下',
  'cardDuel.beat.gloryWin': '這場對決屬於你',
  'cardDuel.beat.gloryLose': '這場對決輸了',
  'cardDuel.beat.gloryDraw': '這場對決打成平手',
  'cardDuel.announce': '你打出 {mine}，對手打出 {theirs}。{outcome}',
  'cardDuel.oppoHandHidden': '對手手牌：{count}',
  'cardDuel.oppoHandSeen': '對手手牌：{count}，已看到 {seen}',
  'cardDuel.effectsHeading': '仍在生效',
  'cardDuel.durationNextRound': '下一輪',
  'cardDuel.durationUntilTriggered': '直到觸發',
  'cardDuel.durationMatchEnd': '本局剩餘時間',
  'cards.name.briarpack_wolfs_nap': '1 狼之小憩',
  'cards.name.briarpack_wolves_hunt': '2 狼之狩獵',
  'cards.name.briarpack_wolves_howl': '3 狼之嚎叫',
  'cards.name.briarpack_wolves_ambush': '4 狼之伏擊',
  'cards.name.briarpack_wolves_trail': '5 狼之足跡',
  'cards.name.briarpack_wolves_moonrun': '6 狼之月夜疾行',
  'cards.name.briarpack_wolves_feast': '7 狼之盛宴',
  'cards.name.briarpack_wolves_siege': '8 狼之圍攻',
  'cards.name.briarpack_wolves_overlook': '9 狼之瞭望',
  'cards.name.briarpack_wolves_wild_night': '10 狼之狂野之夜',
  'cards.name.gravebound_court_ghosts_wake': '1 幽魂之守靈',
  ...
  'cards.name.gravebound_court_ghosts_bell_toll': '5 幽魂之喪鐘',
  'cards.name.gravebound_court_ghosts_procession': '6 幽魂之行列',
  'cards.name.gravebound_court_ghosts_crypt_ball': '7 幽魂之墓窖舞會',
  'cards.name.gravebound_court_ghosts_court': '8 幽魂之宮廷',
  'cards.name.gravebound_court_ghosts_coronation': '9 幽魂之加冕',
  'cards.name.gravebound_court_ghosts_reunion': '10 幽魂之重聚',
  'cards.name.sableweb_brood_spiders_web': '1 蜘蛛之蛛網',
  'cards.name.sableweb_brood_spiders_wait': '2 蜘蛛之守候',
  'cards.name.sableweb_brood_spiders_snack': '3 蜘蛛之小食',
  'cards.name.sableweb_brood_spiders_silk_trap': '4 蜘蛛之絲網陷阱',
  'cards.name.sableweb_brood_spiders_shed': '5 蜘蛛之蛻殼',
  'cards.name.sableweb_brood_spiders_egg_hunt': '6 蜘蛛之尋卵',
  'cards.name.sableweb_brood_spiders_tea_party': '7 蜘蛛之茶會',
  'cards.name.sableweb_brood_spiders_night_watch': '8 蜘蛛之夜巡',
  'cards.name.sableweb_brood_spiders_feast': '9 蜘蛛之盛宴',
  'cards.name.sableweb_brood_spiders_brood_rite': '10 蜘蛛之孵育儀式',
  'cards.name.ashen_flight_dragons_spark': '1 巨龍之火星',
  'cards.name.ashen_flight_dragons_smoke_break': '2 巨龍之吐息小憩',
  'cards.name.ashen_flight_dragons_roost': '3 巨龍之棲巢',
  'cards.name.ashen_flight_dragons_first_raid': '4 巨龍之初襲',
  'cards.name.ashen_flight_dragons_ashfall': '5 巨龍之落灰',
  'cards.name.ashen_flight_dragons_fire_drill': '6 巨龍之火演',
  'cards.name.ashen_flight_dragons_sky_hunt': '7 巨龍之天空狩獵',
  'cards.name.ashen_flight_dragons_bridge_roast': '8 巨龍之焚橋',
  'cards.name.ashen_flight_dragons_sun_feast': '9 巨龍之日宴',
  'cards.name.ashen_flight_dragons_long_nap': '10 巨龍之長眠',
  'cards.name.eastbrook_company_rangers_patrol': '1 遊俠之巡邏',
  'cards.name.eastbrook_company_rangers_lost_map': '2 遊俠之遺失地圖',
  'cards.name.eastbrook_company_rangers_dog_walk': '3 遊俠之遛犬',
  'cards.name.eastbrook_company_rangers_campfire': '4 遊俠之營火',
  'cards.name.eastbrook_company_rangers_beast_hunt': '5 遊俠之獵獸',
  'cards.name.eastbrook_company_rangers_stable_shift': '6 遊俠之馬廄輪值',
  'cards.name.eastbrook_company_rangers_roll_call': '7 遊俠之點名',
  'cards.name.eastbrook_company_rangers_rescue': '8 遊俠之救援',
  'cards.name.eastbrook_company_rangers_last_watch': '9 遊俠之最後守望',
  'cards.name.eastbrook_company_rangers_victory_march': '10 遊俠之凱旋行軍',
  'cards.name.ironward_assembly_golems_boot': '1 石魔之啟動',
  'cards.name.ironward_assembly_golems_test_run': '2 石魔之試運行',
  'cards.name.ironward_assembly_golems_watch': '3 石魔之守望',
  'cards.name.ironward_assembly_golems_tune_up': '4 石魔之調校',
  'cards.name.ironward_assembly_golems_forge_day': '5 石魔之鍛造日',
  'cards.name.ironward_assembly_golems_shield_wall': '6 石魔之盾牆',
  'cards.name.ironward_assembly_golems_march': '7 石魔之行軍',
  'cards.name.ironward_assembly_golems_lockdown': '8 石魔之封鎖',
  'cards.name.ironward_assembly_golems_last_stand': '9 石魔之背水一戰',
  'cards.name.ironward_assembly_golems_awakening': '10 石魔之覺醒',
  'cards.name.mirefen_tide_mudfins_puddle': '1 泥鰭之水窪',
  'cards.name.mirefen_tide_mudfins_fish_fry': '2 泥鰭之煎魚',
  'cards.name.mirefen_tide_mudfins_net_cast': '3 泥鰭之撒網',
  'cards.name.mirefen_tide_mudfins_bog_race': '4 泥鰭之沼澤競逐',
  'cards.name.mirefen_tide_mudfins_reed_raid': '5 泥鰭之蘆葦突襲',
  'cards.name.mirefen_tide_mudfins_tide_call': '6 泥鰭之潮汐召喚',
  'cards.name.mirefen_tide_mudfins_grub_feast': '7 泥鰭之幼蟲盛宴',
  'cards.name.mirefen_tide_mudfins_mud_ball': '8 泥鰭之泥球',
  'cards.name.mirefen_tide_mudfins_moon_croak': '9 泥鰭之月下蛙鳴',
  'cards.name.mirefen_tide_mudfins_flood': '10 泥鰭之洪流',
  'cards.name.tunnel_crown_burrowers_dig': '1 掘穴者之挖掘',
  'cards.name.tunnel_crown_burrowers_shift': '2 掘穴者之輪值',
  'cards.name.tunnel_crown_burrowers_cave_in': '3 掘穴者之塌方',
  'cards.name.tunnel_crown_burrowers_gem_rush': '4 掘穴者之寶石熱潮',
  'cards.name.tunnel_crown_burrowers_lunch_break': '5 掘穴者之午休',
  'cards.name.tunnel_crown_burrowers_deep_march': '6 掘穴者之深處行軍',
  'cards.name.tunnel_crown_burrowers_rockfall': '7 掘穴者之落石',
  'cards.name.tunnel_crown_burrowers_throne_run': '8 掘穴者之奪位疾行',
  'cards.name.tunnel_crown_burrowers_last_tunnel': '9 掘穴者之最後隧道',
  'cards.name.tunnel_crown_burrowers_uprising': '10 掘穴者之起義',
  'cards.name.stormheart_conclave_stormlings_static': '1 風暴之子之靜電',
  'cards.name.stormheart_conclave_stormlings_rain_dance': '2 風暴之子之祈雨舞',
  'cards.name.stormheart_conclave_stormlings_wind_race': '3 風暴之子之御風競速',
  'cards.name.stormheart_conclave_stormlings_storm_call': '4 風暴之子之風暴召喚',
  'cards.name.stormheart_conclave_stormlings_cloudbreak': '5 風暴之子之破雲',
  'cards.name.stormheart_conclave_stormlings_thunder_roll': '6 風暴之子之雷鳴滾滾',
  'cards.name.stormheart_conclave_stormlings_sky_brawl': '7 風暴之子之天空混戰',
  'cards.name.stormheart_conclave_stormlings_blackout': '8 風暴之子之黑幕',
  'cards.name.stormheart_conclave_stormlings_tempest': '9 風暴之子之狂瀾',
  'cards.name.stormheart_conclave_stormlings_big_bang': '10 風暴之子之驚天一擊',
  'cards.name.roadknife_guild_bandits_heist': '1 強盜之劫案',
  'cards.name.roadknife_guild_bandits_lookout': '2 強盜之望風',
  'cards.name.roadknife_guild_bandits_road_toll': '3 強盜之過路費',
  'cards.name.roadknife_guild_bandits_knife_game': '4 強盜之飛刀賭局',
  'cards.name.roadknife_guild_bandits_bridge_job': '5 強盜之橋頭買賣',
  'cards.name.roadknife_guild_bandits_powder_plot': '6 強盜之火藥陰謀',
  'cards.name.roadknife_guild_bandits_night_raid': '7 強盜之夜襲',
  'cards.name.roadknife_guild_bandits_coach_job': '8 強盜之劫車',
  'cards.name.roadknife_guild_bandits_guild_vote': '9 強盜之行會表決',
  'cards.name.roadknife_guild_bandits_last_score': '10 強盜之最後一票',
  'cards.name.mirrorveil_chorus_spirits_glance': '1 靈魂之一瞥',
  'cards.name.mirrorveil_chorus_spirits_echo': '2 靈魂之迴響',
  'cards.name.mirrorveil_chorus_spirits_double_take': '3 靈魂之二度回望',
  'cards.name.mirrorveil_chorus_spirits_mirror_game': '4 靈魂之鏡中遊戲',
  'cards.name.mirrorveil_chorus_spirits_glass_dance': '5 靈魂之琉璃之舞',
  'cards.name.mirrorveil_chorus_spirits_name_swap': '6 靈魂之易名',
  'cards.name.mirrorveil_chorus_spirits_lost_face': '7 靈魂之失容',
  'cards.name.mirrorveil_chorus_spirits_hall_walk': '8 靈魂之廳堂漫步',
  'cards.name.mirrorveil_chorus_spirits_shattering': '9 靈魂之碎裂',
  'cards.name.mirrorveil_chorus_spirits_encore': '10 靈魂之安可',
  'cards.name.emberwatch_compact_wardens_watch': '1 守望者之守望',
  'cards.name.emberwatch_compact_wardens_lantern_run': '2 守望者之提燈巡行',
  ...
  'cards.name.emberwatch_compact_wardens_muster': '6 守望者之集結',
  'cards.name.emberwatch_compact_wardens_rescue': '7 守望者之救援',
  'cards.name.emberwatch_compact_wardens_last_watch': '8 守望者之最後守望',
  'cards.name.emberwatch_compact_wardens_alarm': '9 守望者之警號',
  'cards.name.emberwatch_compact_wardens_final_stand': '10 守望者之終局死守',
  'cards.name.cryptfire_covenant_fiends_spark': '1 邪魔之火星',
  'cards.name.cryptfire_covenant_fiends_grave_raid': '2 邪魔之盜墓',
  'cards.name.cryptfire_covenant_fiends_bone_fire': '3 邪魔之骨火',
  'cards.name.cryptfire_covenant_fiends_soul_hunt': '4 邪魔之獵魂',
  'cards.name.cryptfire_covenant_fiends_crypt_feast': '5 邪魔之墓窖盛宴',
  'cards.name.cryptfire_covenant_fiends_ash_rite': '6 邪魔之灰燼儀式',
  'cards.name.cryptfire_covenant_fiends_hellgate': '7 邪魔之地獄之門',
  'cards.name.cryptfire_covenant_fiends_doom_march': '8 邪魔之末日行軍',
  'cards.name.cryptfire_covenant_fiends_graveburn': '9 邪魔之焚墓',
  'cards.name.cryptfire_covenant_fiends_endtime': '10 邪魔之終末',
  'cards.name.tableborn_circle_gamblers_deal': '1 賭徒之發牌',
  'cards.name.tableborn_circle_gamblers_small_bet': '2 賭徒之小注',
  'cards.name.tableborn_circle_gamblers_card_trick': '3 賭徒之紙牌戲法',
  'cards.name.tableborn_circle_gamblers_poker_night': '4 賭徒之牌局之夜',
  'cards.name.tableborn_circle_gamblers_bad_hand': '5 賭徒之爛牌',
  'cards.name.tableborn_circle_gamblers_bluff': '6 賭徒之詐唬',
  'cards.name.tableborn_circle_gamblers_lucky_draw': '7 賭徒之幸運抽牌',
  'cards.name.tableborn_circle_gamblers_table_flip': '8 賭徒之掀桌',
  'cards.name.tableborn_circle_gamblers_final_bet': '9 賭徒之最終一注',
  'cards.name.tableborn_circle_gamblers_grand_game': '10 賭徒之大局',
  'cards.name.greenwake_circle_treants_sprout': '1 樹人之新芽',
  'cards.name.greenwake_circle_treants_rain_song': '2 樹人之雨歌',
  'cards.name.greenwake_circle_treants_root_race': '3 樹人之根鬚競逐',
  'cards.name.greenwake_circle_treants_orchard_walk': '4 樹人之果園漫步',
  'cards.name.greenwake_circle_treants_stag_hunt': '5 樹人之獵鹿',
  'cards.name.greenwake_circle_treants_bloom': '6 樹人之綻放',
  'cards.name.greenwake_circle_treants_grove_dance': '7 樹人之林間之舞',
  'cards.name.greenwake_circle_treants_wild_hunt': '8 樹人之狂野狩獵',
  'cards.name.greenwake_circle_treants_long_sleep': '9 樹人之長眠',
  'cards.name.greenwake_circle_treants_awakening': '10 樹人之覺醒',
  'cards.name.boneflame_host_skeletons_spark': '1 骷髏之火星',
  'cards.name.boneflame_host_skeletons_bone_toss': '2 骷髏之擲骨',
  'cards.name.boneflame_host_skeletons_ash_dance': '3 骷髏之灰舞',
  'cards.name.boneflame_host_skeletons_grave_run': '4 骷髏之墓間疾行',
  'cards.name.boneflame_host_skeletons_fire_walk': '5 骷髏之踏火',
  'cards.name.boneflame_host_skeletons_pyre': '6 骷髏之柴堆',
  'cards.name.boneflame_host_skeletons_crypt_roast': '7 骷髏之墓窖炙宴',
  'cards.name.boneflame_host_skeletons_last_march': '8 骷髏之最後行軍',
  'cards.name.boneflame_host_skeletons_bone_feast': '9 骷髏之骨宴',
  'cards.name.boneflame_host_skeletons_inferno': '10 骷髏之煉獄',
  'cards.name.fenward_hunters_scout': '1 獵人之偵察',
  'cards.name.fenward_hunters_net_cast': '2 獵人之撒網',
  'cards.name.fenward_hunters_bog_hunt': '3 獵人之沼澤狩獵',
  'cards.name.fenward_hunters_spider_trap': '4 獵人之捕蛛陷阱',
  'cards.name.fenward_hunters_trail': '5 獵人之足跡',
  'cards.name.fenward_hunters_night_hunt': '6 獵人之夜獵',
  'cards.name.fenward_hunters_web_raid': '7 獵人之蛛網突襲',
  'cards.name.fenward_hunters_mire_watch': '8 獵人之泥沼守望',
  'cards.name.fenward_hunters_queen_hunt': '9 獵人之獵后',
  'cards.name.fenward_hunters_homecoming': '10 獵人之歸鄉',
  'cards.name.relicguard_order_sentinels_vigil': '1 哨衛之守夜',
  'cards.name.relicguard_order_sentinels_key_turn': '2 哨衛之轉鑰',
  'cards.name.relicguard_order_sentinels_vault_watch': '3 哨衛之寶庫守望',
  'cards.name.relicguard_order_sentinels_seal': '4 哨衛之封印',
  'cards.name.relicguard_order_sentinels_relic_hunt': '5 哨衛之聖物追尋',
  'cards.name.relicguard_order_sentinels_oath': '6 哨衛之誓約',
  'cards.name.relicguard_order_sentinels_crypt_guard': '7 哨衛之墓窖守衛',
  'cards.name.relicguard_order_sentinels_gate_lock': '8 哨衛之鎖門',
  'cards.name.relicguard_order_sentinels_last_watch': '9 哨衛之最後守望',
  'cards.name.relicguard_order_sentinels_final_oath': '10 哨衛之終誓',
  'cards.name.questbound_caravan_travelers_errand': '1 旅人之差事',
  'cards.name.questbound_caravan_travelers_wrong_turn': '2 旅人之歧路',
  'cards.name.questbound_caravan_travelers_bridge_stop': '3 旅人之橋頭歇腳',
  'cards.name.questbound_caravan_travelers_camp': '4 旅人之宿營',
  'cards.name.questbound_caravan_travelers_side_quest': '5 旅人之支線任務',
  'cards.name.questbound_caravan_travelers_cart_fix': '6 旅人之修車',
  'cards.name.questbound_caravan_travelers_road_meal': '7 旅人之路餐',
  'cards.name.questbound_caravan_travelers_lost_map': '8 旅人之遺失地圖',
  'cards.name.questbound_caravan_travelers_boss_fight': '9 旅人之首領之戰',
  'cards.name.questbound_caravan_travelers_homecoming': '10 旅人之歸鄉',
  'cards.name.crownless_legends_whisper': '1 傳奇之低語',
  'cards.name.crownless_legends_exile': '2 傳奇之流放',
  'cards.name.crownless_legends_broken_oath': '3 傳奇之背誓',
  'cards.name.crownless_legends_empty_hall': '4 傳奇之空廳',
  'cards.name.crownless_legends_last_song': '5 傳奇之終曲',
  'cards.name.crownless_legends_ghost_court': '6 傳奇之幽魂宮廷',
  'cards.name.crownless_legends_lost_crown': '7 傳奇之失落王冠',
  'cards.name.crownless_legends_kingless_feast': '8 傳奇之無王之宴',
  'cards.name.crownless_legends_final_war': '9 傳奇之終戰',
  'cards.name.crownless_legends_return': '10 傳奇之歸來',
  'cards.text.briarpack_wolfs_nap': '揭示時，獲得 {amount} 點狼群。本次比較由較低點數獲勝。',
  'cards.text.briarpack_wolves_hunt': '若你擁有至少 {threshold} 點狼群，則獲得 +{amount}。',
  'cards.text.briarpack_wolves_howl': '你每有 1 點狼群便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.briarpack_wolves_ambush': '揭示時，獲得 {amount} 點狼群。若擁有至少 {threshold} 點狼群，本回合它同時視為靈魂。',
  'cards.text.briarpack_wolves_trail': '若你擁有至少 {threshold} 點狼群，則獲得 +{amount}。',
  'cards.text.briarpack_wolves_moonrun': '你每有 1 點狼群便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.briarpack_wolves_feast': '揭示時，獲得 {amount} 點狼群。',
  'cards.text.briarpack_wolves_siege': '若你擁有至少 {threshold} 點狼群，則獲得 +{amount}。',
  'cards.text.briarpack_wolves_overlook': '你每有 1 點狼群便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.briarpack_wolves_wild_night': '揭示時，獲得 {amount} 點狼群。',
  'cards.text.gravebound_court_ghosts_wake': '若此牌落敗，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌，並抽 {drawCount} 張牌。',
  'cards.text.gravebound_court_ghosts_vigil': '若此牌落敗，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.gravebound_court_ghosts_supper': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.gravebound_court_ghosts_grave_shift': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.gravebound_court_ghosts_bell_toll': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.gravebound_court_ghosts_procession': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.gravebound_court_ghosts_crypt_ball': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.gravebound_court_ghosts_court': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.gravebound_court_ghosts_coronation': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.gravebound_court_ghosts_reunion': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.sableweb_brood_spiders_web': '揭示時，獲得 {amount} 點蛛網，並在本回合沉默對方的牌。',
  'cards.text.sableweb_brood_spiders_wait': '若你擁有至少 {threshold} 點蛛網，則獲得 +{amount}。',
  'cards.text.sableweb_brood_spiders_snack': '你每有 1 點蛛網便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.sableweb_brood_spiders_silk_trap': '揭示時，獲得 {amount} 點蛛網。若擁有至少 {threshold} 點蛛網，本回合它同時視為靈魂。',
  'cards.text.sableweb_brood_spiders_shed': '若你擁有至少 {threshold} 點蛛網，則獲得 +{amount}。',
  'cards.text.sableweb_brood_spiders_egg_hunt': '你每有 1 點蛛網便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.sableweb_brood_spiders_tea_party': '揭示時，獲得 {amount} 點蛛網。',
  'cards.text.sableweb_brood_spiders_night_watch': '若你擁有至少 {threshold} 點蛛網，則獲得 +{amount}。',
  'cards.text.sableweb_brood_spiders_feast': '你每有 1 點蛛網便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.sableweb_brood_spiders_brood_rite': '揭示時，獲得 {amount} 點蛛網。',
  'cards.text.ashen_flight_dragons_spark': '揭示時，給予對手 {amount} 點恐懼。本次比較中對方的牌不能超過 {cap}。',
  'cards.text.ashen_flight_dragons_smoke_break': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.ashen_flight_dragons_roost': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.ashen_flight_dragons_first_raid': '揭示時，給予對手 {amount} 點恐懼。',
  'cards.text.ashen_flight_dragons_ashfall': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.ashen_flight_dragons_fire_drill': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.ashen_flight_dragons_sky_hunt': '揭示時，給予對手 {amount} 點恐懼。若此牌獲勝，再給予 {bonus} 點恐懼。',
  'cards.text.ashen_flight_dragons_bridge_roast': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.ashen_flight_dragons_sun_feast': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.ashen_flight_dragons_long_nap': '揭示時，給予對手 {amount} 點恐懼。',
  'cards.text.eastbrook_company_rangers_patrol': '若此牌落敗，你的下一張野獸牌獲得 +{amount}，並將棄牌堆中最高的野獸牌收回手牌。',
  'cards.text.eastbrook_company_rangers_lost_map': '若此牌落敗，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_dog_walk': '若此牌落敗，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_campfire': '揭示時，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_beast_hunt': '揭示時，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_stable_shift': '揭示時，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_roll_call': '若此牌獲勝，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_rescue': '若此牌獲勝，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_last_watch': '若此牌獲勝，你的下一張野獸牌獲得 +{amount}。',
  'cards.text.eastbrook_company_rangers_victory_march': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.ironward_assembly_golems_boot': '揭示時，本次比較由較低點數獲勝，並在本回合沉默對方的牌。',
  'cards.text.ironward_assembly_golems_test_run': '此牌在平局回合中獲勝。',
  'cards.text.ironward_assembly_golems_watch': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.ironward_assembly_golems_tune_up': '本回合對手的牌不能超過 {amount}。',
  'cards.text.ironward_assembly_golems_forge_day': '此牌的點數變為對手牌的基礎點數。',
  'cards.text.ironward_assembly_golems_shield_wall': '此牌首次揭示時，對手的牌在本回合失去效果。',
  'cards.text.ironward_assembly_golems_march': '此牌首次打出時，交換雙方的實際點數。',
  'cards.text.ironward_assembly_golems_lockdown': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.ironward_assembly_golems_last_stand': '本回合對手的牌不能超過 {amount}。',
  'cards.text.ironward_assembly_golems_awakening': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_puddle': '若此牌落敗，隨機展示對手手牌中的 {count} 張牌，並令對手隨機棄掉 {discardCount} 張牌。',
  'cards.text.mirefen_tide_mudfins_fish_fry': '若此牌落敗，隨機展示對手手牌中的 {count} 張牌。',
  'cards.text.mirefen_tide_mudfins_net_cast': '若此牌獲勝，對手隨機棄掉 {count} 張牌。',
  'cards.text.mirefen_tide_mudfins_bog_race': '若此牌獲勝，對手隨機棄掉 {count} 張牌。',
  'cards.text.mirefen_tide_mudfins_reed_raid': '此牌首次揭示時，展示對手的手牌。',
  'cards.text.mirefen_tide_mudfins_tide_call': '此牌首次揭示時，展示對手的手牌。',
  'cards.text.mirefen_tide_mudfins_grub_feast': '若對手的牌是人類，則獲得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_mud_ball': '若對手的牌是人類，則獲得 +{amount}。',
  'cards.text.mirefen_tide_mudfins_moon_croak': '每當此牌獲勝時，抽 {amount} 張牌。',
  'cards.text.mirefen_tide_mudfins_flood': '揭示時，對手隨機棄掉 {count} 張牌。',
  'cards.text.tunnel_crown_burrowers_dig': '若你的上一張牌是掘穴者，則獲得 +{amount}。此牌在平局時獲勝。',
  'cards.text.tunnel_crown_burrowers_shift': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_cave_in': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_gem_rush': '本回合視為掘穴者；若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_lunch_break': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_deep_march': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_rockfall': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_throne_run': '本回合視為掘穴者；若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_last_tunnel': '若你的上一張牌是掘穴者，則獲得 +{amount}。',
  'cards.text.tunnel_crown_burrowers_uprising': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_static': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}，且本次比較中不能超過 {cap}。',
  'cards.text.stormheart_conclave_stormlings_rain_dance': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_wind_race': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_storm_call': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_cloudbreak': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_thunder_roll': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_sky_brawl': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_blackout': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.stormheart_conclave_stormlings_tempest': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.stormheart_conclave_stormlings_big_bang': '本回合對手的牌不能超過 {amount}。',
  'cards.text.roadknife_guild_bandits_heist': '若此牌落敗，隨機展示對手手牌中的 {count} 張牌，並令對手隨機棄掉 {discardCount} 張牌。',
  'cards.text.roadknife_guild_bandits_lookout': '若此牌落敗，隨機展示對手手牌中的 {count} 張牌。',
  'cards.text.roadknife_guild_bandits_road_toll': '若此牌獲勝，對手隨機棄掉 {count} 張牌。',
  'cards.text.roadknife_guild_bandits_knife_game': '若此牌獲勝，對手隨機棄掉 {count} 張牌。',
  'cards.text.roadknife_guild_bandits_bridge_job': '此牌首次揭示時，展示對手的手牌。',
  'cards.text.roadknife_guild_bandits_powder_plot': '此牌首次揭示時，展示對手的手牌。',
  'cards.text.roadknife_guild_bandits_night_raid': '若對手的牌是人類，則獲得 +{amount}。',
  'cards.text.roadknife_guild_bandits_coach_job': '若對手的牌是人類，則獲得 +{amount}。',
  'cards.text.roadknife_guild_bandits_guild_vote': '每當此牌獲勝時，抽 {amount} 張牌。',
  'cards.text.roadknife_guild_bandits_last_score': '揭示時，對手隨機棄掉 {count} 張牌。',
  'cards.text.mirrorveil_chorus_spirits_glance': '揭示時，本次比較由較低點數獲勝，並在本回合沉默對方的牌。',
  'cards.text.mirrorveil_chorus_spirits_echo': '此牌在平局回合中獲勝。',
  'cards.text.mirrorveil_chorus_spirits_double_take': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.mirrorveil_chorus_spirits_mirror_game': '本回合對手的牌不能超過 {amount}。',
  'cards.text.mirrorveil_chorus_spirits_glass_dance': '此牌的點數變為對手牌的基礎點數。',
  'cards.text.mirrorveil_chorus_spirits_name_swap': '此牌首次揭示時，對手的牌在本回合失去效果。',
  'cards.text.mirrorveil_chorus_spirits_lost_face': '此牌首次打出時，交換雙方的實際點數。',
  'cards.text.mirrorveil_chorus_spirits_hall_walk': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.mirrorveil_chorus_spirits_shattering': '本回合對手的牌不能超過 {amount}。',
  'cards.text.mirrorveil_chorus_spirits_encore': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_watch': '每當此牌落敗時，抽 {amount} 張牌，並將棄牌堆中點數 {threshold} 或更低的最高人類牌收回手牌。',
  'cards.text.emberwatch_compact_wardens_lantern_run': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.emberwatch_compact_wardens_fire_drill': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.emberwatch_compact_wardens_night_shift': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_beacon': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_muster': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_rescue': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_last_watch': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.emberwatch_compact_wardens_alarm': '每當此牌獲勝時，抽 {amount} 張牌。',
  'cards.text.emberwatch_compact_wardens_final_stand': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_spark': '揭示時，給予對手 {amount} 點恐懼。本次比較中對方的牌不能超過 {cap}。',
  'cards.text.cryptfire_covenant_fiends_grave_raid': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_bone_fire': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_soul_hunt': '揭示時，給予對手 {amount} 點恐懼。',
  'cards.text.cryptfire_covenant_fiends_crypt_feast': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_ash_rite': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_hellgate': '揭示時，給予對手 {amount} 點恐懼。若此牌獲勝，再給予 {bonus} 點恐懼。',
  'cards.text.cryptfire_covenant_fiends_doom_march': '對手每有 1 點恐懼便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.cryptfire_covenant_fiends_graveburn': '若對手擁有至少 {threshold} 點恐懼，其牌獲得 -{amount}。',
  'cards.text.cryptfire_covenant_fiends_endtime': '揭示時，給予對手 {amount} 點恐懼。',
  'cards.text.tableborn_circle_gamblers_deal': '你本局每打出一張人類牌便獲得 +{rate}，目前為 +{amount}。本次比較由較低點數獲勝。',
  'cards.text.tableborn_circle_gamblers_small_bet': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_card_trick': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_poker_night': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_bad_hand': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_bluff': '你本局每打出一張人類牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.tableborn_circle_gamblers_lucky_draw': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_table_flip': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_final_bet': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.tableborn_circle_gamblers_grand_game': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_sprout': '你本局每打出一張元素牌便獲得 +{rate}，目前為 +{amount}。本回合它同時視為靈魂。',
  'cards.text.greenwake_circle_treants_rain_song': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_root_race': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_orchard_walk': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_stag_hunt': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_bloom': '你本局每打出一張元素牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.greenwake_circle_treants_grove_dance': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_wild_hunt': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_long_sleep': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.greenwake_circle_treants_awakening': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cards.text.boneflame_host_skeletons_spark': '若此牌落敗，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌，並抽 {drawCount} 張牌。',
  'cards.text.boneflame_host_skeletons_bone_toss': '若此牌落敗，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.boneflame_host_skeletons_ash_dance': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.boneflame_host_skeletons_grave_run': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.boneflame_host_skeletons_fire_walk': '你本局每輸掉一張亡靈牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.boneflame_host_skeletons_pyre': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.boneflame_host_skeletons_crypt_roast': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.boneflame_host_skeletons_last_march': '若此牌獲勝，將你棄牌堆中點數 {threshold} 或更低的最高亡靈牌收回手牌。',
  'cards.text.boneflame_host_skeletons_bone_feast': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.boneflame_host_skeletons_inferno': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.fenward_hunters_scout': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。揭示時，本回合沉默對方的牌。',
  'cards.text.fenward_hunters_net_cast': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.fenward_hunters_bog_hunt': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.fenward_hunters_spider_trap': '若對手的牌是蜘蛛，則獲得 +{amount}。',
  'cards.text.fenward_hunters_trail': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.fenward_hunters_night_hunt': '若對手的牌為 {threshold} 或更高，則獲得 +{amount}。',
  'cards.text.fenward_hunters_web_raid': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.fenward_hunters_mire_watch': '若對手的牌是蜘蛛，則獲得 +{amount}。',
  'cards.text.fenward_hunters_queen_hunt': '若對手的牌為 {threshold} 或更高，則獲得 -{amount}。',
  'cards.text.fenward_hunters_homecoming': '本回合對手的牌不能超過 {amount}。',
  'cards.text.relicguard_order_sentinels_vigil': '揭示時，本次比較由較低點數獲勝，並在本回合沉默對方的牌。',
  'cards.text.relicguard_order_sentinels_key_turn': '此牌在平局回合中獲勝。',
  'cards.text.relicguard_order_sentinels_vault_watch': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.relicguard_order_sentinels_seal': '本回合對手的牌不能超過 {amount}。',
  'cards.text.relicguard_order_sentinels_relic_hunt': '此牌的點數變為對手牌的基礎點數。',
  'cards.text.relicguard_order_sentinels_oath': '此牌首次揭示時，對手的牌在本回合失去效果。',
  'cards.text.relicguard_order_sentinels_crypt_guard': '此牌首次打出時，交換雙方的實際點數。',
  'cards.text.relicguard_order_sentinels_gate_lock': '此牌的點數不能被降至 {amount} 以下。',
  'cards.text.relicguard_order_sentinels_last_watch': '本回合對手的牌不能超過 {amount}。',
  'cards.text.relicguard_order_sentinels_final_oath': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_errand': '每當此牌落敗時，抽 {amount} 張牌，並將棄牌堆中點數 {threshold} 或更低的最高牌收回手牌。',
  'cards.text.questbound_caravan_travelers_wrong_turn': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.questbound_caravan_travelers_bridge_stop': '每當此牌落敗時，抽 {amount} 張牌。',
  'cards.text.questbound_caravan_travelers_camp': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_side_quest': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_cart_fix': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_road_meal': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_lost_map': '當你的回合數落後時，獲得 +{amount}。',
  'cards.text.questbound_caravan_travelers_boss_fight': '每當此牌獲勝時，抽 {amount} 張牌。',
  'cards.text.questbound_caravan_travelers_homecoming': '若此牌獲勝，你的下一張牌獲得 +{amount}。',
  'cards.text.crownless_legends_whisper': '你本局每打出一張靈魂牌便獲得 +{rate}，目前為 +{amount}。本次比較由較低點數獲勝。',
  'cards.text.crownless_legends_exile': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.crownless_legends_broken_oath': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.crownless_legends_empty_hall': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.crownless_legends_last_song': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cards.text.crownless_legends_ghost_court': '你本局每打出一張靈魂牌便獲得 +{rate}，目前為 +{amount}。',
  'cards.text.crownless_legends_lost_crown': '若你本局已打出至少 {threshold} 個不同種族，則獲得 +{amount}。',
  'cards.text.crownless_legends_kingless_feast': '若你的上一張牌落敗，則獲得 +{amount}。',
  'cards.text.crownless_legends_final_war': '在第 {round} 回合及之後獲得 +{amount}。',
  'cards.text.crownless_legends_return': '當你連續輸掉 {threshold} 個回合後，獲得 +{amount}。',
  'cardDeck.setFilterLabel': '按套牌篩選',
  'cardDeck.allSets': '全部套牌',
  'cardDeck.set.ashen_flight': '灰燼之翼',
  'cardDeck.set.boneflame_host': '骨焰之軍',
  'cardDeck.set.briarpack': '荊棘狼群',
  'cardDeck.set.crownless_legends': '無冕傳奇',
  'cardDeck.set.cryptfire_covenant': '墓火盟約',
  'cardDeck.set.eastbrook_company': '東溪商隊',
  'cardDeck.set.emberwatch_compact': '餘燼守望盟',
  'cardDeck.set.fenward_hunters': '沼守獵隊',
  'cardDeck.set.gravebound_court': '墓縛宮廷',
  'cardDeck.set.greenwake_circle': '翠醒之環',
  'cardDeck.set.ironward_assembly': '鐵衛議會',
  'cardDeck.set.mirefen_tide': '泥沼之潮',
  'cardDeck.set.mirrorveil_chorus': '鏡紗合唱團',
  'cardDeck.set.questbound_caravan': '尋途商旅',
  'cardDeck.set.relicguard_order': '聖物守衛團',
  'cardDeck.set.roadknife_guild': '路刃行會',
  'cardDeck.set.sableweb_brood': '黑絲蛛群',
  'cardDeck.set.stormheart_conclave': '風暴之心議會',
  'cardDeck.set.tableborn_circle': '牌桌之子',
  'cardDeck.set.tunnel_crown': '地道王冠',
  'cardDeck.set.basics': '基礎牌',
