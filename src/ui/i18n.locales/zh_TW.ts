...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.controls.master': '大師',
  'cards.controls.newMatch': '新對局',
  'cards.controls.novice': '新手',
  'cards.controls.opponentA': 'A 座位由',
  'cards.controls.opponentB': 'B 座位由',
  'cards.controls.runToEndHint': '兩個座位都必須由電腦對手操作。',
  'cards.controls.seedHint': '相同的種子每次都會發出相同的對局。',
  'cards.controls.sharp': '敏銳',
  'cards.controls.steady': '穩健',
  'cards.docTitle': '卡牌對決試玩 - World of ClaudeCraft',
  'cards.intro': '一張不依賴遊戲世界的卡牌對決桌，運行的是正式版規則引擎。設定隨機種子即可重現完全相同的洗牌。',
  ...
  'cards.result.live': '對局進行中。',
  'cards.result.winA': 'A 座位贏得本局。',
  'cards.result.winB': 'B 座位贏得本局。',
  'cards.round.empty': '尚未進行任何回合。',
  'cards.round.heading': '第 {round} 回合',
  'cards.round.outcomeLose': 'B 座位以 {b} 比 {a} 贏下本回合。',
  'cards.round.outcomePush': '本回合以 {a} 打平。',
  'cards.round.outcomeWin': 'A 座位以 {a} 比 {b} 贏下本回合。',
  'cards.round.overflow': '結算達到步數上限，本回合按當前數值判定。',
  'cards.round.reshuffled': '一方的棄牌堆已重新洗回牌庫。',
  'cards.round.steps': '已結算 {count} 個效果。',
  'cards.seat.committed': '已鎖定出牌',
  'cards.seat.discardCount': '棄牌堆：{count}',
  'cards.seat.score': '已勝回合：{count}',
  'cards.seat.waiting': '選牌中...',
  'cards.seat.you': '你的座位',
  ...
  'cards.round.verdictA': 'A 席贏得本輪',
  'cards.round.verdictB': 'B 席贏得本輪',
  'cards.round.verdictPush': '本輪平手',
  ...
  'cardDuel.pipsAria': '{name}：已贏 {won}/{total} 輪',
  'cardDuel.revealedHeading': '已看到的對手手牌',
