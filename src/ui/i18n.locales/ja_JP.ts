...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.name.ashen_wyrm': '灰のワーム',
  'cards.name.bone_picker': '骨拾い',
  'cards.name.bramble_sprite': '茨の精',
  'cards.name.doppelganger': 'ドッペルゲンガー',
  'cards.name.ember_drake': '残り火のドレイク',
  'cards.name.forest_wolf': '森のオオカミ',
  'cards.name.grave_candle': '墓前の蝋燭',
  'cards.name.grave_rat': '墓場のネズミ',
  'cards.name.grave_warden': '墓守',
  'cards.name.grix_tunnelking': '坑道王グリックス',
  'cards.name.hollow_knight': '虚ろの騎士',
  'cards.name.ironclad': '鉄装甲',
  'cards.name.mire_toad': '泥沼のヒキガエル',
  'cards.name.mirefen_ambusher': 'マイアフェンの伏兵',
  'cards.name.mudfin_scout': 'マッドフィンの斥候',
  'cards.name.necromancer': 'ネクロマンサー',
  'cards.name.nullstone': 'ヌルストーン',
  'cards.name.nythraxis_broodling': 'ニスラクシスの仔',
  'cards.name.old_greyjaw': '老いたグレイジョー',
  'cards.name.pack_alpha': '群れの長',
  'cards.name.ratling_thief': 'ラットリングの盗人',
  'cards.name.sable_matriarch': '漆黒の母蜘蛛',
  'cards.name.sableweb_hexer': '黒網の呪術師',
  'cards.name.stablemaster': '厩舎長',
  'cards.name.stormcaller': '嵐呼び',
  'cards.name.torchbearer': '松明持ち',
  'cards.name.tunnel_guard': '坑道の衛兵',
  'cards.name.vale_champion': '谷の勇者',
  'cards.name.vale_warden': '谷の守人',
  'cards.name.web_spinner': '巣を紡ぐ者',
  'cards.noRulesText': '効果なし。',
  'cards.text.ashen_wyrm': '公開時、相手に恐怖を{amount}与える。',
  'cards.text.bone_picker': 'この試合であなたが出したアンデッド1体につき+1される。',
  'cards.text.bramble_sprite': 'このラウンド、このカードは野獣として扱われ、+{amount}される。',
  'cards.text.doppelganger': 'このカードの値は相手のカードの基本値になる。',
  'cards.text.ember_drake': '相手の恐怖1つにつき+1される。',
  'cards.text.forest_wolf': '直前に出したカードが野獣なら、+{amount}される。',
  'cards.text.grave_candle': 'このカードが負けた場合、次に出すアンデッドは+{amount}される。',
  'cards.text.grave_rat': 'このラウンド、相手のカードは-{amount}される。',
  'cards.text.grave_warden': 'このカードが勝った場合、捨て札から値{threshold}以下で最も高いアンデッドを手札に戻す。',
  'cards.text.grix_tunnelking': 'このカードが勝った場合、次に出すカードは-{amount}される。',
  'cards.text.hollow_knight': '引き分けのラウンドはこのカードの勝ちとなる。',
  'cards.text.ironclad': 'このラウンド、相手のカードの値は{amount}を超えない。',
  'cards.text.mire_toad': '相手のカードが{threshold}以上なら、+{amount}される。',
  'cards.text.mirefen_ambusher': '相手のカードが人間なら、+{amount}される。',
  'cards.text.mudfin_scout': 'このカードが負けた場合、相手の手札からランダムに{count}枚を公開する。',
  'cards.text.necromancer': '次に出すアンデッドは+{amount}される。',
  'cards.text.nullstone': 'このラウンド、相手のカードの効果は発動しない。',
  'cards.text.nythraxis_broodling': '公開時、相手に恐怖を{amount}与える。',
  'cards.text.old_greyjaw': 'ラウンド数で負けている間、+{amount}される。',
  'cards.text.pack_alpha': 'この試合であなたが出した野獣2体につき+1される。',
  'cards.text.ratling_thief': 'このカードが勝った場合、相手は手札からランダムに1枚を捨てる。',
  'cards.text.sable_matriarch': 'あなたの蜘蛛の巣1つにつき+1される。',
  'cards.text.sableweb_hexer': '相手のカードが人間なら、-{amount}される。',
  'cards.text.stablemaster': '次に出す野獣は+{amount}される。',
  'cards.text.stormcaller': '相手のカードが{threshold}以上なら、-{amount}される。',
  'cards.text.torchbearer': 'ラウンド数で負けている間、+{amount}される。',
  'cards.text.tunnel_guard': 'このカードの値は{amount}未満にはならない。',
  'cards.text.vale_champion': 'このカードが負けた場合、カードを{amount}枚引く。',
  'cards.text.vale_warden': 'このカードが勝った場合、カードを{amount}枚引く。',
  'cards.text.web_spinner': '公開時、蜘蛛の巣を{amount}得る。',
