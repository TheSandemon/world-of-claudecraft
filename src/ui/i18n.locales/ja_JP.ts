...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'cards.controls.human': 'プレイヤー',
  'cards.controls.label': '卓の操作',
  'cards.controls.master': '達人',
  'cards.controls.newMatch': '新しい対戦',
  'cards.controls.novice': '初心者',
  'cards.controls.opponentA': 'A席の操作',
  'cards.controls.opponentB': 'B席の操作',
  'cards.controls.runToEndHint': '両方の席がコンピューター対戦相手である必要があります。',
  'cards.controls.seedHint': '同じシード値なら毎回同じ対戦が配られます。',
  'cards.controls.sharp': '鋭敏',
  'cards.controls.steady': '堅実',
  'cards.docTitle': 'カードデュエル試遊 - World of ClaudeCraft',
  'cards.intro': 'ゲーム世界を必要としないカードデュエル卓で、製品版のルールエンジンをそのまま動かします。シード値を設定すると同じシャッフルを再現できます。',
  ...
  'cards.result.live': '対戦中です。',
  'cards.result.winA': 'A席が対戦に勝ちました。',
  'cards.result.winB': 'B席が対戦に勝ちました。',
  'cards.round.empty': 'まだラウンドは行われていません。',
  'cards.round.heading': 'ラウンド{round}',
  'cards.round.outcomeLose': 'B席が{b}対{a}でこのラウンドに勝ちました。',
  'cards.round.outcomePush': 'このラウンドは{a}で引き分けです。',
  'cards.round.outcomeWin': 'A席が{a}対{b}でこのラウンドに勝ちました。',
  'cards.round.overflow': '処理が上限に達したため、このラウンドは現在の値で判定されました。',
  'cards.round.reshuffled': '捨て札が山札に混ぜ直されました。',
  'cards.round.steps': '効果を{count}件処理しました。',
  'cards.seat.committed': 'カード確定',
  'cards.seat.discardCount': '捨て札：{count}',
  'cards.seat.score': '勝利ラウンド：{count}',
  'cards.seat.waiting': '選択中...',
  'cards.seat.you': 'あなたの席',
  ...
  'cards.round.verdictA': 'A席がこのラウンドに勝利',
  'cards.round.verdictB': 'B席がこのラウンドに勝利',
  'cards.round.verdictPush': 'このラウンドは引き分け',
  ...
  'cardDuel.pipsAria': '{name}：{total}ラウンド中{won}勝',
  'cardDuel.revealedHeading': '見えている相手の手札',
