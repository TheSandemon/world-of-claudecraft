...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.card_master.greeting':
    'ClaudeStoneはいかが？三本勝負、勝者には自慢の種が手に入る。',
  'cardDuel.title': 'ClaudeStone',
  'cardDuel.close': '閉じる',
  'cardDuel.join': 'キューに参加',
  'cardDuel.joinAria': 'ClaudeStoneのキューに参加する',
  'cardDuel.leave': 'キューを離れる',
  'cardDuel.leaveAria': 'ClaudeStoneのキューを離れる',
  'cardDuel.queued': '対戦相手を待っています……',
  'cardDuel.vsOpponent': '対 {name}',
  'cardDuel.round': 'ラウンドスコア：{mine} - {theirs}',
  'cardDuel.forfeit': '棄権',
  'cardDuel.forfeitAria': 'ClaudeStoneを棄権する',
  'cardDuel.unavailable': 'ClaudeStoneには、オンラインの対戦相手がもう一人必要です。',
  ...
  'cards.basicName': 'ただの{value}',
  'cards.card.effectiveLabel': '実効値{value}',
  'cards.card.valueLabel': '値{value}',
  'cards.card.playDetail': '{name}を出す。値{value}。{rules}',
  'cards.noRulesText': '効果なし。',
  'cards.tribe.Bandit': '盗賊',
  'cards.tribe.Beast': '野獣',
  'cards.tribe.Burrower': '穴掘り',
  'cards.tribe.Construct': '構造体',
  'cards.tribe.Demon': '悪魔',
  'cards.tribe.Dragon': 'ドラゴン',
  'cards.tribe.Elemental': 'エレメンタル',
  'cards.tribe.Human': '人間',
  'cards.tribe.Mudfin': 'マッドフィン',
  ...
  'cardDuel.clockHeld': 'ラウンドを処理中',
  'cardDuel.summary.win': 'あなたの勝ち',
  'cardDuel.summary.loss': 'あなたの負け',
  'cardDuel.summary.draw': '引き分け',
  'cardDuel.summary.against': '対戦相手：{name}',
  'cardDuel.summary.health': '残り体力',
  'cardDuel.summary.rounds': 'ラウンド数',
  'cardDuel.summary.dealt': '与えたダメージ',
  'cardDuel.summary.taken': '受けたダメージ',
  'cardDuel.summary.bestHit': '最大の一撃',
  'cardDuel.summary.bestHitValue': '第{round}ラウンド、{card}で{amount}',
  'cardDuel.summary.rematch': 'もう一度',
  'cardDuel.summary.done': '席を立つ',
  ...
  'cardDeck.close': '閉じる',
  'cardDeck.defaultName': '新しいデッキ',
  'cardDeck.delete': 'デッキを破棄',
  'cardDeck.emptySlot': '値{value}の空き枠',
  'cardDeck.nameLabel': 'デッキ名',
  'cardDeck.open': 'デッキ',
  'cardDeck.openAria': 'デッキビルダーを開く',
  'cardDeck.progress': '{required}枠中{filled}枠が埋まりました',
  'cardDeck.rowTitle': '値{value}',
  'cardDeck.rule': 'デッキは二十枚です。一から十まで各値二枚ずつで、同じカードは入れられません。',
  'cardDeck.save': 'デッキを保存',
  'cardDeck.title': 'デッキビルダー',
  'cardOpponents.heading': '常連と対戦',
  'cardOpponents.sitDown': '{name}と対戦する',
  'cardOpponents.tier.master': '達人',
  'cardOpponents.tier.novice': '初心者',
  'cardOpponents.tier.sharp': '鋭敏',
  'cardOpponents.tier.steady': '堅実',
  'cards.opponent.dockhand_pell.greeting': '泥に気をつけな。うちの辺りじゃ泥が噛みついてくる。',
  'cards.opponent.dockhand_pell.name': 'ペル',
  'cards.opponent.dockhand_pell.title': '港湾人足',
  'cards.opponent.gravedigger_ossa.greeting': 'わたしが埋めたものは、どれも長くは眠らない。',
  'cards.opponent.gravedigger_ossa.name': 'オッサ',
  'cards.opponent.gravedigger_ossa.title': '墓掘り',
  'cards.opponent.huntsman_bregg.greeting': '狼一匹なら厄介ごと。六匹なら狩りだ。',
  'cards.opponent.huntsman_bregg.name': 'ブレッグ',
  'cards.opponent.huntsman_bregg.title': '狩人',
  'cards.opponent.the_card_master.greeting': '座りたまえ。誰もが同じ二十枚を持つ。君が選んだ札を見せてもらおう。',
  'cards.opponent.the_card_master.name': 'カードマスター',
  'cards.opponent.the_card_master.title': '卓の番人',
  'cards.counter.Pack': '群れ',
  'cards.counter.Dread': '恐怖',
  'cardDuel.commitLocked': '確定済み',
  'cardDuel.commitChoosing': '選択中',
  'cardDuel.waitingBoth': '両者がカードを選んでいます',
  'cardDuel.waitingThem': '相手のカードを待っています',
  'cardDuel.waitingMe': '相手の準備が整いました',
  ...
  'cardDuel.beat.reveal': 'カードが表に',
  'cardDuel.beat.effectValue': '{card}：{target}に{amount}',
  'cardDuel.beat.effectSilence': '{card}が相手のカードを沈黙させた',
  'cardDuel.beat.effectReveal': '{card}がカードを公開した',
  'cardDuel.beat.effectDraw': '{card}がカードを1枚引いた',
  'cardDuel.beat.effectSwap': '{card}が両者の値を入れ替えた',
  'cardDuel.beat.effectOther': '{card}が発動',
  'cardDuel.beat.yourCard': 'あなたのカード',
  'cardDuel.beat.theirCard': '相手のカード',
  'cardDuel.damageMine': 'あなたに{amount}ダメージ',
  'cardDuel.damageTheirs': '相手に{amount}ダメージ',
  'cardDuel.beat.clash': 'カードが激突',
  'cardDuel.beat.finish': '最後の一撃が決まった',
  'cardDuel.beat.gloryWin': 'この対決はあなたのものだ',
  'cardDuel.beat.gloryLose': 'この対決は敗北に終わった',
  'cardDuel.beat.gloryDraw': 'この対決は引き分けに終わった',
  'cardDuel.announce': 'あなたは{mine}、相手は{theirs}を出しました。{outcome}',
  'cardDuel.oppoHandHidden': '相手の手札：{count}',
  'cardDuel.oppoHandSeen': '相手の手札：{count}、うち{seen}枚が見えています',
  'cardDuel.effectsHeading': '継続中の効果',
  'cardDuel.durationNextRound': '次のラウンド',
  'cardDuel.durationUntilTriggered': '発動するまで',
  'cardDuel.durationMatchEnd': 'この対戦の残り',
  'cards.name.briarpack_wolfs_nap': '1 狼の昼寝',
  'cards.name.briarpack_wolves_hunt': '2 狼の狩り',
  'cards.name.briarpack_wolves_howl': '3 狼の遠吠え',
  'cards.name.briarpack_wolves_ambush': '4 狼の待ち伏せ',
  'cards.name.briarpack_wolves_trail': '5 狼の足跡',
  'cards.name.briarpack_wolves_moonrun': '6 狼の月夜駆け',
  'cards.name.briarpack_wolves_feast': '7 狼の饗宴',
  'cards.name.briarpack_wolves_siege': '8 狼の包囲',
  'cards.name.briarpack_wolves_overlook': '9 狼の見張り台',
  'cards.name.briarpack_wolves_wild_night': '10 狼の荒れ狂う夜',
  'cards.name.gravebound_court_ghosts_wake': '1 亡霊の通夜',
  'cards.name.gravebound_court_ghosts_vigil': '2 亡霊の寝ずの番',
  'cards.name.gravebound_court_ghosts_supper': '3 亡霊の晩餐',
  'cards.name.gravebound_court_ghosts_grave_shift': '4 亡霊の墓守り番',
  'cards.name.gravebound_court_ghosts_bell_toll': '5 亡霊の弔鐘',
  'cards.name.gravebound_court_ghosts_procession': '6 亡霊の行進',
  'cards.name.gravebound_court_ghosts_crypt_ball': '7 亡霊の地下墓所の舞踏会',
  'cards.name.gravebound_court_ghosts_court': '8 亡霊の宮廷',
  'cards.name.gravebound_court_ghosts_coronation': '9 亡霊の戴冠式',
  'cards.name.gravebound_court_ghosts_reunion': '10 亡霊の再会',
  'cards.name.sableweb_brood_spiders_web': '1 蜘蛛の巣',
  'cards.name.sableweb_brood_spiders_wait': '2 蜘蛛の待ち',
  'cards.name.sableweb_brood_spiders_snack': '3 蜘蛛の軽食',
  'cards.name.sableweb_brood_spiders_silk_trap': '4 蜘蛛の絹の罠',
  'cards.name.sableweb_brood_spiders_shed': '5 蜘蛛の脱皮',
  'cards.name.sableweb_brood_spiders_egg_hunt': '6 蜘蛛の卵探し',
  'cards.name.sableweb_brood_spiders_tea_party': '7 蜘蛛のお茶会',
  'cards.name.sableweb_brood_spiders_night_watch': '8 蜘蛛の夜警',
  'cards.name.sableweb_brood_spiders_feast': '9 蜘蛛の饗宴',
  'cards.name.sableweb_brood_spiders_brood_rite': '10 蜘蛛の孵化の儀',
  'cards.name.ashen_flight_dragons_spark': '1 竜の火花',
  'cards.name.ashen_flight_dragons_smoke_break': '2 竜の一服',
  'cards.name.ashen_flight_dragons_roost': '3 竜の塒',
  'cards.name.ashen_flight_dragons_first_raid': '4 竜の初陣',
  'cards.name.ashen_flight_dragons_ashfall': '5 竜の灰降り',
  'cards.name.ashen_flight_dragons_fire_drill': '6 竜の火の演習',
  'cards.name.ashen_flight_dragons_sky_hunt': '7 竜の空の狩り',
  'cards.name.ashen_flight_dragons_bridge_roast': '8 竜の橋焼き',
  'cards.name.ashen_flight_dragons_sun_feast': '9 竜の陽の饗宴',
  'cards.name.ashen_flight_dragons_long_nap': '10 竜の長い昼寝',
  'cards.name.eastbrook_company_rangers_patrol': '1 レンジャーの巡回',
  'cards.name.eastbrook_company_rangers_lost_map': '2 レンジャーの失くした地図',
  'cards.name.eastbrook_company_rangers_dog_walk': '3 レンジャーの犬の散歩',
  'cards.name.eastbrook_company_rangers_campfire': '4 レンジャーの焚き火',
  'cards.name.eastbrook_company_rangers_beast_hunt': '5 レンジャーの獣狩り',
  'cards.name.eastbrook_company_rangers_stable_shift': '6 レンジャーの厩舎当番',
  'cards.name.eastbrook_company_rangers_roll_call': '7 レンジャーの点呼',
  'cards.name.eastbrook_company_rangers_rescue': '8 レンジャーの救出',
  'cards.name.eastbrook_company_rangers_last_watch': '9 レンジャーの最後の見張り',
  'cards.name.eastbrook_company_rangers_victory_march': '10 レンジャーの凱旋行進',
  'cards.name.ironward_assembly_golems_boot': '1 ゴーレムの起動',
  'cards.name.ironward_assembly_golems_test_run': '2 ゴーレムの試運転',
  'cards.name.ironward_assembly_golems_watch': '3 ゴーレムの見張り',
  'cards.name.ironward_assembly_golems_tune_up': '4 ゴーレムの調整',
  'cards.name.ironward_assembly_golems_forge_day': '5 ゴーレムの鍛冶の日',
  'cards.name.ironward_assembly_golems_shield_wall': '6 ゴーレムの盾の壁',
  'cards.name.ironward_assembly_golems_march': '7 ゴーレムの行軍',
  'cards.name.ironward_assembly_golems_lockdown': '8 ゴーレムの封鎖',
  'cards.name.ironward_assembly_golems_last_stand': '9 ゴーレムの最後の抵抗',
  'cards.name.ironward_assembly_golems_awakening': '10 ゴーレムの覚醒',
  'cards.name.mirefen_tide_mudfins_puddle': '1 マッドフィンの水たまり',
  'cards.name.mirefen_tide_mudfins_fish_fry': '2 マッドフィンの魚のフライ',
  'cards.name.mirefen_tide_mudfins_net_cast': '3 マッドフィンの投網',
  'cards.name.mirefen_tide_mudfins_bog_race': '4 マッドフィンの沼の競走',
  'cards.name.mirefen_tide_mudfins_reed_raid': '5 マッドフィンの葦の襲撃',
  'cards.name.mirefen_tide_mudfins_tide_call': '6 マッドフィンの潮の呼び声',
  'cards.name.mirefen_tide_mudfins_grub_feast': '7 マッドフィンの幼虫の饗宴',
  'cards.name.mirefen_tide_mudfins_mud_ball': '8 マッドフィンの泥団子',
  'cards.name.mirefen_tide_mudfins_moon_croak': '9 マッドフィンの月夜の鳴き声',
  'cards.name.mirefen_tide_mudfins_flood': '10 マッドフィンの氾濫',
  'cards.name.tunnel_crown_burrowers_dig': '1 穴掘りの掘削',
  'cards.name.tunnel_crown_burrowers_shift': '2 穴掘りの当番',
  'cards.name.tunnel_crown_burrowers_cave_in': '3 穴掘りの落盤',
  'cards.name.tunnel_crown_burrowers_gem_rush': '4 穴掘りの宝石ラッシュ',
  'cards.name.tunnel_crown_burrowers_lunch_break': '5 穴掘りの昼休み',
  'cards.name.tunnel_crown_burrowers_deep_march': '6 穴掘りの深部行軍',
  'cards.name.tunnel_crown_burrowers_rockfall': '7 穴掘りの落石',
  'cards.name.tunnel_crown_burrowers_throne_run': '8 穴掘りの玉座への疾走',
  'cards.name.tunnel_crown_burrowers_last_tunnel': '9 穴掘りの最後の坑道',
  'cards.name.tunnel_crown_burrowers_uprising': '10 穴掘りの蜂起',
  'cards.name.stormheart_conclave_stormlings_static': '1 嵐の子の静電気',
  'cards.name.stormheart_conclave_stormlings_rain_dance': '2 嵐の子の雨乞いの舞',
  'cards.name.stormheart_conclave_stormlings_wind_race': '3 嵐の子の風の競走',
  'cards.name.stormheart_conclave_stormlings_storm_call': '4 嵐の子の嵐の呼び声',
  'cards.name.stormheart_conclave_stormlings_cloudbreak': '5 嵐の子の雲破り',
  'cards.name.stormheart_conclave_stormlings_thunder_roll': '6 嵐の子の雷鳴',
  'cards.name.stormheart_conclave_stormlings_sky_brawl': '7 嵐の子の空の乱闘',
  'cards.name.stormheart_conclave_stormlings_blackout': '8 嵐の子の暗転',
  'cards.name.stormheart_conclave_stormlings_tempest': '9 嵐の子の大嵐',
  'cards.name.stormheart_conclave_stormlings_big_bang': '10 嵐の子の大爆発',
  'cards.name.roadknife_guild_bandits_heist': '1 山賊の強奪',
  'cards.name.roadknife_guild_bandits_lookout': '2 山賊の見張り役',
  'cards.name.roadknife_guild_bandits_road_toll': '3 山賊の通行料',
  'cards.name.roadknife_guild_bandits_knife_game': '4 山賊のナイフ遊び',
  'cards.name.roadknife_guild_bandits_bridge_job': '5 山賊の橋の仕事',
  'cards.name.roadknife_guild_bandits_powder_plot': '6 山賊の火薬の陰謀',
  'cards.name.roadknife_guild_bandits_night_raid': '7 山賊の夜襲',
  'cards.name.roadknife_guild_bandits_coach_job': '8 山賊の馬車強盗',
  'cards.name.roadknife_guild_bandits_guild_vote': '9 山賊のギルド投票',
  'cards.name.roadknife_guild_bandits_last_score': '10 山賊の最後の一仕事',
  'cards.name.mirrorveil_chorus_spirits_glance': '1 精霊の一瞥',
  'cards.name.mirrorveil_chorus_spirits_echo': '2 精霊の残響',
  'cards.name.mirrorveil_chorus_spirits_double_take': '3 精霊の二度見',
  'cards.name.mirrorveil_chorus_spirits_mirror_game': '4 精霊の鏡の遊戯',
  'cards.name.mirrorveil_chorus_spirits_glass_dance': '5 精霊の硝子の舞',
  'cards.name.mirrorveil_chorus_spirits_name_swap': '6 精霊の名の交換',
  'cards.name.mirrorveil_chorus_spirits_lost_face': '7 精霊の失われた顔',
  'cards.name.mirrorveil_chorus_spirits_hall_walk': '8 精霊の広間の歩み',
  'cards.name.mirrorveil_chorus_spirits_shattering': '9 精霊の砕け',
  'cards.name.mirrorveil_chorus_spirits_encore': '10 精霊のアンコール',
  'cards.name.emberwatch_compact_wardens_watch': '1 守護者の見張り',
  'cards.name.emberwatch_compact_wardens_lantern_run': '2 守護者の灯火の巡行',
  'cards.name.emberwatch_compact_wardens_fire_drill': '3 守護者の火の演習',
  'cards.name.emberwatch_compact_wardens_night_shift': '4 守護者の夜勤',
  'cards.name.emberwatch_compact_wardens_beacon': '5 守護者の烽火',
  'cards.name.emberwatch_compact_wardens_muster': '6 守護者の召集',
  'cards.name.emberwatch_compact_wardens_rescue': '7 守護者の救出',
  'cards.name.emberwatch_compact_wardens_last_watch': '8 守護者の最後の見張り',
  'cards.name.emberwatch_compact_wardens_alarm': '9 守護者の警報',
  'cards.name.emberwatch_compact_wardens_final_stand': '10 守護者の最終防衛',
  'cards.name.cryptfire_covenant_fiends_spark': '1 魔物の火花',
  'cards.name.cryptfire_covenant_fiends_grave_raid': '2 魔物の墓荒らし',
  'cards.name.cryptfire_covenant_fiends_bone_fire': '3 魔物の骨の炎',
  'cards.name.cryptfire_covenant_fiends_soul_hunt': '4 魔物の魂狩り',
  'cards.name.cryptfire_covenant_fiends_crypt_feast': '5 魔物の地下墓所の饗宴',
  'cards.name.cryptfire_covenant_fiends_ash_rite': '6 魔物の灰の儀式',
  'cards.name.cryptfire_covenant_fiends_hellgate': '7 魔物の地獄門',
  'cards.name.cryptfire_covenant_fiends_doom_march': '8 魔物の破滅の行軍',
  'cards.name.cryptfire_covenant_fiends_graveburn': '9 魔物の墓焼き',
  'cards.name.cryptfire_covenant_fiends_endtime': '10 魔物の終末',
  'cards.name.tableborn_circle_gamblers_deal': '1 賭博師の配札',
  'cards.name.tableborn_circle_gamblers_small_bet': '2 賭博師の小さな賭け',
  'cards.name.tableborn_circle_gamblers_card_trick': '3 賭博師のカード手品',
  'cards.name.tableborn_circle_gamblers_poker_night': '4 賭博師のポーカーの夜',
  'cards.name.tableborn_circle_gamblers_bad_hand': '5 賭博師の悪い手札',
  'cards.name.tableborn_circle_gamblers_bluff': '6 賭博師のブラフ',
  'cards.name.tableborn_circle_gamblers_lucky_draw': '7 賭博師の幸運の一枚',
  'cards.name.tableborn_circle_gamblers_table_flip': '8 賭博師の卓返し',
  'cards.name.tableborn_circle_gamblers_final_bet': '9 賭博師の最後の賭け',
  'cards.name.tableborn_circle_gamblers_grand_game': '10 賭博師の大勝負',
  'cards.name.greenwake_circle_treants_sprout': '1 トレントの芽吹き',
  'cards.name.greenwake_circle_treants_rain_song': '2 トレントの雨の歌',
  'cards.name.greenwake_circle_treants_root_race': '3 トレントの根の競走',
  'cards.name.greenwake_circle_treants_orchard_walk': '4 トレントの果樹園の散歩',
  'cards.name.greenwake_circle_treants_stag_hunt': '5 トレントの鹿狩り',
  'cards.name.greenwake_circle_treants_bloom': '6 トレントの開花',
  'cards.name.greenwake_circle_treants_grove_dance': '7 トレントの木立の舞',
  'cards.name.greenwake_circle_treants_wild_hunt': '8 トレントのワイルドハント',
  'cards.name.greenwake_circle_treants_long_sleep': '9 トレントの長い眠り',
  'cards.name.greenwake_circle_treants_awakening': '10 トレントの覚醒',
  'cards.name.boneflame_host_skeletons_spark': '1 骸骨の火花',
  'cards.name.boneflame_host_skeletons_bone_toss': '2 骸骨の骨投げ',
  'cards.name.boneflame_host_skeletons_ash_dance': '3 骸骨の灰の舞',
  'cards.name.boneflame_host_skeletons_grave_run': '4 骸骨の墓場駆け',
  'cards.name.boneflame_host_skeletons_fire_walk': '5 骸骨の火渡り',
  'cards.name.boneflame_host_skeletons_pyre': '6 骸骨の火葬壇',
  'cards.name.boneflame_host_skeletons_crypt_roast': '7 骸骨の地下墓所の炙り',
  'cards.name.boneflame_host_skeletons_last_march': '8 骸骨の最後の行軍',
  'cards.name.boneflame_host_skeletons_bone_feast': '9 骸骨の骨の饗宴',
  'cards.name.boneflame_host_skeletons_inferno': '10 骸骨の業火',
  'cards.name.fenward_hunters_scout': '1 狩人の斥候',
  'cards.name.fenward_hunters_net_cast': '2 狩人の投網',
  'cards.name.fenward_hunters_bog_hunt': '3 狩人の沼の狩り',
  'cards.name.fenward_hunters_spider_trap': '4 狩人の蜘蛛の罠',
  'cards.name.fenward_hunters_trail': '5 狩人の足跡',
  'cards.name.fenward_hunters_night_hunt': '6 狩人の夜の狩り',
  'cards.name.fenward_hunters_web_raid': '7 狩人の巣への急襲',
  'cards.name.fenward_hunters_mire_watch': '8 狩人の泥沼の見張り',
  'cards.name.fenward_hunters_queen_hunt': '9 狩人の女王狩り',
  'cards.name.fenward_hunters_homecoming': '10 狩人の帰郷',
  'cards.name.relicguard_order_sentinels_vigil': '1 衛士の寝ずの番',
  'cards.name.relicguard_order_sentinels_key_turn': '2 衛士の鍵回し',
  'cards.name.relicguard_order_sentinels_vault_watch': '3 衛士の宝物庫の番',
  'cards.name.relicguard_order_sentinels_seal': '4 衛士の封印',
  'cards.name.relicguard_order_sentinels_relic_hunt': '5 衛士の遺物狩り',
  'cards.name.relicguard_order_sentinels_oath': '6 衛士の誓い',
  'cards.name.relicguard_order_sentinels_crypt_guard': '7 衛士の地下墓所の守り',
  'cards.name.relicguard_order_sentinels_gate_lock': '8 衛士の門の施錠',
  'cards.name.relicguard_order_sentinels_last_watch': '9 衛士の最後の見張り',
  'cards.name.relicguard_order_sentinels_final_oath': '10 衛士の最後の誓い',
  'cards.name.questbound_caravan_travelers_errand': '1 旅人の使い走り',
  'cards.name.questbound_caravan_travelers_wrong_turn': '2 旅人の道間違い',
  'cards.name.questbound_caravan_travelers_bridge_stop': '3 旅人の橋での休憩',
  'cards.name.questbound_caravan_travelers_camp': '4 旅人の野営',
  'cards.name.questbound_caravan_travelers_side_quest': '5 旅人のサブクエスト',
  'cards.name.questbound_caravan_travelers_cart_fix': '6 旅人の荷車修理',
  'cards.name.questbound_caravan_travelers_road_meal': '7 旅人の道中の食事',
  'cards.name.questbound_caravan_travelers_lost_map': '8 旅人の失くした地図',
  'cards.name.questbound_caravan_travelers_boss_fight': '9 旅人のボス戦',
  'cards.name.questbound_caravan_travelers_homecoming': '10 旅人の帰郷',
  'cards.name.crownless_legends_whisper': '1 伝説の囁き',
  'cards.name.crownless_legends_exile': '2 伝説の追放',
  'cards.name.crownless_legends_broken_oath': '3 伝説の破られた誓い',
  'cards.name.crownless_legends_empty_hall': '4 伝説の空の広間',
  'cards.name.crownless_legends_last_song': '5 伝説の最後の歌',
  'cards.name.crownless_legends_ghost_court': '6 伝説の亡霊の宮廷',
  'cards.name.crownless_legends_lost_crown': '7 伝説の失われた王冠',
  'cards.name.crownless_legends_kingless_feast': '8 伝説の王なき饗宴',
  'cards.name.crownless_legends_final_war': '9 伝説の最終戦争',
  'cards.name.crownless_legends_return': '10 伝説の帰還',
  'cards.text.briarpack_wolfs_nap': '公開時、群れを {amount} 得る。この比較では低い数値が勝つ。',
  'cards.text.briarpack_wolves_hunt': '群れが {threshold} 以上あるなら、+{amount}。',
  'cards.text.briarpack_wolves_howl': '群れ 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.briarpack_wolves_ambush': '公開時、群れを {amount} 得る。群れが {threshold} 以上あれば、このラウンドは精霊としても扱う。',
  'cards.text.briarpack_wolves_trail': '群れが {threshold} 以上あるなら、+{amount}。',
  'cards.text.briarpack_wolves_moonrun': '群れ 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.briarpack_wolves_feast': '公開時、群れを {amount} 得る。',
  'cards.text.briarpack_wolves_siege': '群れが {threshold} 以上あるなら、+{amount}。',
  'cards.text.briarpack_wolves_overlook': '群れ 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.briarpack_wolves_wild_night': '公開時、群れを {amount} 得る。',
  'cards.text.gravebound_court_ghosts_wake': 'このカードが負けたら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻し、カードを {drawCount} 枚引く。',
  'cards.text.gravebound_court_ghosts_vigil': 'このカードが負けたら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.gravebound_court_ghosts_supper': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.gravebound_court_ghosts_grave_shift': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.gravebound_court_ghosts_bell_toll': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.gravebound_court_ghosts_procession': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.gravebound_court_ghosts_crypt_ball': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.gravebound_court_ghosts_court': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.gravebound_court_ghosts_coronation': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.gravebound_court_ghosts_reunion': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.sableweb_brood_spiders_web': '公開時、巣を {amount} 得て、このラウンド相手のカードを沈黙させる。',
  'cards.text.sableweb_brood_spiders_wait': '巣が {threshold} 以上あるなら、+{amount}。',
  'cards.text.sableweb_brood_spiders_snack': '巣 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.sableweb_brood_spiders_silk_trap': '公開時、巣を {amount} 得る。巣が {threshold} 以上あれば、このラウンドは精霊としても扱う。',
  'cards.text.sableweb_brood_spiders_shed': '巣が {threshold} 以上あるなら、+{amount}。',
  'cards.text.sableweb_brood_spiders_egg_hunt': '巣 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.sableweb_brood_spiders_tea_party': '公開時、巣を {amount} 得る。',
  'cards.text.sableweb_brood_spiders_night_watch': '巣が {threshold} 以上あるなら、+{amount}。',
  'cards.text.sableweb_brood_spiders_feast': '巣 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.sableweb_brood_spiders_brood_rite': '公開時、巣を {amount} 得る。',
  'cards.text.ashen_flight_dragons_spark': '公開時、相手に恐怖を {amount} 与える。この比較では相手のカードは {cap} を超えられない。',
  'cards.text.ashen_flight_dragons_smoke_break': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.ashen_flight_dragons_roost': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.ashen_flight_dragons_first_raid': '公開時、相手に恐怖を {amount} 与える。',
  'cards.text.ashen_flight_dragons_ashfall': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.ashen_flight_dragons_fire_drill': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.ashen_flight_dragons_sky_hunt': '公開時、相手に恐怖を {amount} 与える。このカードが勝ったら、さらに {bonus} 与える。',
  'cards.text.ashen_flight_dragons_bridge_roast': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.ashen_flight_dragons_sun_feast': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.ashen_flight_dragons_long_nap': '公開時、相手に恐怖を {amount} 与える。',
  'cards.text.eastbrook_company_rangers_patrol': 'このカードが負けたら、次に出す獣が +{amount} を得て、捨札から最も高い獣が手札に戻る。',
  'cards.text.eastbrook_company_rangers_lost_map': 'このカードが負けたら、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_dog_walk': 'このカードが負けたら、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_campfire': '公開時、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_beast_hunt': '公開時、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_stable_shift': '公開時、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_roll_call': 'このカードが勝ったら、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_rescue': 'このカードが勝ったら、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_last_watch': 'このカードが勝ったら、次に出す獣が +{amount}。',
  'cards.text.eastbrook_company_rangers_victory_march': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.ironward_assembly_golems_boot': '公開時、この比較では低い数値が勝ち、このラウンド相手のカードを沈黙させる。',
  'cards.text.ironward_assembly_golems_test_run': 'このカードは引き分けのラウンドに勝つ。',
  'cards.text.ironward_assembly_golems_watch': 'このカードは {amount} 未満には下がらない。',
  'cards.text.ironward_assembly_golems_tune_up': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.ironward_assembly_golems_forge_day': 'このカードは相手カードの基本値になる。',
  'cards.text.ironward_assembly_golems_shield_wall': 'このカードが初めて公開されたとき、相手のカードはこのラウンド効果を失う。',
  'cards.text.ironward_assembly_golems_march': 'このカードを初めて出したとき、双方の実効値を入れ替える。',
  'cards.text.ironward_assembly_golems_lockdown': 'このカードは {amount} 未満には下がらない。',
  'cards.text.ironward_assembly_golems_last_stand': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.ironward_assembly_golems_awakening': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.mirefen_tide_mudfins_puddle': 'このカードが負けたら、相手の手札からランダムに {count} 枚を公開し、相手はランダムに {discardCount} 枚捨てる。',
  'cards.text.mirefen_tide_mudfins_fish_fry': 'このカードが負けたら、相手の手札からランダムに {count} 枚を公開する。',
  'cards.text.mirefen_tide_mudfins_net_cast': 'このカードが勝ったら、相手はランダムに {count} 枚捨てる。',
  'cards.text.mirefen_tide_mudfins_bog_race': 'このカードが勝ったら、相手はランダムに {count} 枚捨てる。',
  'cards.text.mirefen_tide_mudfins_reed_raid': 'このカードが初めて公開されたとき、相手の手札を公開する。',
  'cards.text.mirefen_tide_mudfins_tide_call': 'このカードが初めて公開されたとき、相手の手札を公開する。',
  'cards.text.mirefen_tide_mudfins_grub_feast': '相手のカードが人間なら、+{amount}。',
  'cards.text.mirefen_tide_mudfins_mud_ball': '相手のカードが人間なら、+{amount}。',
  'cards.text.mirefen_tide_mudfins_moon_croak': 'このカードが勝つたび、カードを {amount} 枚引く。',
  'cards.text.mirefen_tide_mudfins_flood': '公開時、相手はランダムに {count} 枚捨てる。',
  'cards.text.tunnel_crown_burrowers_dig': '直前のカードが穴掘りだった場合、+{amount}。このカードは引き分けに勝つ。',
  'cards.text.tunnel_crown_burrowers_shift': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_cave_in': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_gem_rush': 'このラウンドは穴掘りとして扱う。直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_lunch_break': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_deep_march': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_rockfall': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_throne_run': 'このラウンドは穴掘りとして扱う。直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_last_tunnel': '直前のカードが穴掘りだった場合、+{amount}。',
  'cards.text.tunnel_crown_burrowers_uprising': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.stormheart_conclave_stormlings_static': '相手のカードが {threshold} 以上なら -{amount}、さらにこの比較では {cap} を超えられない。',
  'cards.text.stormheart_conclave_stormlings_rain_dance': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.stormheart_conclave_stormlings_wind_race': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.stormheart_conclave_stormlings_storm_call': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.stormheart_conclave_stormlings_cloudbreak': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.stormheart_conclave_stormlings_thunder_roll': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.stormheart_conclave_stormlings_sky_brawl': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.stormheart_conclave_stormlings_blackout': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.stormheart_conclave_stormlings_tempest': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.stormheart_conclave_stormlings_big_bang': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.roadknife_guild_bandits_heist': 'このカードが負けたら、相手の手札からランダムに {count} 枚を公開し、相手はランダムに {discardCount} 枚捨てる。',
  'cards.text.roadknife_guild_bandits_lookout': 'このカードが負けたら、相手の手札からランダムに {count} 枚を公開する。',
  'cards.text.roadknife_guild_bandits_road_toll': 'このカードが勝ったら、相手はランダムに {count} 枚捨てる。',
  'cards.text.roadknife_guild_bandits_knife_game': 'このカードが勝ったら、相手はランダムに {count} 枚捨てる。',
  'cards.text.roadknife_guild_bandits_bridge_job': 'このカードが初めて公開されたとき、相手の手札を公開する。',
  'cards.text.roadknife_guild_bandits_powder_plot': 'このカードが初めて公開されたとき、相手の手札を公開する。',
  'cards.text.roadknife_guild_bandits_night_raid': '相手のカードが人間なら、+{amount}。',
  'cards.text.roadknife_guild_bandits_coach_job': '相手のカードが人間なら、+{amount}。',
  'cards.text.roadknife_guild_bandits_guild_vote': 'このカードが勝つたび、カードを {amount} 枚引く。',
  'cards.text.roadknife_guild_bandits_last_score': '公開時、相手はランダムに {count} 枚捨てる。',
  'cards.text.mirrorveil_chorus_spirits_glance': '公開時、この比較では低い数値が勝ち、このラウンド相手のカードを沈黙させる。',
  'cards.text.mirrorveil_chorus_spirits_echo': 'このカードは引き分けのラウンドに勝つ。',
  'cards.text.mirrorveil_chorus_spirits_double_take': 'このカードは {amount} 未満には下がらない。',
  'cards.text.mirrorveil_chorus_spirits_mirror_game': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.mirrorveil_chorus_spirits_glass_dance': 'このカードは相手カードの基本値になる。',
  'cards.text.mirrorveil_chorus_spirits_name_swap': 'このカードが初めて公開されたとき、相手のカードはこのラウンド効果を失う。',
  'cards.text.mirrorveil_chorus_spirits_lost_face': 'このカードを初めて出したとき、双方の実効値を入れ替える。',
  'cards.text.mirrorveil_chorus_spirits_hall_walk': 'このカードは {amount} 未満には下がらない。',
  'cards.text.mirrorveil_chorus_spirits_shattering': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.mirrorveil_chorus_spirits_encore': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.emberwatch_compact_wardens_watch': 'このカードが負けるたび、カードを {amount} 枚引き、捨札から数値 {threshold} 以下で最も高い人間を手札に戻す。',
  'cards.text.emberwatch_compact_wardens_lantern_run': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.emberwatch_compact_wardens_fire_drill': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.emberwatch_compact_wardens_night_shift': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.emberwatch_compact_wardens_beacon': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.emberwatch_compact_wardens_muster': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.emberwatch_compact_wardens_rescue': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.emberwatch_compact_wardens_last_watch': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.emberwatch_compact_wardens_alarm': 'このカードが勝つたび、カードを {amount} 枚引く。',
  'cards.text.emberwatch_compact_wardens_final_stand': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.cryptfire_covenant_fiends_spark': '公開時、相手に恐怖を {amount} 与える。この比較では相手のカードは {cap} を超えられない。',
  'cards.text.cryptfire_covenant_fiends_grave_raid': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.cryptfire_covenant_fiends_bone_fire': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.cryptfire_covenant_fiends_soul_hunt': '公開時、相手に恐怖を {amount} 与える。',
  'cards.text.cryptfire_covenant_fiends_crypt_feast': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.cryptfire_covenant_fiends_ash_rite': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.cryptfire_covenant_fiends_hellgate': '公開時、相手に恐怖を {amount} 与える。このカードが勝ったら、さらに {bonus} 与える。',
  'cards.text.cryptfire_covenant_fiends_doom_march': '相手の恐怖 1 つにつき +{rate}、現在は +{amount}。',
  'cards.text.cryptfire_covenant_fiends_graveburn': '相手の恐怖が {threshold} 以上なら、相手のカードは -{amount}。',
  'cards.text.cryptfire_covenant_fiends_endtime': '公開時、相手に恐怖を {amount} 与える。',
  'cards.text.tableborn_circle_gamblers_deal': 'この対戦で出した人間カード 1 枚につき +{rate}、現在は +{amount}。この比較では低い数値が勝つ。',
  'cards.text.tableborn_circle_gamblers_small_bet': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.tableborn_circle_gamblers_card_trick': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.tableborn_circle_gamblers_poker_night': '{round} ラウンド目以降、+{amount}。',
  'cards.text.tableborn_circle_gamblers_bad_hand': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cards.text.tableborn_circle_gamblers_bluff': 'この対戦で出した人間カード 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.tableborn_circle_gamblers_lucky_draw': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.tableborn_circle_gamblers_table_flip': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.tableborn_circle_gamblers_final_bet': '{round} ラウンド目以降、+{amount}。',
  'cards.text.tableborn_circle_gamblers_grand_game': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cards.text.greenwake_circle_treants_sprout': 'この対戦で出した元素カード 1 枚につき +{rate}、現在は +{amount}。このラウンドは精霊としても扱う。',
  'cards.text.greenwake_circle_treants_rain_song': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.greenwake_circle_treants_root_race': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.greenwake_circle_treants_orchard_walk': '{round} ラウンド目以降、+{amount}。',
  'cards.text.greenwake_circle_treants_stag_hunt': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cards.text.greenwake_circle_treants_bloom': 'この対戦で出した元素カード 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.greenwake_circle_treants_grove_dance': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.greenwake_circle_treants_wild_hunt': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.greenwake_circle_treants_long_sleep': '{round} ラウンド目以降、+{amount}。',
  'cards.text.greenwake_circle_treants_awakening': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cards.text.boneflame_host_skeletons_spark': 'このカードが負けたら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻し、カードを {drawCount} 枚引く。',
  'cards.text.boneflame_host_skeletons_bone_toss': 'このカードが負けたら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.boneflame_host_skeletons_ash_dance': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.boneflame_host_skeletons_grave_run': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.boneflame_host_skeletons_fire_walk': 'この対戦で失ったアンデッド 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.boneflame_host_skeletons_pyre': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.boneflame_host_skeletons_crypt_roast': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.boneflame_host_skeletons_last_march': 'このカードが勝ったら、捨札から数値 {threshold} 以下で最も高いアンデッドを手札に戻す。',
  'cards.text.boneflame_host_skeletons_bone_feast': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.boneflame_host_skeletons_inferno': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.fenward_hunters_scout': '相手のカードが {threshold} 以上なら、-{amount}。公開時、このラウンド相手のカードを沈黙させる。',
  'cards.text.fenward_hunters_net_cast': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.fenward_hunters_bog_hunt': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.fenward_hunters_spider_trap': '相手のカードが蜘蛛なら、+{amount}。',
  'cards.text.fenward_hunters_trail': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.fenward_hunters_night_hunt': '相手のカードが {threshold} 以上なら、+{amount}。',
  'cards.text.fenward_hunters_web_raid': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.fenward_hunters_mire_watch': '相手のカードが蜘蛛なら、+{amount}。',
  'cards.text.fenward_hunters_queen_hunt': '相手のカードが {threshold} 以上なら、-{amount}。',
  'cards.text.fenward_hunters_homecoming': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.relicguard_order_sentinels_vigil': '公開時、この比較では低い数値が勝ち、このラウンド相手のカードを沈黙させる。',
  'cards.text.relicguard_order_sentinels_key_turn': 'このカードは引き分けのラウンドに勝つ。',
  'cards.text.relicguard_order_sentinels_vault_watch': 'このカードは {amount} 未満には下がらない。',
  'cards.text.relicguard_order_sentinels_seal': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.relicguard_order_sentinels_relic_hunt': 'このカードは相手カードの基本値になる。',
  'cards.text.relicguard_order_sentinels_oath': 'このカードが初めて公開されたとき、相手のカードはこのラウンド効果を失う。',
  'cards.text.relicguard_order_sentinels_crypt_guard': 'このカードを初めて出したとき、双方の実効値を入れ替える。',
  'cards.text.relicguard_order_sentinels_gate_lock': 'このカードは {amount} 未満には下がらない。',
  'cards.text.relicguard_order_sentinels_last_watch': 'このラウンド、相手のカードは {amount} を超えられない。',
  'cards.text.relicguard_order_sentinels_final_oath': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.questbound_caravan_travelers_errand': 'このカードが負けるたび、カードを {amount} 枚引き、捨札から数値 {threshold} 以下で最も高いカードを手札に戻す。',
  'cards.text.questbound_caravan_travelers_wrong_turn': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.questbound_caravan_travelers_bridge_stop': 'このカードが負けるたび、カードを {amount} 枚引く。',
  'cards.text.questbound_caravan_travelers_camp': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.questbound_caravan_travelers_side_quest': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.questbound_caravan_travelers_cart_fix': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.questbound_caravan_travelers_road_meal': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.questbound_caravan_travelers_lost_map': 'ラウンド数で負けている間、+{amount}。',
  'cards.text.questbound_caravan_travelers_boss_fight': 'このカードが勝つたび、カードを {amount} 枚引く。',
  'cards.text.questbound_caravan_travelers_homecoming': 'このカードが勝ったら、次に出すカードが +{amount}。',
  'cards.text.crownless_legends_whisper': 'この対戦で出した精霊カード 1 枚につき +{rate}、現在は +{amount}。この比較では低い数値が勝つ。',
  'cards.text.crownless_legends_exile': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.crownless_legends_broken_oath': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.crownless_legends_empty_hall': '{round} ラウンド目以降、+{amount}。',
  'cards.text.crownless_legends_last_song': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cards.text.crownless_legends_ghost_court': 'この対戦で出した精霊カード 1 枚につき +{rate}、現在は +{amount}。',
  'cards.text.crownless_legends_lost_crown': 'この対戦で {threshold} 種類以上の種族を出していれば、+{amount}。',
  'cards.text.crownless_legends_kingless_feast': '直前のカードが負けていた場合、+{amount}。',
  'cards.text.crownless_legends_final_war': '{round} ラウンド目以降、+{amount}。',
  'cards.text.crownless_legends_return': '{threshold} ラウンド連続で負けた後、+{amount}。',
  'cardDeck.setFilterLabel': 'セットで絞り込む',
  'cardDeck.allSets': 'すべてのセット',
  'cardDeck.set.ashen_flight': '灰燼の翼',
  'cardDeck.set.boneflame_host': '骨炎の軍勢',
  'cardDeck.set.briarpack': '茨の群れ',
  'cardDeck.set.crownless_legends': '王冠なき伝説',
  'cardDeck.set.cryptfire_covenant': '墓炎の盟約',
  'cardDeck.set.eastbrook_company': 'イーストブルック商会',
  'cardDeck.set.emberwatch_compact': '残火の守り',
  'cardDeck.set.fenward_hunters': '沼守りの狩人',
  'cardDeck.set.gravebound_court': '墓縛りの宮廷',
  'cardDeck.set.greenwake_circle': '緑目覚めの環',
  'cardDeck.set.ironward_assembly': '鉄衛評議会',
  'cardDeck.set.mirefen_tide': '泥沼の潮',
  'cardDeck.set.mirrorveil_chorus': '鏡帳の合唱',
  'cardDeck.set.questbound_caravan': '旅路の隊商',
  'cardDeck.set.relicguard_order': '遺物守護騎士団',
  'cardDeck.set.roadknife_guild': '街道刃のギルド',
  'cardDeck.set.sableweb_brood': '黒糸の一族',
  'cardDeck.set.stormheart_conclave': '嵐心の集会',
  'cardDeck.set.tableborn_circle': '卓の申し子',
  'cardDeck.set.tunnel_crown': '坑道の王冠',
  'cardDeck.set.basics': '基本カード',
