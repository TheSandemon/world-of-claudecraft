...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  nl_NL: {
    ...
    'error.cardDeckIllegal': 'Een deck is twintig kaarten: twee van elke waarde en geen kaart dubbel.',
  ...
  pl_PL: {
    ...
    'error.cardDeckIllegal': 'Talia to dwadziescia kart: po dwie z kazdej wartosci i zadnej dwa razy.',
  ...
  id_ID: {
    ...
    'error.cardDeckIllegal': 'Satu dek berisi dua puluh kartu: dua per nilai dan tidak ada yang berulang.',
  ...
  vi_VN: {
    ...
    'error.cardDeckIllegal': 'Mot bo bai gom hai muoi la: moi gia tri hai la va khong la nao lap lai.',
