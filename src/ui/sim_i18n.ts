...
const baseEnTable = {
  ...
  // ClaudeStone minigame (Card Master NPC, src/sim/social/card_duel.ts).
  'log.cardDuelQueued': 'You queue for a ClaudeStone match.',
  'log.cardDuelLeftQueue': 'You leave the ClaudeStone queue.',
  'log.cardDuelBegins': 'Your ClaudeStone match against {name} begins!',
  ...
  'log.cardDuelBeginsNoOpponent': 'Your ClaudeStone match begins!',
  'log.cardDuelRound': 'ClaudeStone round: you played {mine}, opponent played {theirs}.',
  'log.cardDuelWin': 'You win the ClaudeStone match against {name}!',
  'log.cardDuelWinNoOpponent': 'You win the ClaudeStone match!',
  'log.cardDuelLoss': 'You lose the ClaudeStone match against {name}.',
  'log.cardDuelLossNoOpponent': 'You lose the ClaudeStone match.',
  'log.cardDuelForfeit': 'You forfeit the ClaudeStone match.',
  'log.cardDuelOpponentForfeited': 'Your opponent forfeited the ClaudeStone match. You win!',
  'log.cardDuelVoid': 'Your ClaudeStone match is void: neither side played in time.',
  'log.cardDuelDraw': 'Your ClaudeStone match ends in a draw.',
  'error.cardDuelNotAtMaster': 'You must be at the Card Master to queue for a ClaudeStone match.',
  'error.cardDuelNotInMatch': 'You are not in a ClaudeStone match.',
  ...
  'error.cardDuelAlreadyInDuel': 'You are already in a ClaudeStone match.',
  'error.cardDuelAlreadyQueued': 'You are already queued for a ClaudeStone match.',
  'error.cardDuelUnavailable': 'ClaudeStone requires another player online.',
  ...
  'error.cardDeckNameTooLong': 'That deck name will not fit on the card box.',
  'error.cardDeckNoRoom': 'You have no room for another deck.',
  'error.cardDeckUnknown': 'You have no deck by that name.',
  'error.cardDeckIllegal': 'A deck is twenty cards: two of each value, and no card twice.',
  'error.cardOpponentUnknown': 'That opponent is not at the table.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'error.cardDeckNameTooLong': 'Ese nombre de mazo no cabe en la caja de cartas.',
    'error.cardDeckNoRoom': 'No te queda sitio para otro mazo.',
    'error.cardDeckUnknown': 'No tienes ningun mazo con ese nombre.',
    'error.cardDeckIllegal': 'Un mazo son veinte cartas: dos de cada valor y ninguna repetida.',
    'error.cardOpponentUnknown': 'Ese rival no esta en la mesa.',
  ...
  fr_FR: {
    ...
    'error.cardDeckNameTooLong': 'Ce nom de paquet ne tient pas sur la boite.',
    'error.cardDeckNoRoom': "Vous n'avez plus de place pour un autre paquet.",
    'error.cardDeckUnknown': "Vous n'avez aucun paquet de ce nom.",
    'error.cardDeckIllegal': 'Un paquet fait vingt cartes : deux par valeur, aucune en double.',
    'error.cardOpponentUnknown': "Cet adversaire n'est pas a la table.",
  ...
  it_IT: {
    ...
    'error.cardDeckNameTooLong': 'Quel nome di mazzo non entra sulla scatola.',
    'error.cardDeckNoRoom': 'Non hai spazio per un altro mazzo.',
    'error.cardDeckUnknown': 'Non hai nessun mazzo con quel nome.',
    'error.cardDeckIllegal': 'Un mazzo e di venti carte: due per ogni valore e nessuna ripetuta.',
    'error.cardOpponentUnknown': 'Quel avversario non e al tavolo.',
  ...
  de_DE: {
    ...
    'error.cardDeckNameTooLong': 'Dieser Deckname passt nicht auf die Kartenschachtel.',
    'error.cardDeckNoRoom': 'Du hast keinen Platz fuer ein weiteres Deck.',
    'error.cardDeckUnknown': 'Du hast kein Deck mit diesem Namen.',
    'error.cardDeckIllegal': 'Ein Deck sind zwanzig Karten: zwei je Wert und keine doppelt.',
    'error.cardOpponentUnknown': 'Dieser Gegner sitzt nicht am Tisch.',
  ...
  zh_CN: {
    ...
    'log.cardDuelQueued': '你已加入ClaudeStone队列。',
    'log.cardDuelLeftQueue': '你已离开ClaudeStone队列。',
    'log.cardDuelBegins': '你与 {name} 的ClaudeStone开始了！',
    'log.cardDuelBeginsNoOpponent': '你的ClaudeStone开始了！',
    'log.cardDuelRound': 'ClaudeStone回合：你出了 {mine}，对手出了 {theirs}。',
    'log.cardDuelWin': '你赢得了与 {name} 的ClaudeStone！',
    'log.cardDuelWinNoOpponent': '你赢得了ClaudeStone！',
    'log.cardDuelLoss': '你输掉了与 {name} 的ClaudeStone。',
    'log.cardDuelLossNoOpponent': '你输掉了ClaudeStone。',
    'log.cardDuelForfeit': '你认输退出了ClaudeStone。',
    'log.cardDuelOpponentForfeited': '你的对手认输退出了ClaudeStone。你赢了！',
    'log.cardDuelVoid': '你的ClaudeStone已作废：双方均未在限时内出牌。',
    'log.cardDuelDraw': '你的ClaudeStone以平局结束。',
    'error.cardDuelNotAtMaster': '你必须前往牌局大师处才能加入ClaudeStone队列。',
    'error.cardDuelNotInMatch': '你当前不在ClaudeStone中。',
    'error.cardDuelAlreadyPlayed': '你本轮已经出过牌了。',
    'error.cardDuelNotHeld': '你手中没有那张牌。',
    'error.cardDuelAlreadyInDuel': '你已经在ClaudeStone中了。',
    'error.cardDuelAlreadyQueued': '你已在ClaudeStone队列中。',
    'error.cardDuelUnavailable': 'ClaudeStone需要另一名玩家在线。',
    'error.noDeadGroupMembers': '队伍中没有可以复活的死亡成员。',
    'error.cardDeckNameTooLong': '这个牌组名称太长，写不下。',
    'error.cardDeckNoRoom': '你已经没有位置再放一副牌组了。',
    'error.cardDeckUnknown': '你没有叫这个名字的牌组。',
    'error.cardDeckIllegal': '一副牌组是二十张：每个数值各两张，且没有重复的牌。',
    'error.cardOpponentUnknown': '那位对手不在牌桌上。',
  ...
  zh_TW: {
    ...
    'log.cardDuelQueued': '你加入了ClaudeStone隊列。',
    'log.cardDuelLeftQueue': '你離開了ClaudeStone隊列。',
    'log.cardDuelBegins': '你與 {name} 的ClaudeStone開始了！',
    'log.cardDuelBeginsNoOpponent': '你的ClaudeStone開始了！',
    'log.cardDuelRound': 'ClaudeStone本局：你出了 {mine}，對手出了 {theirs}。',
    'log.cardDuelWin': '你在與 {name} 的ClaudeStone中獲勝！',
    'log.cardDuelWinNoOpponent': '你贏得了ClaudeStone！',
    'log.cardDuelLoss': '你在與 {name} 的ClaudeStone中落敗。',
    'log.cardDuelLossNoOpponent': '你在ClaudeStone中落敗。',
    'log.cardDuelForfeit': '你在ClaudeStone中認輸。',
    'log.cardDuelOpponentForfeited': '對手在ClaudeStone中認輸。你獲勝！',
    'log.cardDuelVoid': '你的ClaudeStone宣告無效：雙方均未在時限內出牌。',
    'log.cardDuelDraw': '你的ClaudeStone以平局結束。',
    'error.cardDuelNotAtMaster': '你必須在牌局大師旁邊才能加入ClaudeStone隊列。',
    'error.cardDuelNotInMatch': '你目前不在任何ClaudeStone中。',
    'error.cardDuelAlreadyPlayed': '你本局已出過牌了。',
    'error.cardDuelNotHeld': '你沒有持有那張牌。',
    'error.cardDuelAlreadyInDuel': '你已在ClaudeStone中。',
    'error.cardDuelAlreadyQueued': '你已在ClaudeStone隊列中。',
    'error.cardDuelUnavailable': 'ClaudeStone需要另一名玩家在線。',
    'error.noDeadGroupMembers': '隊伍中沒有可以復活的陣亡成員。',
    'error.cardDeckNameTooLong': '這個牌組名稱太長，寫不下。',
    'error.cardDeckNoRoom': '你已經沒有位置再放一副牌組了。',
    'error.cardDeckUnknown': '你沒有叫這個名字的牌組。',
    'error.cardDeckIllegal': '一副牌組是二十張：每個數值各兩張，且沒有重複的牌。',
    'error.cardOpponentUnknown': '那位對手不在牌桌上。',
  ...
  ko_KR: {
    ...
    'log.cardDuelQueued': 'ClaudeStone 대기열에 참가했습니다.',
    'log.cardDuelLeftQueue': 'ClaudeStone 대기열에서 나갔습니다.',
    'log.cardDuelBegins': '{name}와(과)의 ClaudeStone이 시작됩니다!',
    'log.cardDuelBeginsNoOpponent': 'ClaudeStone이 시작됩니다!',
    'log.cardDuelRound': 'ClaudeStone 라운드: 내가 낸 카드 {mine}, 상대가 낸 카드 {theirs}.',
    'log.cardDuelWin': '{name}와(과)의 ClaudeStone에서 승리했습니다!',
    'log.cardDuelWinNoOpponent': 'ClaudeStone에서 승리했습니다!',
    'log.cardDuelLoss': '{name}와(과)의 ClaudeStone에서 패배했습니다.',
    'log.cardDuelLossNoOpponent': 'ClaudeStone에서 패배했습니다.',
    'log.cardDuelForfeit': 'ClaudeStone을 기권했습니다.',
    'log.cardDuelOpponentForfeited': '상대가 ClaudeStone을 기권했습니다. 승리!',
    'log.cardDuelVoid':
      'ClaudeStone이 무효 처리되었습니다: 제한 시간 안에 양쪽 모두 카드를 내지 않았습니다.',
    'log.cardDuelDraw': 'ClaudeStone이 무승부로 끝났습니다.',
    'error.cardDuelNotAtMaster': 'ClaudeStone 대기열에 참가하려면 카드 마스터 곁에 있어야 합니다.',
    'error.cardDuelNotInMatch': '현재 ClaudeStone 중이 아닙니다.',
    'error.cardDuelAlreadyPlayed': '이번 라운드에 이미 카드를 냈습니다.',
    'error.cardDuelNotHeld': '해당 카드를 보유하고 있지 않습니다.',
    'error.cardDuelAlreadyInDuel': '이미 ClaudeStone 중입니다.',
    'error.cardDuelAlreadyQueued': '이미 ClaudeStone 대기열에 있습니다.',
    'error.cardDuelUnavailable': 'ClaudeStone을 하려면 다른 플레이어가 온라인 상태여야 합니다.',
    'error.noDeadGroupMembers': '부활시킬 사망한 그룹원이 없습니다.',
    'error.cardDeckNameTooLong': '그 덱 이름은 카드 상자에 들어가지 않습니다.',
    'error.cardDeckNoRoom': '덱을 더 넣을 자리가 없습니다.',
    'error.cardDeckUnknown': '그런 이름의 덱이 없습니다.',
    'error.cardDeckIllegal': '덱은 스무 장입니다. 값마다 두 장씩, 같은 카드는 넣을 수 없습니다.',
    'error.cardOpponentUnknown': '그 상대는 테이블에 없습니다.',
  ...
  ja_JP: {
    ...
    'log.cardDuelQueued': 'ClaudeStoneのキューに参加しました。',
    'log.cardDuelLeftQueue': 'ClaudeStoneのキューから退出しました。',
    'log.cardDuelBegins': '{name}とのClaudeStoneが始まりました！',
    'log.cardDuelBeginsNoOpponent': 'ClaudeStoneが始まりました！',
    'log.cardDuelRound':
      'ClaudeStoneのラウンド：あなたは{mine}を出し、相手は{theirs}を出しました。',
    'log.cardDuelWin': '{name}とのClaudeStoneに勝利しました！',
    'log.cardDuelWinNoOpponent': 'ClaudeStoneに勝利しました！',
    'log.cardDuelLoss': '{name}とのClaudeStoneに敗れました。',
    'log.cardDuelLossNoOpponent': 'ClaudeStoneに敗れました。',
    'log.cardDuelForfeit': 'ClaudeStoneを棄権しました。',
    'log.cardDuelOpponentForfeited': '相手がClaudeStoneを棄権しました。あなたの勝ちです！',
    'log.cardDuelVoid': 'ClaudeStoneは無効です：どちらも時間内にカードを出しませんでした。',
    'log.cardDuelDraw': 'ClaudeStoneは引き分けに終わりました。',
    'error.cardDuelNotAtMaster':
      'ClaudeStoneのキューに参加するには、カードマスターのそばにいる必要があります。',
    'error.cardDuelNotInMatch': 'ClaudeStone中ではありません。',
    'error.cardDuelAlreadyPlayed': 'このラウンドではすでにカードを出しました。',
    'error.cardDuelNotHeld': 'そのカードは持っていません。',
    'error.cardDuelAlreadyInDuel': 'すでにClaudeStone中です。',
    'error.cardDuelAlreadyQueued': 'すでにClaudeStoneのキューに参加しています。',
    'error.cardDuelUnavailable': 'ClaudeStoneにはオンラインの対戦相手がもう一人必要です。',
    'error.noDeadGroupMembers': '蘇生できる死亡したグループメンバーがいません。',
    'error.cardDeckNameTooLong': 'そのデッキ名はカードボックスに収まりません。',
    'error.cardDeckNoRoom': 'これ以上デッキを置く場所がありません。',
    'error.cardDeckUnknown': 'その名前のデッキはありません。',
    'error.cardDeckIllegal': 'デッキは二十枚です。各値二枚ずつで、同じカードは入れられません。',
    'error.cardOpponentUnknown': 'その対戦相手は卓にいません。',
  ...
  pt_BR: {
    ...
    'error.cardDeckNameTooLong': 'Esse nome de baralho nao cabe na caixa.',
    'error.cardDeckNoRoom': 'Voce nao tem espaco para outro baralho.',
    'error.cardDeckUnknown': 'Voce nao tem nenhum baralho com esse nome.',
    'error.cardDeckIllegal': 'Um baralho tem vinte cartas: duas de cada valor e nenhuma repetida.',
    'error.cardOpponentUnknown': 'Esse adversario nao esta na mesa.',
  ...
  ru_RU: {
    ...
    'log.cardDuelQueued': 'Вы встаёте в очередь на ClaudeStone.',
    'log.cardDuelLeftQueue': 'Вы покидаете очередь ClaudeStone.',
    'log.cardDuelBegins': 'ClaudeStone против {name} начинается!',
    'log.cardDuelBeginsNoOpponent': 'ClaudeStone начинается!',
    'log.cardDuelRound': 'Раунд ClaudeStone: вы сыграли {mine}, соперник сыграл {theirs}.',
    'log.cardDuelWin': 'Вы победили в ClaudeStone против {name}!',
    'log.cardDuelWinNoOpponent': 'Вы победили в ClaudeStone!',
    'log.cardDuelLoss': 'Вы проиграли ClaudeStone против {name}.',
    'log.cardDuelLossNoOpponent': 'Вы проиграли ClaudeStone.',
    'log.cardDuelForfeit': 'Вы сдаётесь в ClaudeStone.',
    'log.cardDuelOpponentForfeited': 'Соперник сдался в ClaudeStone. Вы побеждаете!',
    'log.cardDuelVoid': 'ClaudeStone аннулирована: ни одна из сторон не сыграла вовремя.',
    'log.cardDuelDraw': 'ClaudeStone завершилась вничью.',
    'error.cardDuelNotAtMaster':
      'Вы должны находиться рядом с Карточным мастером, чтобы встать в очередь.',
    'error.cardDuelNotInMatch': 'Вы не участвуете в ClaudeStone.',
    'error.cardDuelAlreadyPlayed': 'Вы уже сыграли карту в этом раунде.',
    'error.cardDuelNotHeld': 'У вас нет этой карты.',
    'error.cardDuelAlreadyInDuel': 'Вы уже участвуете в ClaudeStone.',
    'error.cardDuelAlreadyQueued': 'Вы уже стоите в очереди на ClaudeStone.',
    'error.cardDuelUnavailable': 'Для ClaudeStone нужен ещё один игрок онлайн.',
    'error.noDeadGroupMembers': 'В группе нет погибших участников, которых можно воскресить.',
    'error.cardDeckNameTooLong': 'Такое название колоды не помещается на коробке.',
    'error.cardDeckNoRoom': 'У вас нет места еще для одной колоды.',
    'error.cardDeckUnknown': 'У вас нет колоды с таким названием.',
    'error.cardDeckIllegal': 'Колода это двадцать карт: по две на каждое значение и без повторов.',
    'error.cardOpponentUnknown': 'Этого соперника нет за столом.',
  ...
  cs_CZ: {
    ...
    'error.cardDeckNameTooLong': 'Tenhle nazev balicku se na krabicku nevejde.',
    'error.cardDeckNoRoom': 'Nemas misto na dalsi balicek.',
    'error.cardDeckUnknown': 'Zadny balicek s timhle nazvem nemas.',
    'error.cardDeckIllegal': 'Balicek ma dvacet karet: dve od kazde hodnoty a zadnou dvakrat.',
    'error.cardOpponentUnknown': 'Tenhle souper u stolu neni.',
  ...
  nl_NL: {
    ...
    'error.cardDeckNameTooLong': 'Die decknaam past niet op het kaartdoosje.',
    'error.cardDeckNoRoom': 'Je hebt geen ruimte voor nog een deck.',
    'error.cardDeckUnknown': 'Je hebt geen deck met die naam.',
    'error.cardDeckIllegal':
      'Een deck is twintig kaarten: twee van elke waarde en geen kaart dubbel.',
    'error.cardOpponentUnknown': 'Die tegenstander zit niet aan tafel.',
  ...
  pl_PL: {
    ...
    'error.cardDeckNameTooLong': 'Ta nazwa talii nie miesci sie na pudelku.',
    'error.cardDeckNoRoom': 'Nie masz miejsca na kolejna talie.',
    'error.cardDeckUnknown': 'Nie masz talii o tej nazwie.',
    'error.cardDeckIllegal':
      'Talia to dwadziescia kart: po dwie z kazdej wartosci i zadnej dwa razy.',
    'error.cardOpponentUnknown': 'Tego przeciwnika nie ma przy stole.',
  ...
  id_ID: {
    ...
    'error.cardDeckNameTooLong': 'Nama dek itu tidak muat di kotak kartu.',
    'error.cardDeckNoRoom': 'Kamu tidak punya tempat untuk dek lain.',
    'error.cardDeckUnknown': 'Kamu tidak punya dek dengan nama itu.',
    'error.cardDeckIllegal':
      'Satu dek berisi dua puluh kartu: dua per nilai dan tidak ada yang berulang.',
    'error.cardOpponentUnknown': 'Lawan itu tidak ada di meja.',
  ...
  tr_TR: {
    ...
    'error.cardDeckNameTooLong': 'Bu deste adi kart kutusuna sigmiyor.',
    'error.cardDeckNoRoom': 'Baska bir desteye yerin yok.',
    'error.cardDeckUnknown': 'Bu adda bir desten yok.',
    'error.cardDeckIllegal': 'Bir deste yirmi karttir: her degerden iki tane ve hicbiri iki kez.',
    'error.cardOpponentUnknown': 'O rakip masada degil.',
  ...
  sv_SE: {
    ...
    'error.cardDeckNameTooLong': 'Det decknamnet far inte plats pa kortasken.',
    'error.cardDeckNoRoom': 'Du har inte plats for en lek till.',
    'error.cardDeckUnknown': 'Du har ingen lek med det namnet.',
    'error.cardDeckIllegal': 'En lek ar tjugo kort: tva av varje valor och inget kort tva ganger.',
    'error.cardOpponentUnknown': 'Den motstandaren sitter inte vid bordet.',
  ...
  vi_VN: {
    ...
    'error.cardDeckNameTooLong': 'Ten bo bai do khong vua hop bai.',
    'error.cardDeckNoRoom': 'Ban khong con cho cho mot bo bai nua.',
    'error.cardDeckUnknown': 'Ban khong co bo bai nao ten do.',
    'error.cardDeckIllegal':
      'Mot bo bai gom hai muoi la: moi gia tri hai la va khong la nao lap lai.',
    'error.cardOpponentUnknown': 'Doi thu do khong co o ban.',
  ...
  da_DK: {
    ...
    'error.cardDeckNameTooLong': 'Det deknavn kan ikke vaere pa kortaesken.',
    'error.cardDeckNoRoom': 'Du har ikke plads til endnu et dek.',
    'error.cardDeckUnknown': 'Du har ingen dek med det navn.',
    'error.cardDeckIllegal': 'Et dek er tyve kort: to af hver vaerdi og intet kort to gange.',
    'error.cardOpponentUnknown': 'Den modstander sidder ikke ved bordet.',
...
const RULES: Rule[] = [
  ...
  // ClaudeStone minigame (Card Master NPC, src/sim/social/card_duel.ts).
  { re: /^You queue for a ClaudeStone match\.$/, build: () => tSim('log.cardDuelQueued') },
  { re: /^You leave the ClaudeStone queue\.$/, build: () => tSim('log.cardDuelLeftQueue') },
  {
    re: /^Your ClaudeStone match against (.+) begins!$/,
    build: (m) => tSim('log.cardDuelBegins', { name: m[1] }),
  },
  {
    re: /^Your ClaudeStone match begins!$/,
    build: () => tSim('log.cardDuelBeginsNoOpponent'),
  },
  {
    re: /^ClaudeStone round: you played (.+), opponent played (.+)\.$/,
    build: (m) => tSim('log.cardDuelRound', { mine: m[1], theirs: m[2] }),
  },
  {
    re: /^You win the ClaudeStone match against (.+)!$/,
    build: (m) => tSim('log.cardDuelWin', { name: m[1] }),
  },
  {
    re: /^You win the ClaudeStone match!$/,
    build: () => tSim('log.cardDuelWinNoOpponent'),
  },
  {
    re: /^You lose the ClaudeStone match against (.+)\.$/,
    build: (m) => tSim('log.cardDuelLoss', { name: m[1] }),
  },
  {
    re: /^You lose the ClaudeStone match\.$/,
    build: () => tSim('log.cardDuelLossNoOpponent'),
  },
  { re: /^You forfeit the ClaudeStone match\.$/, build: () => tSim('log.cardDuelForfeit') },
  {
    re: /^Your opponent forfeited the ClaudeStone match\. You win!$/,
    build: () => tSim('log.cardDuelOpponentForfeited'),
  },
  {
    re: /^Your ClaudeStone match is void: neither side played in time\.$/,
    build: () => tSim('log.cardDuelVoid'),
  },
  {
    re: /^Your ClaudeStone match ends in a draw\.$/,
    build: () => tSim('log.cardDuelDraw'),
  },
  {
    re: /^You must be at the Card Master to queue for a ClaudeStone match\.$/,
    build: () => tSim('error.cardDuelNotAtMaster'),
  },
  { re: /^You are not in a ClaudeStone match\.$/, build: () => tSim('error.cardDuelNotInMatch') },
  {
  ...
  {
    re: /^You are already in a ClaudeStone match\.$/,
    build: () => tSim('error.cardDuelAlreadyInDuel'),
  },
  {
    re: /^You are already queued for a ClaudeStone match\.$/,
    build: () => tSim('error.cardDuelAlreadyQueued'),
  },
  {
    re: /^ClaudeStone requires another player online\.$/,
    build: () => tSim('error.cardDuelUnavailable'),
  },
  // Deck building (src/sim/social/card_deck_commands.ts) and the direct match
  // against a named regular (src/sim/social/card_duel_bots.ts).
  {
    re: /^That deck name will not fit on the card box\.$/,
    build: () => tSim('error.cardDeckNameTooLong'),
  },
  { re: /^You have no room for another deck\.$/, build: () => tSim('error.cardDeckNoRoom') },
  { re: /^You have no deck by that name\.$/, build: () => tSim('error.cardDeckUnknown') },
  {
    re: /^A deck is twenty cards: two of each value, and no card twice\.$/,
    build: () => tSim('error.cardDeckIllegal'),
  },
  { re: /^That opponent is not at the table\.$/, build: () => tSim('error.cardOpponentUnknown') },
