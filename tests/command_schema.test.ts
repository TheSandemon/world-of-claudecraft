...
// Upstream's v0.42.0 counts, plus the four send + dispatch pairs the
// ClaudeStone deck builder and named regulars add (card_play_opponent,
// card_deck_save, card_deck_select, card_deck_delete). Every number here is
// read off a suite run on the MERGED tree.
const EXPECTED_SEND_COUNT = 211;
const EXPECTED_DISPATCH_COUNT = 225;
